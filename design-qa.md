...
### Entry-point visual correction

Replaced the smile icons and bounce after user feedback: Add a video uses the Lucide Video icon with an amber light sweep; chat restores its original speech bubble with a restrained halo. Motion runs three cycles and respects reduced-motion. The mobile layout remains unchanged. Checked the live 390px view, icon loading and restored chat glyph; screenshot `/tmp/hindsight-professional-buttons.png`.
