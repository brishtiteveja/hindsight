...
import { j as n } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { t as r } from "./dist-DepzDghu.mjs";
...
var i = r(), a = /* @__PURE__ */ e((e, t) => {
...
}, "drawBackgroundRect"), s = /* @__PURE__ */ e((e, t) => {
...
}, "drawText"), c = /* @__PURE__ */ e((e, t, n, r) => {
	let a = e.append("image");
	a.attr("x", t), a.attr("y", n);
	let o = (0, i.sanitizeUrl)(r);
	a.attr("xlink:href", o);
}, "drawImage"), l = /* @__PURE__ */ e((e, t, n, r) => {
	let a = e.append("use");
	a.attr("x", t), a.attr("y", n);
	let o = (0, i.sanitizeUrl)(r);
	a.attr("xlink:href", `#${o}`);
}, "drawEmbeddedImage"), u = /* @__PURE__ */ e(() => ({
	x: 0,
	y: 0,
	width: 100,
	height: 100,
	...
	ry: 0,
	tspan: !0
}), "getTextObj"), f = /* @__PURE__ */ e(() => {
	let e = t(".mermaidTooltip");
	return e.empty() && (e = t("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0).style("position", "absolute").style("text-align", "center").style("max-width", "200px").style("padding", "2px").style("font-size", "12px").style("background", "#ffffde").style("border", "1px solid #333").style("border-radius", "2px").style("pointer-events", "none").style("z-index", "100")), e;
}, "createTooltip");
//#endregion
