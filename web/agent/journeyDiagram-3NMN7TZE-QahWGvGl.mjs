...
import { H as n, K as r, U as i, a, c as o, v as s, w as c, x as l, y as u } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { t as d } from "./arc-BMQtrKqw.mjs";
import { t as f } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import { a as p, n as m, o as h, s as g } from "./chunk-F27PBJKO-BmGuo1wo.mjs";
		...
		performAction: /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
			...
			switch (i) {
				...
				case 12:
					...
					break;
				case 13: r.addTask(a[s - 1], a[s]), this.$ = "task";
			}
		}, "anonymous"),
		table: [
			{
...
var v = _, y = "", b = [], x = [], S = [], C = /* @__PURE__ */ e(function() {
	b.length = 0, x.length = 0, y = "", S.length = 0, a();
	...
	for (let [e, r] of S.entries()) t(e), n = n && r.processed;
	return n;
}, "compileTasks"), j = {
	getConfig: /* @__PURE__ */ e(() => l().journey, "getConfig"),
	clear: C,
	setDiagramTitle: r,
	getDiagramTitle: c,
	setAccTitle: i,
...
`, "getStyles"), N = /* @__PURE__ */ e(function(e, t) {
	...
	let r = e.append("g"), i = g();
	i.x = t.x, i.y = t.y, i.fill = t.fill, i.width = n.width * t.taskCount + n.diagramMarginX * (t.taskCount - 1), i.height = n.height, i.class = "journey-section section-type-" + t.num, i.rx = 3, i.ry = 3, N(r, i), H(n)(t.text, r, i.x, i.y, i.width, i.height, { class: "journey-section section-type-" + t.num }, n, t.colour);
}, "drawSection"), z = -1, B = /* @__PURE__ */ e(function(e, t, n, r) {
	let i = t.x + n.width / 2, a = e.append("g");
	z++, a.append("line").attr("id", r + "-task" + z).attr("x1", i).attr("y1", t.y).attr("x2", i).attr("y2", 450).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), P(a, {
		cx: i,
		cy: 300 + (5 - t.score) * 30,
		score: t.score
	});
	let o = g();
	o.x = t.x, o.y = t.y, o.fill = t.fill, o.width = n.width, o.height = n.height, o.class = "task task-type-" + t.num, o.rx = 3, o.ry = 3, N(a, o);
	let s = t.x + 14;
	t.people.forEach((e) => {
		...
		F(a, r), s += 10;
	}), H(n)(t.task, a, o.x, o.y, o.width, o.height, { class: "task" }, n, t.colour);
}, "drawTask"), V = /* @__PURE__ */ e(function(e, t) {
	m(e, t);
}, "drawBackgroundRect"), H = /* @__PURE__ */ (function() {
	...
	initGraphics: /* @__PURE__ */ e(function(e, t) {
		z = -1, e.append("defs").append("marker").attr("id", t + "-arrowhead").attr("refX", 5).attr("refY", 2).attr("markerWidth", 6).attr("markerHeight", 4).attr("orient", "auto").append("path").attr("d", "M 0,0 V 4 L6,2 Z");
	}, "initGraphics")
}, W = /* @__PURE__ */ e(function(e) {
	Object.keys(e).forEach(function(t) {
		J[t] = e[t];
	});
}, "setConf"), G = {}, K = 0;
function q(e) {
	let t = l().journey, n = t.maxLabelWidth;
	K = 0;
	let r = 60;
...
e(q, "drawActorLegend");
var J = l().journey, Y = 0, ee = /* @__PURE__ */ e(function(e, n, r, i) {
	let a = l(), s = a.journey.titleColor, c = a.journey.titleFontSize, u = a.journey.titleFontFamily, d = a.securityLevel, f;
	d === "sandbox" && (f = t("#i" + n));
	...
	}), q(m), Y = J.leftMargin + K, X.insert(0, 0, Y, Object.keys(G).length * 50), te(m, h, 0, n);
	let y = X.getBounds();
	g && m.append("text").text(g).attr("x", Y).attr("font-size", c).attr("font-weight", "bold").attr("y", 25).attr("fill", s).attr("font-family", u);
	let b = y.stopy - y.starty + 2 * J.diagramMarginY, x = Y + y.stopx + 2 * J.diagramMarginX;
	o(m, b, x, J.useMaxWidth), m.append("line").attr("x1", Y).attr("y1", J.height * 4).attr("x2", x - Y - 4).attr("y2", J.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#" + n + "-arrowhead)");
	let S = g ? 70 : 0;
	...
	updateBounds: /* @__PURE__ */ e(function(t, n, r, i) {
		let a = l().journey, o = this, s = 0;
		function c(c) {
			return /* @__PURE__ */ e(function(e) {
				s++;
				let l = o.sequenceItems.length - s + 1;
				o.updateVal(e, "starty", n - l * a.boxMargin, Math.min), o.updateVal(e, "stopy", i + l * a.boxMargin, Math.max), o.updateVal(X.data, "startx", t - l * a.boxMargin, Math.min), o.updateVal(X.data, "stopx", r + l * a.boxMargin, Math.max), c !== "activation" && (o.updateVal(e, "startx", t - l * a.boxMargin, Math.min), o.updateVal(e, "stopx", r + l * a.boxMargin, Math.max), o.updateVal(X.data, "starty", n - l * a.boxMargin, Math.min), o.updateVal(X.data, "stopy", i + l * a.boxMargin, Math.max));
			}, "updateItemBounds");
		}
...
}, Z = J.sectionFills, Q = J.sectionColours, te = /* @__PURE__ */ e(function(e, t, n, r) {
	let i = l().journey, a = "", o = n + (i.height * 2 + i.diagramMarginY), s = 0, c = "#CCC", u = "black", d = 0;
	for (let [n, l] of t.entries()) {
		...
		l.x = n * i.taskMargin + n * i.width + Y, l.y = o, l.width = i.diagramMarginX, l.height = i.diagramMarginY, l.colour = u, l.fill = c, l.num = d, l.actors = f, U.drawTask(e, l, i, r), X.insert(l.x, l.y, l.x + l.width + i.taskMargin, 450);
	}
}, "drawTasks"), $ = {
	setConf: W,
	draw: ee
