...
import { J as n, et as r, f as i, rt as a, tt as o, x as s, z as c } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import "./chunk-PWAF6VOD-CPL-Te_E.mjs";
import "./chunk-GMAD6QVW-4mlTi1Bn.mjs";
import { t as l } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import "./chunk-P2QGCYS3-DGLAAY3E.mjs";
import "./chunk-4HAMMTFA-DyLvtKHk.mjs";
import { i as u, r as d } from "./chunk-GVQU2GXP-QLVNlVya.mjs";
import { n as f } from "./chunk-L3NEJ4N5-xQTuRmpd.mjs";
import { f as p, n as m, t as h } from "./mermaid.core-DuekSTCI.mjs";
...
var g = (function() {
	...
	return e(S, "Parser"), S.prototype = x, x.Parser = S, new S();
})();
g.parser = g;
var _ = g, v = [], y = [], b = 0, x = {}, S = /* @__PURE__ */ e(() => {
	v = [], y = [], b = 0, x = {};
}, "clear"), C = /* @__PURE__ */ e((e) => {
...
}, "getSection"), w = /* @__PURE__ */ e(function() {
	return y;
}, "getSections"), T = /* @__PURE__ */ e(function() {
	let e = [], t = [], n = w(), r = s();
	for (let e of n) {
		let n = {
			id: e.id,
		...
		t.push(n);
		let i = v.filter((t) => t.parentId === e.id);
		for (let n of i) {
			let i = {
				id: n.id,
				parentId: e.id,
...
}, "getData"), E = /* @__PURE__ */ e((e, t, n, r, a) => {
	let o = s(), l = o.mindmap?.padding ?? i.mindmap.padding;
	switch (r) {
		case D.ROUNDED_RECT:
		case D.RECT:
		case D.HEXAGON: l *= 2;
	...
	let u = {
		...
		level: e,
		label: c(n, o),
		width: o.mindmap?.maxNodeWidth ?? i.mindmap.maxNodeWidth,
		padding: l,
		isGroup: !1
	};
	if (a !== void 0) {
	...
	setElementForId: /* @__PURE__ */ e((e, t) => {
		x[e] = t;
	}, "setElementForId"),
	decorateNode: /* @__PURE__ */ e((e) => {
		if (!e) return;
		let t = s(), n = v[v.length - 1];
		e.icon && (n.icon = c(e.icon, t)), e.class && (n.cssClasses = c(e.class, t));
	}, "decorateNode"),
	type2Str: /* @__PURE__ */ e((e) => {
		switch (e) {
	...
	getElementById: /* @__PURE__ */ e((e) => x[e], "getElementById")
}, k = { draw: /* @__PURE__ */ e(async (e, r, a, o) => {
	t.debug("Rendering kanban diagram\n" + e);
	let c = o.db.getData(), l = s();
	l.htmlLabels = !1;
	let m = p(r);
	for (let e of c.nodes) e.domId = `${r}-${e.id}`;
	let h = m.append("g");
	h.attr("class", "sections");
	let g = m.append("g");
	g.attr("class", "items");
	let _ = c.nodes.filter((e) => e.isGroup), v = 0, y = [], b = 25;
	for (let e of _) {
		let t = l?.kanban?.sectionWidth || 200;
	...
	for (let e of _) {
		let t = y[x];
		x += 1;
		let n = l?.kanban?.sectionWidth || 200, r = -n * 3 / 2 + b, i = r, a = c.nodes.filter((t) => t.parentId === e.id);
		for (let t of a) {
			if (t.isGroup) throw Error("Groups within groups are not allowed in Kanban diagrams");
			t.x = e.x, t.width = n - 15;
			let r = (await d(g, t, { config: l })).node().getBBox();
			t.y = i + r.height / 2, await u(t), i = t.y + r.height / 2 + 5;
		}
		let o = t.cluster.select("rect"), s = Math.max(i - r + 30, 50) + (b - 25);
		o.attr("height", s);
	}
	n(void 0, m, l.mindmap?.padding ?? i.kanban.padding, l.mindmap?.useMaxWidth ?? i.kanban.useMaxWidth);
}, "draw") }, A = /* @__PURE__ */ e((t) => {
	let n = "";
	for (let e = 0; e < t.THEME_COLOR_LIMIT; e++) t["lineColor" + e] = t["lineColor" + e] || t["cScaleInv" + e], a(t["lineColor" + e]) ? t["lineColor" + e] = o(t["lineColor" + e], 20) : t["lineColor" + e] = r(t["lineColor" + e], 20);
	let i = /* @__PURE__ */ e((e, n) => t.darkMode ? r(e, n) : o(e, n), "adjuster");
