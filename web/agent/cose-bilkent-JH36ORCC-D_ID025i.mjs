...
import { m as r, p as i } from "./src-DKnM293t.mjs";
import { t as a } from "./cytoscape.esm-CIHnfaA4.mjs";
		...
		return (function(e) {
			...
			(function(e, t, n) {
				...
				v.prototype.newGraphManager = function() {
					...
					r.prototype.initParameters.call(this, arguments), this.isSubLayout || (this.idealEdgeLength = c.DEFAULT_EDGE_LENGTH < 10 ? 10 : c.DEFAULT_EDGE_LENGTH, this.useSmartIdealEdgeLengthCalculation = c.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION, this.springConstant = l.DEFAULT_SPRING_STRENGTH, this.repulsionConstant = l.DEFAULT_REPULSION_STRENGTH, this.gravityConstant = l.DEFAULT_GRAVITY_STRENGTH, this.compoundGravityConstant = l.DEFAULT_COMPOUND_GRAVITY_STRENGTH, this.gravityRangeFactor = l.DEFAULT_GRAVITY_RANGE_FACTOR, this.compoundGravityRangeFactor = l.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR, this.prunedNodesAll = [], this.growTreeIterations = 0, this.afterGrowthIterations = 0, this.isTreeGrowing = !1, this.isGrowthFinished = !1, this.coolingCycle = 0, this.maxCoolingCycle = this.maxIterations / l.CONVERGENCE_CHECK_PERIOD, this.finalTemperature = l.CONVERGENCE_CHECK_PERIOD / this.maxIterations, this.coolingAdjuster = 1);
...
function d(e) {
	return new Promise((t) => {
		let n = i("body").append("div").attr("id", "cy").attr("style", "display:none"), o = a({
		...
		n.remove(), l(e.nodes, o), u(e.edges, o), o.nodes().forEach(function(e) {
			e.layoutDimensions = () => {
				let t = e.data();
				return {
					w: t.width,
			...
			r.info("Cytoscape ready", e), t(o);
		});
	});
}
n(d, "createCytoscapeInstance");
function f(e) {
...
n(p, "extractPositionedEdges");
async function m(e, t) {
	r.debug("Starting cose-bilkent layout algorithm");
	try {
		h(e);
		let t = await d(e), n = f(t), i = p(t);
...
n(h, "validateLayoutData");
var g = /* @__PURE__ */ n(async (e, t, { insertCluster: n, insertEdge: r, insertEdgeLabel: i, insertMarkers: a, insertNode: o, log: s, positionEdgeLabel: c }, { algorithm: l }) => {
