...
import { a as r, b as i, c as a, it as o, s, x as c } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { t as l } from "./channel-B0B0j90Y.mjs";
import { A as u, B as d, C as f, D as p, E as m, F as h, G as g, H as _, I as v, L as y, M as b, N as x, O as S, P as C, R as w, T, U as E, V as D, W as O, b as k, j as A, k as j, l as M, v as ee, w as te, z as ne } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import "./chunk-PWAF6VOD-CPL-Te_E.mjs";
import "./chunk-GMAD6QVW-4mlTi1Bn.mjs";
import { t as re } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import "./chunk-P2QGCYS3-DGLAAY3E.mjs";
import "./chunk-4HAMMTFA-DyLvtKHk.mjs";
import { i as ie, r as N } from "./chunk-GVQU2GXP-QLVNlVya.mjs";
import { a as ae, c as oe, i as se, s as ce } from "./chunk-OSK3NFVY-Bbxjh8pF.mjs";
import { t as le } from "./graphlib-W4p2eKAU.mjs";
...
function de(e) {
	...
	if (t === "[object Boolean]" || t === "[object Number]" || t === "[object String]") {
		...
		return t === "[object String]" ? me(r, e) : P(r, e), r;
	}
	...
	if (t === "[object Arguments]") {
		let t = e, n = {};
		return P(n, t), n.length = t.length, n[Symbol.iterator] = t[Symbol.iterator], n;
	}
	let n = {};
	return he(n, e), P(n, e), pe(n, e), n;
}
function fe(e) {
	switch (g(e)) {
		case f:
		...
		performAction: /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
			...
			switch (i) {
				...
				case 11:
					...
					break;
				case 12:
					r.getLogger().debug("Rule: statement: ", a[s]), this.$ = typeof a[s].length == "number" ? a[s] : [a[s]];
					break;
				case 13:
...
F.parser = F;
var ge = F, I = /* @__PURE__ */ new Map(), L = [], R = /* @__PURE__ */ new Map(), _e = "color", z = "fill", ve = "bgFill", ye = ",", B = /* @__PURE__ */ new Map(), V = "", be = /* @__PURE__ */ e((e) => s.sanitizeText(e, c()), "sanitizeText"), xe = /* @__PURE__ */ e(function(e, t = "") {
	let n = B.get(e);
	n || (n = {
		id: e,
		styles: [],
		textStyles: []
	}, B.set(e, n)), t?.split(ye).forEach((e) => {
		let t = e.replace(/([^;]*);/, "$1").trim();
		if (RegExp(_e).exec(e)) {
			let e = t.replace(z, ve).replace(_e, z);
			n.textStyles.push(e);
		}
		n.styles.push(t);
	});
}, "addStyleClass"), Se = /* @__PURE__ */ e(function(e, t = "") {
	let n = I.get(e);
	t != null && (n.styles = t.split(ye));
}, "addStyle2Node"), Ce = /* @__PURE__ */ e(function(e, t) {
...
}, "setCssClass"), we = /* @__PURE__ */ e((e, n) => {
	let r = e.flat(), i = [], a = r.find((e) => e?.type === "column-setting")?.columns ?? -1;
	for (let e of r) {
		if (typeof a == "number" && a > 0 && e.type !== "column-setting" && typeof e.widthInColumns == "number" && e.widthInColumns > a && t.warn(`Block ${e.id} width ${e.widthInColumns} exceeds configured column width ${a}`), e.label && (e.label = be(e.label)), e.type === "classDef") {
			xe(e.id, e.css);
			continue;
		}
		if (e.type === "applyClass") {
			Ce(e.id, e?.styleClass ?? "");
			continue;
		}
		if (e.type === "applyStyles") {
			e?.stylesStr && Se(e.id, e?.stylesStr);
			continue;
		}
		if (e.type === "column-setting") n.columns = e.columns ?? -1;
		else if (e.type === "edge") {
			let t = (R.get(e.id) ?? 0) + 1;
			R.set(e.id, t), e.id = t + "-" + e.id, L.push(e);
		} else {
			e.label || (e.label = e.type === "composite" ? "" : e.id);
			let t = I.get(e.id);
			if (t === void 0 ? I.set(e.id, e) : (e.type !== "na" && (t.type = e.type), e.label !== e.id && (t.label = e.label)), e.children && we(e.children, e), e.type === "space") {
				let t = e.width ?? 1;
				for (let n = 0; n < t; n++) {
					let t = de(e);
					t.id = t.id + "-" + n, I.set(t.id, t), i.push(t);
				}
			} else t === void 0 && i.push(e);
		}
	}
	n.children = i;
}, "populateBlockDatabase"), H = [], U = {
	id: "root",
	type: "composite",
	children: [],
	columns: -1
}, Te = /* @__PURE__ */ e(() => {
	t.debug("Clear called"), r(), U = {
		id: "root",
		type: "composite",
		children: [],
		columns: -1
	}, I = /* @__PURE__ */ new Map([["root", U]]), H = [], B = /* @__PURE__ */ new Map(), L = [], R = /* @__PURE__ */ new Map(), V = "";
}, "clear");
function Ee(e) {
...
e(ke, "edgeStrToEdgeStartData");
function Ae(e) {
	return e.includes("==") ? "thick" : "normal";
}
e(Ae, "edgeStrToThickness");
function W(e) {
	return e.includes(".-") ? "dotted" : "solid";
}
e(W, "edgeStrToPattern");
var G = 0, je = {
	getConfig: /* @__PURE__ */ e(() => i().block, "getConfig"),
	typeStr2Type: Ee,
	edgeTypeStr2Type: De,
	edgeStrToEdgeData: Oe,
	edgeStrToEdgeStartData: ke,
	edgeStrToThickness: Ae,
	edgeStrToPattern: W,
	getLogger: /* @__PURE__ */ e(() => t, "getLogger"),
	getBlocksFlat: /* @__PURE__ */ e(() => [...I.values()], "getBlocksFlat"),
	getBlocks: /* @__PURE__ */ e(() => H || [], "getBlocks"),
	getEdges: /* @__PURE__ */ e(() => L, "getEdges"),
	setHierarchy: /* @__PURE__ */ e((e) => {
		U.children = e, we(e, U), H = U.children;
	}, "setHierarchy"),
	getBlock: /* @__PURE__ */ e((e) => I.get(e), "getBlock"),
	...
	clear: Te,
	generateId: /* @__PURE__ */ e(() => (G++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + G), "generateId"),
	setDiagramId: /* @__PURE__ */ e((e) => {
		V = e;
	}, "setDiagramId"),
	getDiagramId: /* @__PURE__ */ e(() => V, "getDiagramId")
}, K = /* @__PURE__ */ e((e, t) => {
	let n = l, r = n(e, "r"), i = n(e, "g"), a = n(e, "b");
	return o(r, i, a, t);
}, "fade"), Me = /* @__PURE__ */ e((e) => `.label {
  ...
  .node .cluster {
    // fill: ${K(e.mainBkg, .5)};
    fill: ${K(e.clusterBkg, .5)};
    stroke: ${K(e.clusterBorder, .2)};
...
function J(e, n, r = 0, i = 0, a = 8) {
	...
	if (e.children?.length > 0) {
		for (let t of e.children) J(t, n, 0, 0, a);
		let c = Ne(e);
		o = c.width, s = c.height, t.debug("setBlockSizes abc95 maxWidth of", e.id, ":s children is ", o, s);
		for (let n of e.children) n.size && (t.debug(`abc95 Setting size of children of ${e.id} id=${n.id} ${o} ${s} ${JSON.stringify(n.size)}`), n.size.width = o * (n.widthInColumns ?? 1) + a * ((n.widthInColumns ?? 1) - 1), n.size.height = s, n.size.x = 0, n.size.y = 0, t.debug(`abc95 updating size of ${e.id} children child:${n.id} maxWidth:${o} maxHeight:${s}`));
		for (let t of e.children) J(t, n, o, s, a);
		let l = e.columns ?? -1, u = 0;
		for (let t of e.children) u += t.widthInColumns ?? 1;
		let d = e.children.length;
		l > 0 && l < u && (d = l);
		let f = Math.ceil(u / d), p = d * (o + a) + a, m = f * (s + a) + a;
		if (p < r) {
			t.debug(`Detected to small sibling: abc95 ${e.id} siblingWidth ${r} siblingHeight ${i} width ${p}`), p = r, m = i;
			let n = (r - d * a - a) / d, c = (i - f * a - a) / f;
			t.debug("Size indata abc88", e.id, "childWidth", n, "maxWidth", o), t.debug("Size indata abc88", e.id, "childHeight", c, "maxHeight", s), t.debug("Size indata abc88 xSize", d, "padding", a);
			for (let t of e.children) t.size && (t.size.width = n, t.size.height = c, t.size.x = 0, t.size.y = 0);
		}
		if (t.debug(`abc95 (finale calc) ${e.id} xSize ${d} ySize ${f} columns ${l}${e.children.length} width=${Math.max(p, e.size?.width || 0)}`), p < (e?.size?.width || 0)) {
			p = e?.size?.width || 0;
			let n = l > 0 ? Math.min(e.children.length, l) : e.children.length;
			if (n > 0) {
				let r = (p - n * a - a) / n;
				t.debug("abc95 (growing to fit) width", e.id, p, e.size?.width, r);
...
function Y(e, n, r = 8) {
	...
	let i = e.columns ?? -1;
	if (t.debug("layoutBlocks columns abc95", e.id, "=>", i, e), e.children && e.children.length > 0) {
		let a = e?.children[0]?.size?.width ?? 0, o = e.children.length * a + (e.children.length - 1) * r;
		t.debug("widthOfChildren 88", o, "posX");
		let s = /* @__PURE__ */ new Map();
		{
			let t = 0;
			for (let n of e.children) {
				if (!n.size) continue;
				let { py: e } = q(i, t), r = s.get(e) ?? 0;
				n.size.height > r && s.set(e, n.size.height);
				let a = n?.widthInColumns ?? 1;
				i > 0 && (a = Math.min(a, i - t % i)), t += a;
			}
		}
		let c = /* @__PURE__ */ new Map();
		{
			let e = 0, t = [...s.keys()].sort((e, t) => e - t);
			for (let n of t) c.set(n, e), e += (s.get(n) ?? 0) + r;
		}
		let l = 0;
		t.debug("abc91 block?.size?.x", e.id, e?.size?.x);
		let u = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -r, d = 0;
		for (let a of e.children) {
			let o = e;
			if (!a.size) continue;
			let { width: f, height: p } = a.size, { px: m, py: h } = q(i, l);
			if (h != d && (d = h, u = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -r, t.debug("New row in layout for block", e.id, " and child ", a.id, d)), t.debug(`abc89 layout blocks (child) id: ${a.id} Pos: ${l} (px, py) ${m},${h} (${o?.size?.x},${o?.size?.y}) parent: ${o.id} width: ${f}${r}`), o.size) {
				let e = f / 2;
				a.size.x = u + r + e, t.debug(`abc91 layout blocks (calc) px, pyid:${a.id} startingPos=X${u} new startingPosX${a.size.x} ${e} padding=${r} width=${f} halfWidth=${e} => x:${a.size.x} y:${a.size.y} ${a.widthInColumns} (width * (child?.w || 1)) / 2 ${f * (a?.widthInColumns ?? 1) / 2}`), u = a.size.x + e;
				let n = c.get(h) ?? 0, i = s.get(h) ?? p;
				a.size.y = o.size.y - o.size.height / 2 + n + i / 2 + r, t.debug(`abc88 layout blocks (calc) px, pyid:${a.id}startingPosX${u}${r}${e}=>x:${a.size.x}y:${a.size.y}${a.widthInColumns}(width * (child?.w || 1)) / 2${f * (a?.widthInColumns ?? 1) / 2}`);
			}
			a.children && Y(a, n, r);
			let g = a?.widthInColumns ?? 1;
			i > 0 && (g = Math.min(g, i - l % i)), l += g, t.debug("abc88 columnsPos", a, l);
		}
	}
	t.debug(`layout blocks (<==layoutBlocks) ${e.id} x: ${e?.size?.x} y: ${e?.size?.y} width: ${e?.size?.width}`);
}
e(Y, "layoutBlocks");
function X(e, { minX: t, minY: n, maxX: r, maxY: i } = {
	minX: 0,
	minY: 0,
	maxX: 0,
	maxY: 0
	...
	if (e.children) for (let a of e.children) ({minX: t, minY: n, maxX: r, maxY: i} = X(a, {
		minX: t,
		minY: n,
		maxX: r,
		maxY: i
...
function Z(e) {
	...
	if (!n) return;
	let r = c()?.block?.padding ?? 8;
	J(n, e, 0, 0, r), Y(n, e, r), t.debug("getBlocks", JSON.stringify(n, null, 2));
	let { minX: i, minY: a, maxX: o, maxY: s } = X(n), l = s - a;
	return {
		x: i,
		y: a,
		width: o - i,
...
function Q(e, t, n = !1) {
	let r = e, a = "default";
	(r?.classes?.length || 0) > 0 && (a = (r?.classes ?? []).join(" ")), a += " flowchart-label";
	let o = (r?.classes ?? []).flatMap((e) => t.getClasses().get(e)?.styles ?? []), s = 0, c = "rect", l;
	switch (r.type) {
		case "round":
			s = 5, c = "rect";
			break;
	...
	let u = M(r?.styles ?? []), d = r.label, f = r.size ?? {
		width: 0,
		height: 0,
		x: 0,
		y: 0
	...
	return {
		...
		wrappingWidth: f.width || Infinity,
		x: f.x,
		y: f.y,
		positioned: n,
		intersect: void 0,
		padding: l ?? i()?.block?.padding ?? 0,
		widthInColumns: r.widthInColumns ?? 1
	};
}
e(Q, "getNodeFromBlock");
async function Pe(e, t, n) {
	let r = Q(t, n, !1);
	if (t.type === "group") return;
	let a = i(), o = await N(e, r, { config: a }), s = o.node()?.getBBox() ?? {
		width: 0,
		height: 0
	}, c = n.getBlock(r.id);
	c.size = {
		...
		y: 0,
		node: o
	}, n.setBlock(c), o.remove();
}
e(Pe, "calculateBlockSize");
async function Fe(e, t, n) {
	let r = Q(t, n, !0);
	if (n.getBlock(r.id).type !== "space") {
		let n = i();
		await N(e, r, { config: n }), t.intersect = r?.intersect, ie(r);
	}
}
e(Fe, "insertBlockPositioned");
	...
	for (let n of t) if (n.start && n.end) {
		...
		if (t?.size && o?.size) {
			...
			se(e, {
				...
				points: c,
				classes: u
			}, {}, "block", a.node(n.start), a.node(n.end), i), n.label && (await ae(e, {
				...n,
				label: n.label,
...
var ze = {
	...
	db: je,
	renderer: {
		draw: /* @__PURE__ */ e(async function(e, r, o, s) {
			let { securityLevel: c, block: l } = i(), u = s.db;
			u.setDiagramId(r);
			let d;
			c === "sandbox" && (d = n("#i" + r));
			...
			await Ie(_, m, u);
			let v = Z(u);
			await Le(_, m, u), await Re(_, g, h, u, r);
			let y = _.node()?.getBBox(), b = y && Number.isFinite(y.width) && Number.isFinite(y.height) ? y : v;
			if (b) {
				let e = Math.max(1, Math.round(.125 * (b.width / b.height))), n = b.height + e + 10, r = b.width + 10, { useMaxWidth: i } = l;
				a(p, n, r, !!i), t.debug("Here Bounds", v, b), p.attr("viewBox", `${b.x - 5} ${b.y - 5} ${b.width + 10} ${b.height + 10}`);
			}
		}, "draw"),
