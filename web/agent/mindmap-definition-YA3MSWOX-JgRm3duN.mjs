import { t as e } from "./v4-BZmdGEh9.mjs";
import { n as t } from "./chunk-Y2CYZVJY-i11wjrBe.mjs";
import { m as n } from "./src-DKnM293t.mjs";
import { b as r, et as i, f as a, k as o, rt as s, tt as c, x as l, z as u } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
...
import { t as d } from "./chunk-XXDRQBXY-DPtumRZh.mjs";
import { t as f } from "./chunk-POPQ4Y6H-C5gbCr3a.mjs";
import "./chunk-L3NEJ4N5-xQTuRmpd.mjs";
import { d as p, u as m } from "./mermaid.core-DuekSTCI.mjs";
		...
		performAction: /* @__PURE__ */ t(function(e, t, n, r, i, a, o) {
			...
			switch (i) {
				...
				case 26:
					...
					break;
				case 27: r.getLogger().trace("node found ..", a[s - 3]), this.$ = {
					id: a[s - 3],
					descr: a[s - 1],
					type: r.getType(a[s - 2], a[s])
				};
...
var _ = g, v = 12, y = {
	...
	constructor() {
		this.nodes = [], this.count = 0, this.elements = {}, this.getLogger = this.getLogger.bind(this), this.nodeType = y, this.clear(), this.getType = this.getType.bind(this), this.getElementById = this.getElementById.bind(this), this.getParent = this.getParent.bind(this), this.getMindmap = this.getMindmap.bind(this), this.addNode = this.addNode.bind(this), this.decorateNode = this.decorateNode.bind(this);
	}
	clear() {
	...
	addNode(e, t, r, i) {
		n.info("addNode", e, t, r, i);
		let o = !1;
		this.nodes.length === 0 ? (this.baseLevel = e, e = 0, o = !0) : this.baseLevel !== void 0 && (e -= this.baseLevel, o = !1);
		let s = l(), c = s.mindmap?.padding ?? a.mindmap.padding;
		switch (i) {
			case this.nodeType.ROUNDED_RECT:
			case this.nodeType.RECT:
			case this.nodeType.HEXAGON: c *= 2;
		}
		let d = {
			id: this.count++,
			nodeId: u(t, s),
			...
			type: i,
			children: [],
			width: s.mindmap?.maxNodeWidth ?? a.mindmap.maxNodeWidth,
			padding: c,
			isRoot: o
		}, f = this.getParent(e);
	...
	getType(e, t) {
		switch (n.debug("In get type", e, t), e) {
	...
	decorateNode(e) {
		if (!e) return;
		let t = l(), n = this.nodes[this.nodes.length - 1];
		e.icon && (n.icon = u(e.icon, t)), e.class && (n.class = u(e.class, t));
	}
	type2Str(e) {
		switch (e) {
	...
	assignSections(e, t) {
		if (e.section = e.level === 0 ? void 0 : t, e.children) for (let [n, r] of e.children.entries()) {
			let i = e.level === 0 ? n % (v - 1) : t;
			this.assignSections(r, i);
		}
	}
	flattenNodes(e, n) {
		let r = l(), i = ["mindmap-node"];
		e.isRoot === !0 ? i.push("section-root", "section--1") : e.section !== void 0 && i.push(`section-${e.section}`), e.class && i.push(e.class);
		let a = i.join(" "), o = /* @__PURE__ */ t((e) => {
			let t = (r.theme?.toLowerCase() ?? "").includes("redux");
			switch (e) {
				case y.CIRCLE: return "mindmapCircle";
				case y.RECT: return "rect";
				case y.ROUNDED_RECT: return "rounded";
				case y.CLOUD: return "cloud";
				case y.BANG: return "bang";
				case y.HEXAGON: return "hexagon";
				case y.DEFAULT: return t ? "rounded" : "defaultMindmapNode";
				case y.NO_BORDER:
				default: return "rect";
			}
		}, "getShapeFromType"), s = {
		...
		if (n.push(s), e.children) for (let t of e.children) this.flattenNodes(t, n);
	}
	generateEdges(e, t) {
	...
	getData() {
		let t = this.getMindmap(), r = l(), i = o().layout !== void 0, a = r;
		if (i || (a.layout = "cose-bilkent"), !t) return {
			nodes: [],
			edges: [],
			config: a
		};
		n.debug("getData: mindmapRoot", t, r), this.assignSections(t);
		let s = [], c = [];
		this.flattenNodes(t, s), this.generateEdges(t, c), n.debug(`getData: processed ${s.length} nodes and ${c.length} edges`);
		let u = /* @__PURE__ */ new Map();
		for (let e of s) u.set(e.id, {
			shape: e.shape,
			width: e.width,
			height: e.height,
			padding: e.padding
...
}, t(h, "MindmapDB"), h), x = { draw: /* @__PURE__ */ t(async (e, t, i, o) => {
	n.debug("Rendering mindmap diagram\n" + e);
	let s = o.db, c = s.getData(), l = d(t, c.config.securityLevel);
	if (c.type = o.type, c.layoutAlgorithm = m(c.config.layout, { fallback: "cose-bilkent" }), c.diagramId = t, !s.getMindmap()) return;
	c.nodes.forEach((e) => {
	...
	let { themeVariables: u } = r(), { useGradient: h, gradientStart: g, gradientStop: _ } = u;
	if (h && g && _) {
	...
	f(l, c.config.mindmap?.padding ?? a.mindmap.padding, "mindmapDiagram", c.config.mindmap?.useMaxWidth ?? a.mindmap.useMaxWidth);
}, "draw") }, S = /* @__PURE__ */ t((e) => {
	let { theme: t, look: n } = e, r = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t], s(e["lineColor" + t]) ? e["lineColor" + t] = c(e["lineColor" + t], 20) : e["lineColor" + t] = i(e["lineColor" + t], 20);
	for (let i = 0; i < e.THEME_COLOR_LIMIT; i++) {
		let a = "" + (n === "neo" ? Math.max(10 - (i - 1) * 2, 2) : 17 - 3 * i);
		r += `
	...
	return r;
}, "genSections"), C = /* @__PURE__ */ t((e, t, n) => {
	let r = "";
	for (let i = 0; i < e; i++) r += `
    [data-look="neo"].mindmap-node.section-${i - 1} rect, [data-look="neo"].mindmap-node.section-${i - 1} path, [data-look="neo"].mindmap-node.section-${i - 1} circle, [data-look="neo"].mindmap-node.section-${i - 1} polygon {
  ...
  ${e.useGradient && n && e.mainBkg ? C(e.THEME_COLOR_LIMIT, n, e.mainBkg) : ""}
`;
	}, "getStyles")
};
//#endregion
