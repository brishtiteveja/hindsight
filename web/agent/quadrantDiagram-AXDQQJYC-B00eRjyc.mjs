...
import { D as r, H as i, K as a, U as o, a as s, c, f as l, v as u, w as d, x as f, y as p, z as m } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { t as h } from "./linear-DhhH3tye.mjs";
...
var g, _, v = (function() {
	var t = /* @__PURE__ */ e(function(e, t, n, r) {
		...
		56,
		57
	], u = [2, 36], d = [1, 37], f = [1, 36], p = [1, 38], m = [1, 35], h = [1, 43], g = [1, 41], _ = [1, 45], v = [1, 14], y = [1, 23], b = [1, 18], x = [1, 19], S = [1, 20], C = [1, 21], w = [1, 22], T = [1, 24], E = [1, 25], D = [1, 26], O = [1, 27], k = [1, 28], A = [1, 29], j = [1, 32], M = [1, 33], N = [1, 34], P = [1, 39], F = [1, 40], I = [1, 42], L = [1, 44], R = [1, 63], z = [1, 62], B = [
		4,
		5,
		8,
		10,
		...
		66,
		67
	], V = [1, 66], ee = [1, 67], te = [1, 68], ne = [1, 69], re = [1, 70], ie = [1, 71], ae = [1, 72], oe = [1, 73], se = [1, 74], ce = [1, 75], le = [1, 76], ue = [1, 77], H = [
		4,
		5,
		6,
		7,
		...
		15,
		18
	], U = [1, 91], W = [1, 92], G = [1, 93], K = [1, 100], q = [1, 94], J = [1, 97], Y = [1, 95], X = [1, 96], Z = [1, 98], Q = [1, 99], de = [1, 103], fe = [
		10,
		55,
		56,
		57
	...
	return e(me, "Parser"), me.prototype = pe, pe.Parser = me, new me();
})();
v.parser = v;
var y = v, b = r(), x = (g = class {
	constructor() {
	...
	getDefaultConfig() {
		return {
			...
			showYAxis: !0,
			showTitle: !0,
			chartHeight: l.quadrantChart?.chartWidth || 500,
			chartWidth: l.quadrantChart?.chartHeight || 500,
			titlePadding: l.quadrantChart?.titlePadding || 10,
			titleFontSize: l.quadrantChart?.titleFontSize || 20,
			quadrantPadding: l.quadrantChart?.quadrantPadding || 5,
			xAxisLabelPadding: l.quadrantChart?.xAxisLabelPadding || 5,
			yAxisLabelPadding: l.quadrantChart?.yAxisLabelPadding || 5,
			xAxisLabelFontSize: l.quadrantChart?.xAxisLabelFontSize || 16,
			yAxisLabelFontSize: l.quadrantChart?.yAxisLabelFontSize || 16,
			quadrantLabelFontSize: l.quadrantChart?.quadrantLabelFontSize || 16,
			quadrantTextTopPadding: l.quadrantChart?.quadrantTextTopPadding || 5,
			pointTextPadding: l.quadrantChart?.pointTextPadding || 5,
			pointLabelFontSize: l.quadrantChart?.pointLabelFontSize || 12,
			pointRadius: l.quadrantChart?.pointRadius || 5,
			xAxisPosition: l.quadrantChart?.xAxisPosition || "top",
			yAxisPosition: l.quadrantChart?.yAxisPosition || "left",
			quadrantInternalBorderStrokeWidth: l.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
			quadrantExternalBorderStrokeWidth: l.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
		};
	}
...
var D = new x();
function O(e) {
	D.setData({ quadrant1Text: E(e.text) });
}
e(O, "setQuadrant1Text");
function k(e) {
	D.setData({ quadrant2Text: E(e.text) });
}
e(k, "setQuadrant2Text");
function A(e) {
	D.setData({ quadrant3Text: E(e.text) });
}
e(A, "setQuadrant3Text");
function j(e) {
	D.setData({ quadrant4Text: E(e.text) });
}
e(j, "setQuadrant4Text");
function M(e) {
	D.setData({ xAxisLeftText: E(e.text) });
}
e(M, "setXAxisLeftText");
function N(e) {
	D.setData({ xAxisRightText: E(e.text) });
}
e(N, "setXAxisRightText");
function P(e) {
	D.setData({ yAxisTopText: E(e.text) });
}
e(P, "setYAxisTopText");
function F(e) {
	D.setData({ yAxisBottomText: E(e.text) });
}
e(F, "setYAxisBottomText");
function I(e) {
	let t = {};
	for (let n of e) {
		let [e, r] = n.trim().split(/\s*:\s*/);
		if (e === "radius") {
			if (w(r)) throw new S(e, r, "number");
			t.radius = parseInt(r);
		} else if (e === "color") {
			if (C(r)) throw new S(e, r, "hex code");
			t.color = r;
		} else if (e === "stroke-color") {
			if (C(r)) throw new S(e, r, "hex code");
			t.strokeColor = r;
		} else if (e === "stroke-width") {
			if (T(r)) throw new S(e, r, "number of pixels (eg. 10px)");
			t.strokeWidth = r;
...
e(R, "addClass");
function z(e) {
	D.setConfig({ chartWidth: e });
}
e(z, "setWidth");
function B(e) {
	D.setConfig({ chartHeight: e });
}
e(B, "setHeight");
function V() {
	let { themeVariables: e, quadrantChart: t } = f();
	return t && D.setConfig(t), D.setThemeConfig({
...
var ee = {
	...
	renderer: { draw: /* @__PURE__ */ e((r, i, a, o) => {
		function s(e) {
			return e === "top" ? "hanging" : "middle";
		}
		e(s, "getDominantBaseLine");
		function l(e) {
		...
		e(u, "getTransformation");
		let d = f();
		t.debug("Rendering quadrant chart\n" + r);
		let p = d.securityLevel, m;
		p === "sandbox" && (m = n("#i" + i));
		let h = n(p === "sandbox" ? m.nodes()[0].contentDocument.body : "body").select(`[id="${i}"]`), g = h.append("g").attr("class", "main"), _ = d.quadrantChart?.chartWidth ?? 500, v = d.quadrantChart?.chartHeight ?? 500;
		c(h, v, _, d.quadrantChart?.useMaxWidth ?? !0), h.attr("viewBox", "0 0 " + _ + " " + v), o.db.setHeight(v), o.db.setWidth(_);
