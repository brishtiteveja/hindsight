...
import { t as n } from "./defineProperty-DxjBOsvz.mjs";
import { n as r } from "./chunk-Y2CYZVJY-i11wjrBe.mjs";
import { m as i, p as a } from "./src-DKnM293t.mjs";
import { A as o, F as s, b as c, s as l, z as u } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { a as d } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { n as f, t as p } from "./chunk-PWAF6VOD-CPL-Te_E.mjs";
...
var m = /* @__PURE__ */ t(((e, t) => {
	(function(e) {
		...
		function r() {
			var t = this;
			t.reads = [], t.writes = [], t.raf = n.bind(e);
		}
		r.prototype = {
			constructor: r,
			runTasks: function(e) {
			...
			clear: function(e) {
				return o(this.reads, e) || o(this.writes, e);
			},
			extend: function(e) {
				if (typeof e != "object") throw Error("expected object");
				var t = Object.create(this);
				return s(t, e), t.fastdom = this, t.initialize && t.initialize(), t;
			},
			catch: null
		};
		function i(e) {
		...
		function a(e) {
			var t = e.writes, n = e.reads, r;
			try {
				n.length, e.runTasks(n), t.length, e.runTasks(t);
			} catch (e) {
				r = e;
			}
			if (e.scheduled = !1, (n.length || t.length) && i(e), r) {
				if (r.message, e.catch) e.catch(r);
				else throw r;
			}
		}
		function o(e, t) {
		...
		var c = e.fastdom = e.fastdom || new r();
		typeof define == "function" ? define(function() {
			return c;
		}) : typeof t == "object" && (t.exports = c);
	...
	(function() {
		var e = {
			...
			mutate: function(e, t) {
				return n(this, "mutate", e, t);
			},
			measure: function(e, t) {
				return n(this, "measure", e, t);
			},
			clear: function(e) {
				var t = this._tasks, n = t.get(e);
				this.fastdom.clear(n), t.delete(e);
			}
		};
		function n(e, t, n, r) {
			var i = e._tasks, a = e.fastdom, o, s = new Promise(function(e, c) {
				o = a[t](function() {
					i.delete(s);
					try {
						e(r ? n.call(r) : n());
		...
		(typeof define)[0] == "f" ? define(function() {
			return e;
		}) : (typeof t)[0] == "o" ? t.exports = e : window.fastdomPromised = e;
	})();
})), ee = /* @__PURE__ */ e(m(), 1), te = /* @__PURE__ */ e(h(), 1), g;
function _() {
	return {
		async: !1,
		breaks: !1,
...
var re = (() => {
...
}, ie = /^(?:[ \t]*(?:\n|$))+/, ae = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, oe = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, S = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, se = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, C = /(?:[*+-]|\d{1,9}[.)])/, ce = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, le = b(ce).replace(/bull/g, C).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), ue = b(ce).replace(/bull/g, C).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), w = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, de = /^[^\n]+/, T = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/, fe = b(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", T).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), pe = b(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, C).getRegex(), E = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", D = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, me = b("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", D).replace("tag", E).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), he = b(w).replace("hr", S).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", E).getRegex(), O = {
	...
	table: y,
	text: de
}, ge = b("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", S).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", E).getRegex(), _e = {
	...O,
	lheading: ue,
	table: ge,
	paragraph: b(w).replace("hr", S).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", ge).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", E).getRegex()
}, ve = {
	...O,
...
}, ye = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, be = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, xe = /^( {2,}|\\)\n(?!\s*$)/, Se = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, k = /[\p{P}\p{S}]/u, A = /[\s\p{P}\p{S}]/u, Ce = /[^\s\p{P}\p{S}]/u, we = b(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, A).getRegex(), Te = /(?!~)[\p{P}\p{S}]/u, Ee = /(?!~)[\s\p{P}\p{S}]/u, De = /(?:[^\s\p{P}\p{S}]|~)/u, Oe = b(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", re ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(), ke = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, Ae = b(ke, "u").replace(/punct/g, k).getRegex(), je = b(ke, "u").replace(/punct/g, Te).getRegex(), Me = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", Ne = b(Me, "gu").replace(/notPunctSpace/g, Ce).replace(/punctSpace/g, A).replace(/punct/g, k).getRegex(), Pe = b(Me, "gu").replace(/notPunctSpace/g, De).replace(/punctSpace/g, Ee).replace(/punct/g, Te).getRegex(), Fe = b("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, Ce).replace(/punctSpace/g, A).replace(/punct/g, k).getRegex(), Ie = b(/\\(punct)/, "gu").replace(/punct/g, k).getRegex(), Le = b(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), Re = b(D).replace("(?:-->|$)", "-->").getRegex(), ze = b("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", Re).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), j = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/, Be = b(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", j).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), Ve = b(/^!?\[(label)\]\[(ref)\]/).replace("label", j).replace("ref", T).getRegex(), He = b(/^!?\[(ref)\](?:\[\])?/).replace("ref", T).getRegex(), Ue = b("reflink|nolink(?!\\()", "g").replace("reflink", Ve).replace("nolink", He).getRegex(), We = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/, M = {
	_backpedal: y,
	anyPunctuation: Ie,
	autolink: Le,
	blockSkip: Oe,
	...
	emStrongLDelim: je,
	url: b(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", We).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),
	_backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,
	del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,
	text: b(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", We).getRegex()
}, Ke = {
	...N,
	br: b(xe).replace("{2,}", "*").getRegex(),
...
function I(e, t) {
	if (t) {
		if (x.escapeTest.test(e)) return e.replace(x.escapeReplace, Je);
	} else if (x.escapeTestNoEncode.test(e)) return e.replace(x.escapeReplaceNoEncode, Je);
	return e;
}
function Ye(e) {
	try {
...
var R = class {
	constructor(e) {
		n(this, "options", void 0), n(this, "rules", void 0), n(this, "lexer", void 0), this.options = e || v;
	}
	space(e) {
	...
	fences(e) {
		...
		if (t) {
			let e = t[0], n = $e(e, t[3] || "", this.rules);
			return {
				type: "code",
				raw: e,
...
${c}` : c;
	...
	table(e) {
		...
		let n = Xe(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split("\n") : [], a = {
			type: "table",
			raw: t[0],
			header: [],
			align: [],
		...
		if (n.length === r.length) {
			...
			for (let e of i) a.rows.push(Xe(e, a.header.length).map((e, t) => ({
				text: e,
				tokens: this.lexer.inline(e),
				header: !1,
				align: a.align[t]
	...
	link(e) {
		...
		if (t) {
			...
			return n = n.trim(), this.rules.other.startAngleBracket.test(n) && (n = this.options.pedantic && !this.rules.other.endAngleBracket.test(e) ? n.slice(1) : n.slice(1, -1)), Qe(t, {
	...
	reflink(e, t) {
		...
		if ((n = this.rules.inline.reflink.exec(e)) || (n = this.rules.inline.nolink.exec(e))) {
			...
			return Qe(n, e, n[0], this.lexer, this.rules);
		}
	}
	emStrong(e, t, n = "") {
	...
	constructor(e) {
		n(this, "tokens", void 0), n(this, "options", void 0), n(this, "state", void 0), n(this, "tokenizer", void 0), n(this, "inlineQueue", void 0), this.tokens = [], this.tokens.links = Object.create(null), this.options = e || v, this.options.tokenizer = this.options.tokenizer || new R(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
			inLink: !1,
			inRawBlock: !1,
			top: !0
		};
	...
	constructor(e) {
		n(this, "options", void 0), n(this, "parser", void 0), this.options = e || v;
	}
	space(e) {
		return "";
	}
...
`;
	...
	link({ href: e, title: t, tokens: n }) {
		let r = this.parser.parseInline(n), i = Ye(e);
		if (i === null) return r;
		e = i;
		let a = "<a href=\"" + e + "\"";
	...
	constructor(e) {
		n(this, "options", void 0), n(this, "renderer", void 0), n(this, "textRenderer", void 0), this.options = e || v, this.options.renderer = this.options.renderer || new B(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new V();
	}
	static parse(t, n) {
	...
	constructor(e) {
		n(this, "options", void 0), n(this, "block", void 0), this.options = e || v;
	}
	preprocess(e) {
		return e;
	}
...
}, n(g, "passThroughHooks", /* @__PURE__ */ new Set([
	"preprocess",
	"postprocess",
	"processAllTokens",
	"emStrongMask"
])), n(g, "passThroughHooksRespectAsync", /* @__PURE__ */ new Set([
	"preprocess",
	"postprocess",
	"processAllTokens"
])), g), W = new class {
	constructor(...e) {
		n(this, "defaults", _()), n(this, "options", this.setOptions), n(this, "parse", this.parseMarkdown(!0)), n(this, "parseInline", this.parseMarkdown(!1)), n(this, "Parser", H), n(this, "Renderer", B), n(this, "TextRenderer", V), n(this, "Lexer", z), n(this, "Tokenizer", R), n(this, "Hooks", U), this.use(...e);
	}
	walkTokens(e, t) {
		let n = [];
...
G.options = G.setOptions = function(e) {
	return W.setOptions(e), G.defaults = W.defaults, ne(G.defaults), G;
}, G.getDefaults = _, G.defaults = v, G.use = function(...e) {
	return W.use(...e), G.defaults = W.defaults, ne(G.defaults), G;
...
var tt, nt, K = typeof performance < "u" && typeof performance.now == "function", q = /* @__PURE__ */ r(() => K ? performance.now() : 0, "now"), J = "🧜 ", rt = "Mermaid render", it = "Mermaid", at = {
	parse: "tertiary",
	prepare: "secondary",
	measure: "primary",
	layout: "primary-dark",
...
tt = class {
	...
	tickSync(e, t) {
		...
		try {
			...
			this.buckets[e] = (this.buckets[e] ?? 0) + (q() - n);
		}
	}
	async tick(e, t) {
		if (!this.enabled) return t();
	...
	stop() {
		...
		let e = this.roots.at(-1), t = this.runLabel ?? e?.name;
		return e && (this.records.push({
			label: t ?? e.name,
			tree: e,
			buckets: { ...this.buckets }
		}), this.records.length > this.maxRecords && this.records.splice(0, this.records.length - this.maxRecords), this.autoPrint && this.printSummary(e, t)), this.runLabel = void 0, e;
	}
	begin(e) {
		if (!this.enabled) return;
		let t = {
		...
		if (n ? n.children.push(t) : this.roots.push(t), this.stack.push(t), K && typeof performance.mark == "function") try {
			performance.mark(`${J}${e} \u25B6`);
		} catch {}
	}
	end() {
		if (!this.enabled) return;
		...
		if (!e) return;
		let t = q();
		if (e.duration = t - e.start, K && typeof performance.measure == "function") try {
			performance.measure(`${J}${e.name}`, {
				start: e.start,
				end: t,
				detail: { devtools: {
	...
	printSummary(e = this.report(), t) {
		if (!e) return;
		let n = e.duration, i = t && t !== e.name ? `${e.name} [${t}]` : e.name, a = ["ms        %    phase"], o = /* @__PURE__ */ r((e, t) => {
			let r = "  ".repeat(t), i = e.duration.toFixed(1).padStart(8), s = n > 0 ? `${(e.duration / n * 100).toFixed(0).padStart(3)}%` : "   -";
			a.push(`${i}  ${s}  ${r}${e.name}`);
			for (let n of e.children) o(n, t + 1);
			if (e.children.length > 0) {
				let t = e.children.reduce((e, t) => e + t.duration, 0), n = e.duration - t;
				if (n > .5) {
					let e = n.toFixed(1).padStart(8);
					a.push(`${e}       ${r}  (self)`);
				}
			}
		}, "walk");
		o(e, 0);
		let s = Object.keys(this.buckets);
		if (s.length > 0) {
			a.push("—— buckets (summed) ——");
			for (let e of s) a.push(`${this.buckets[e].toFixed(1).padStart(8)}       ${e}`);
		}
		console.log(`${J}mermaid render profile \xB7 ${i}
${a.join("\n")}`);
	}
}, r(tt, "Profiler"), (nt = globalThis).injected ?? (nt.injected = {
	includeLargeFeatures: !0,
	profiling: !1,
	version: "0.0.0"
});
var ot = ee.default.extend({ raf(e) {
	typeof queueMicrotask == "function" ? queueMicrotask(e) : setTimeout(e, 0);
} }).extend(te.default);
function st(e, { markdownAutoWrap: t }) {
	return et(e.replace(/<br\/>/g, "\n").replace(/\n{2,}/g, "\n"));
}
r(st, "preprocessMarkdown");
function ct(e) {
...
r(ct, "nonMarkdownToLines");
function lt(e, t = {}) {
	let n = st(e, t), i = G.lexer(n), a = [[]], o = 0;
	...
	return r(s, "processNode"), i.forEach((e) => {
...
r(lt, "markdownToLines");
function ut(e) {
	return e ? `<p>${e.replace(/\\n|\n/g, "<br />")}</p>` : "";
}
r(ut, "nonMarkdownToHTML");
function dt(e, { markdownAutoWrap: t } = {}) {
	let n = G.lexer(e);
	function a(e) {
		return e.type === "text" ? t === !1 ? e.text.replace(/\n */g, "<br/>").replace(/ /g, "&nbsp;") : e.text.replace(/\n */g, "<br/>") : e.type === "strong" ? `<strong>${e.tokens?.map(a).join("")}</strong>` : e.type === "em" ? `<em>${e.tokens?.map(a).join("")}</em>` : e.type === "paragraph" ? `<p>${e.tokens?.map(a).join("")}</p>` : e.type === "space" ? "" : e.type === "html" ? `${e.text}` : e.type === "escape" ? e.text : (i.warn(`Unsupported markdown: ${e.type}`), e.raw);
	}
	return r(a, "output"), n.map(a).join("");
}
r(dt, "markdownToHTML");
function ft(e) {
	return Intl.Segmenter ? [...new Intl.Segmenter().segment(e)].map((e) => e.segment) : [...e];
}
r(ft, "splitTextToChars");
function pt(e, t) {
	return Y(e, [], ft(t.content), t.type);
}
r(pt, "splitWordToFitWidth");
function Y(e, t, n, r) {
	...
	return e([{
		content: o.join(""),
		type: r
	}]) ? Y(e, o, a, r) : (t.length === 0 && i && (t.push(i), n.shift()), [{
		content: t.join(""),
		type: r
	}, {
		content: n.join(""),
...
r(X, "splitLineToFitWidthRecursion");
function Z(e, t) {
	t && e.attr("style", t);
}
r(Z, "applyStyle");
var ht = 16384;
async function gt(e, t, n, r, i = !1, a = c()) {
	let d = e.append("foreignObject");
	d.attr("width", `${Math.min(10 * n, ht)}px`), d.attr("height", `${Math.min(10 * n, ht)}px`);
	let f = d.append("xhtml:div"), p = o(t.label) ? await s(t.label.replace(l.lineBreakRegex, "\n"), a) : u(t.label, a), m = t.isNode ? "nodeLabel" : "edgeLabel", h = f.append("span");
	return h.html(p), Z(h, t.labelStyle), h.attr("class", `${m} ${r}`), Z(f, t.labelStyle), f.style("display", "table-cell"), f.style("white-space", "nowrap"), f.style("line-height", "1.5"), n !== Infinity && (f.style("max-width", n + "px"), f.style("text-align", "center")), f.attr("xmlns", "http://www.w3.org/1999/xhtml"), i && f.attr("class", "labelBkg"), (await ot.measure(() => f.node().getBoundingClientRect())).width === n && (f.style("display", "table"), f.style("white-space", "break-spaces"), f.style("width", n + "px")), d.node();
}
r(gt, "addHtmlSpan");
...
r(vt, "computeDimensionOfText");
function yt(e, t, n, i = !1, a = !1) {
	...
	let u = 0;
	for (let t of n) {
		let n = /* @__PURE__ */ r((t) => _t(s, o, t) <= e, "checkWidth"), i = n(t) ? [t] : mt(t, n);
		for (let e of i) $(Q(l, u, o, a), e), u++;
	}
	if (i) {
...
function $(e, t) {
	e.text(""), t.forEach((t, n) => {
		...
		n === 0 ? r.text(bt(t.content)) : r.text(" " + bt(t.content));
	});
}
r($, "updateTextContentAndStyles");
async function xt(e, t = {}) {
	let n = [];
	e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (e, r, i) => (n.push((async () => {
		let n = `${r}:${i}`;
		return await f(n) ? await p(n, void 0, { class: "label-icon" }) : `<i class='${u(e, t).replace(":", " ")}'></i>`;
	})()), e));
	let r = await Promise.all(n);
	return e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, () => r.shift() ?? "");
}
r(xt, "replaceIconSubstring");
var St = /* @__PURE__ */ r(async (e, t = "", { style: n = "", isTitle: r = !1, classes: s = "", useHtmlLabels: c = !0, markdown: l = !0, isNode: u = !0, width: f = 200, addSvgBackground: p = !1 } = {}, m) => {
	if (i.debug("XYZ createText", t, n, r, s, c, u, "addSvgBackground: ", p), c) {
		let r = l ? dt(t, m) : ut(t), i = await xt(d(r), m), a = t.replace(/\\\\/g, "\\");
		return await gt(e, {
			isNode: u,
			label: o(t) ? a : i,
	...
	{
		let i = d(t.replace(/<br\s*\/?>/g, "<br/>")), o = yt(f, e, l ? lt(i.replace("<br>", "<br/>"), m) : ct(i), t ? p : !1, !u);
		if (u) {
			...
			a(o).select("rect").attr("style", e.replace(/background:/g, "fill:"));
			let t = n.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
			a(o).select("text").attr("style", t);
		}
		return r ? a(o).selectAll("tspan.text-outer-tspan").classed("title-row", !0) : a(o).selectAll("tspan.text-outer-tspan").classed("row", !0), o;
	}
}, "createText");
//#endregion
export { et as i, St as n, ot as r, vt as t };
