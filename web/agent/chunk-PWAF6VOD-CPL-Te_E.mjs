...
import { b as n, z as r } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
...
var i = Object.freeze({
	...
	return null;
}, d = (e, t) => e ? !!((t && e.prefix === "" || e.prefix) && e.name) : !1;
//#endregion
...
function h(e, t, n) {
	...
	return o(t), n.forEach(o), p(e, a);
}
function g(e, t) {
	if (e.icons[t]) return h(e, t, []);
	let n = m(e, [t])[t];
	return n ? h(e, t, n) : null;
}
//#endregion
//#region node_modules/@iconify/utils/lib/svg/size.js
var _ = /(-?[0-9.]*[0-9]+[0-9.]*)/g, v = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function y(e, t, n) {
	if (t === 1) return e;
...
function S(e, t, n) {
	let r = b(e);
	return x(r.defs, t + r.content + n);
}
//#endregion
//#region node_modules/@iconify/utils/lib/svg/build.js
var C = (e) => e === "unset" || e === "undefined" || e === "none";
function w(e, t) {
	let n = {
		...o,
		...e
	...
	[n, r].forEach((e) => {
		...
		o % 2 == 1 && (i.left !== i.top && (s = i.left, i.left = i.top, i.top = s), i.width !== i.height && (s = i.width, i.width = i.height, i.height = s)), t.length && (a = S(a, "<g transform=\"" + t.join(" ") + "\">", "</g>"));
	});
	let s = r.width, c = r.height, u = i.width, d = i.height, f, p;
	s === null ? (p = c === null ? "1em" : c === "auto" ? d : c, f = y(p, u / d)) : (f = s === "auto" ? u : s, p = c === null ? y(f, d / u) : c === "auto" ? d : c);
	let m = {}, h = (e, t) => {
		C(t) || (m[e] = t.toString());
	};
...
var T = /\sid="(\S+)"/g, E = /* @__PURE__ */ new Map();
function D(e) {
	e = e.replace(/[0-9]+$/, "") || "a";
	let t = E.get(e) || 0;
	return E.set(e, t + 1), t ? `${e}${t}` : e;
}
function O(e) {
	let t = [], n;
	for (; n = T.exec(e);) t.push(n[1]);
	if (!t.length) return e;
	let r = "suffix" + (Math.random() * 16777216 | Date.now()).toString(16);
	return t.forEach((t) => {
		let n = D(t), i = t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
...
var A = {
	...
	height: 80,
	width: 80
}, j = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ e((e) => {
	for (let n of e) {
		if (!n.name) throw Error("Invalid icon loader. Must have a \"name\" property with non-empty string value.");
		if (t.debug("Registering icon pack:", n.name), "loader" in n) M.set(n.name, n.loader);
		else if ("icons" in n) j.set(n.name, n.icons);
		else throw t.error("Invalid icon loader:", n), Error("Invalid icon loader. Must have either \"icons\" or \"loader\" property.");
	}
}, "registerIconPacks"), P = /* @__PURE__ */ e(async (e, n) => {
	let r = u(e, !0, n !== void 0);
	...
	return o;
}, "getRegisteredIconData"), F = /* @__PURE__ */ e(async (e) => {
	try {
		return await P(e), !0;
	} catch {
		return !1;
	}
}, "isIconAvailable"), I = /* @__PURE__ */ e(async (e, i, a) => {
	let o;
	try {
		o = await P(e, i?.fallbackPrefix);
	} catch (e) {
		t.error(e), o = A;
	}
	let s = w(o, i), c = k(O(s.body), {
		...s.attributes,
		...a
	});
	return r(c, n());
...
//#endregion
export { A as i, F as n, N as r, I as t };
