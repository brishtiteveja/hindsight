...
import { n } from "./mermaid-parser.core-CocydDMZ.mjs";
import { n as r } from "./chunk-Y2CYZVJY-i11wjrBe.mjs";
import { m as i, p as a } from "./src-DKnM293t.mjs";
import { H as o, J as s, K as c, U as l, a as u, b as d, f, v as p, w as m, x as h, y as g, z as _ } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { c as v, i as y } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { t as b } from "./chunk-JWPE2WC7-DIKiF5cm.mjs";
import { i as x, r as S, t as C } from "./chunk-PWAF6VOD-CPL-Te_E.mjs";
import { n as w } from "./chunk-GMAD6QVW-4mlTi1Bn.mjs";
import { t as T } from "./cytoscape.esm-CIHnfaA4.mjs";
import { f as E } from "./mermaid.core-DuekSTCI.mjs";
...
var D = /* @__PURE__ */ t(((e, t) => {
	(function(n, r) {
		...
		return (function(e) {
			...
			(function(e, t, n) {
				...
				function l(e, t, n, o) {
					n == null && o == null && (o = t), r.call(this, o), e.graphManager != null && (e = e.graphManager), this.estimatedSize = i.MIN_VALUE, this.inclusionTreeDepth = i.MAX_VALUE, this.vGraphObject = o, this.edges = [], this.graphManager = e, this.rect = n != null && t != null ? new a(t.x, t.y, n.width, n.height) : new a();
				}
			...
			(function(e, t, n) {
				...
				f.prototype.getNodes = function() {
					...
					return this.estimatedSize = e == 0 ? a.EMPTY_COMPOUND_NODE_SIZE : e / Math.sqrt(this.nodes.length), this.estimatedSize;
			...
			(function(e, t, n) {
				...
				a.prototype.addRoot = function() {
					...
					this.rootGraph = e, e.parent ?? (e.parent = this.layout.newNode("Root node"));
			...
			(function(e, t, n) {
				...
				i.calcSeparationAmount = function(e, t, n, r) {
					...
					n[0] = e.getCenterX() < t.getCenterX() ? -1 : 1, n[1] = e.getCenterY() < t.getCenterY() ? -1 : 1;
					...
					if (r === a) {
						...
						if (r > a ? i > o ? (O = this.getCardinalDirection(T, D, 4), k = this.getCardinalDirection(E, D, 2)) : (O = this.getCardinalDirection(-T, D, 3), k = this.getCardinalDirection(-E, D, 1)) : i > o ? (O = this.getCardinalDirection(-T, D, 1), k = this.getCardinalDirection(-E, D, 3)) : (O = this.getCardinalDirection(T, D, 2), k = this.getCardinalDirection(E, D, 4)), !C) switch (O) {
							...
							case 3:
								...
								break;
							case 4: A = u, j = i + -p * D, n[0] = A, n[1] = j;
						}
						if (!w) switch (k) {
							case 1:
							...
							case 3:
								...
								break;
							case 4: M = v, N = o + -x * D, n[2] = M, n[3] = N;
						}
					}
					return !1;
			...
			(function(e, t, n) {
				...
				f.RANDOM_SEED = 1, f.prototype = Object.create(d.prototype), f.prototype.getGraphManager = function() {
					...
					return i.ANIMATE !== "during" && (e && (this.isSubLayout || this.doPostLayout()), this.tilingPostLayout && this.tilingPostLayout(), this.isLayoutFinished = !0, e);
			...
			(function(e, t, n) {
				...
				l.prototype.initParameters = function() {
					...
					this.incremental ? (e > a.ADAPTATION_LOWER_NODE_LIMIT && (this.coolingFactor = Math.max(this.coolingFactor * a.COOLING_ADAPTATION_FACTOR, this.coolingFactor - (e - a.ADAPTATION_LOWER_NODE_LIMIT) / (a.ADAPTATION_UPPER_NODE_LIMIT - a.ADAPTATION_LOWER_NODE_LIMIT) * this.coolingFactor * (1 - a.COOLING_ADAPTATION_FACTOR))), this.maxNodeDisplacement = a.MAX_NODE_DISPLACEMENT_INCREMENTAL) : (this.coolingFactor = e > a.ADAPTATION_LOWER_NODE_LIMIT ? Math.max(a.COOLING_ADAPTATION_FACTOR, 1 - (e - a.ADAPTATION_LOWER_NODE_LIMIT) / (a.ADAPTATION_UPPER_NODE_LIMIT - a.ADAPTATION_LOWER_NODE_LIMIT) * (1 - a.COOLING_ADAPTATION_FACTOR)) : 1, this.initialCoolingFactor = this.coolingFactor, this.maxNodeDisplacement = a.MAX_NODE_DISPLACEMENT), this.maxIterations = Math.max(this.getAllNodes().length * 5, this.maxIterations), this.displacementThresholdPerNode = 3 * a.DEFAULT_EDGE_LENGTH / 100, this.totalDisplacementThreshold = this.displacementThresholdPerNode * this.getAllNodes().length, this.repulsionRange = this.calcRepulsionRange();
				...
				r.svd = function(e) {
					...
					if (s < this.n && (this.s[s] = e[s][s]), this.m < E && (this.s[E - 1] = 0), c + 1 < E && (n[c] = e[c][E - 1]), n[E - 1] = 0, a) {
						...
						for (var k = s - 1; k >= 0; k--) if (this.s[k] !== 0) {
							...
							for (var F = 0; F < this.m; F++) this.U[F][k] = 0;
							this.U[k][k] = 1;
						}
					}
					if (o) for (var I = this.n - 1; I >= 0; I--) {
						...
						for (var te = 0; te < this.n; te++) this.V[te][I] = 0;
						this.V[I][I] = 1;
					}
					for (var ne = E - 1, V = 0, re = 2 ** -52, ie = 2 ** -966; E > 0;) {
						...
						switch (H++, U) {
							case 1:
								...
								n[E - 2] = 0;
								for (var K = E - 2; K >= H; K--) {
									var q = r.hypot(this.s[K], G), J = this.s[K] / q, Y = G / q;
									if (this.s[K] = q, K !== H && (G = -Y * n[K - 1], n[K - 1] = J * n[K - 1]), o) for (var X = 0; X < this.n; X++) q = J * this.V[X][K] + Y * this.V[X][E - 1], this.V[X][E - 1] = -Y * this.V[X][K] + J * this.V[X][E - 1], this.V[X][K] = q;
								}
								break;
							case 2:
								var oe = n[H - 1];
								...
								for (var Z = H; Z < E; Z++) {
									...
									if (this.s[Z] = se, oe = -le * n[Z], n[Z] = ce * n[Z], a) for (var ue = 0; ue < this.m; ue++) se = ce * this.U[ue][Z] + le * this.U[ue][H - 1], this.U[ue][H - 1] = -le * this.U[ue][Z] + ce * this.U[ue][H - 1], this.U[ue][Z] = se;
								}
								break;
							case 3:
								var de = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[E - 1]), Math.abs(this.s[E - 2])), Math.abs(n[E - 2])), Math.abs(this.s[H])), Math.abs(n[H])), fe = this.s[E - 1] / de, pe = this.s[E - 2] / de, me = n[E - 2] / de, he = this.s[H] / de, ge = n[H] / de, _e = ((pe + fe) * (pe - fe) + me * me) / 2, ve = fe * me * (fe * me), ye = 0;
								(function(e, t) {
									return e || t;
								})(_e !== 0, ve !== 0) && (ye = Math.sqrt(_e * _e + ve), _e < 0 && (ye = -ye), ye = ve / (_e + ye));
								for (var be = (he + fe) * (he - fe) + ye, xe = he * ge, Q = H; Q < E - 1; Q++) {
									var $ = r.hypot(be, xe), Se = be / $, Ce = xe / $;
									if (Q !== H && (n[Q - 1] = $), be = Se * this.s[Q] + Ce * n[Q], n[Q] = Se * n[Q] - Ce * this.s[Q], xe = Ce * this.s[Q + 1], this.s[Q + 1] = Se * this.s[Q + 1], o) for (var we = 0; we < this.n; we++) $ = Se * this.V[we][Q] + Ce * this.V[we][Q + 1], this.V[we][Q + 1] = -Ce * this.V[we][Q] + Se * this.V[we][Q + 1], this.V[we][Q] = $;
			...
			var t = {
				...
				765: ((e, t, n) => {
					...
					x.prototype.newGraphManager = function() {
						...
						r.prototype.initParameters.call(this, arguments), this.isSubLayout || (this.idealEdgeLength = c.DEFAULT_EDGE_LENGTH < 10 ? 10 : c.DEFAULT_EDGE_LENGTH, this.useSmartIdealEdgeLengthCalculation = c.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION, this.gravityConstant = u.DEFAULT_GRAVITY_STRENGTH, this.compoundGravityConstant = u.DEFAULT_COMPOUND_GRAVITY_STRENGTH, this.gravityRangeFactor = u.DEFAULT_GRAVITY_RANGE_FACTOR, this.compoundGravityRangeFactor = u.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR, this.prunedNodesAll = [], this.growTreeIterations = 0, this.afterGrowthIterations = 0, this.isTreeGrowing = !1, this.isGrowthFinished = !1);
						...
						if (this.isTreeGrowing) {
							if (this.growTreeIterations % 10 == 0) {
								if (this.prunedNodesAll.length > 0) {
									...
									this.graphManager.setAllNodesToApplyGravitation(t), this.graphManager.updateBounds(), this.updateGrid(), this.coolingFactor = c.PURE_INCREMENTAL ? u.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2 : u.DEFAULT_COOLING_FACTOR_INCREMENTAL;
						...
						if (this.isGrowthFinished) {
							...
							this.afterGrowthIterations % 10 == 0 && (this.graphManager.updateBounds(), this.updateGrid()), this.coolingFactor = c.PURE_INCREMENTAL ? u.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2 * ((100 - this.afterGrowthIterations) / 100) : u.DEFAULT_COOLING_FACTOR_INCREMENTAL * ((100 - this.afterGrowthIterations) / 100), this.afterGrowthIterations++;
						}
						...
						if (this.constraints.relativePlacementConstraint) {
							...
							if (c.RELAX_MOVEMENT_ON_CONSTRAINTS) this.shuffle = function(e) {
								for (var t, n, r = e.length - 1; r >= 2 * e.length / 3; r--) t = Math.floor(Math.random() * (r + 1)), n = e[r], e[r] = e[t], e[t] = n;
								return e;
						...
						if (this.constraints.relativePlacementConstraint) {
							if (c.RELAX_MOVEMENT_ON_CONSTRAINTS) this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function(t) {
						...
						for (var e = [], t, n = this.graphManager.getGraphs(), r = n.length, i = 0; i < r; i++) t = n[i], t.updateConnected(), t.isConnected || (e = e.concat(t.getNodes()));
						return e;
					}, x.prototype.createBendpoints = function() {
						var e = [];
						e = e.concat(this.graphManager.getAllEdges());
						for (var t = /* @__PURE__ */ new Set(), n = 0; n < e.length; n++) {
							var r = e[n];
							if (!t.has(r)) {
								...
								if (i == a) r.getBendpoints().push(new p()), r.getBendpoints().push(new p()), this.createDummyNodesForBendpoints(r), t.add(r);
									...
									if (o = o.concat(i.getEdgeListToNode(a)), o = o.concat(a.getEdgeListToNode(i)), !t.has(o[0])) {
										if (o.length > 1) for (var s = 0; s < o.length; s++) {
											var c = o[s];
				...
				902: ((e, t, n) => {
					...
					c.handleConstraints = function(e) {
						...
						t.relativePlacementConstraint && t.relativePlacementConstraint.forEach(function(e) {
							!e.gap && e.gap != 0 && (e.gap = e.left ? i.DEFAULT_EDGE_LENGTH + n.get(e.left).getWidth() / 2 + n.get(e.right).getWidth() / 2 : i.DEFAULT_EDGE_LENGTH + n.get(e.top).getHeight() / 2 + n.get(e.bottom).getHeight() / 2);
						});
						var h = function(e, t) {
							return {
								x: e.x - t.x,
							...
							d.forEach(function(e, r) {
								...
								if (e.forEach(function(e) {
									...
									var o = 0;
									e.forEach(function(e) {
										o += t == "horizontal" ? c.has(e) ? l[c.get(e)] : i.get(e) : c.has(e) ? u[c.get(e)] : i.get(e);
						...
						if (t.fixedNodeConstraint && t.fixedNodeConstraint.forEach(function(e) {
							...
							if (t.fixedNodeConstraint && t.fixedNodeConstraint.length > 1) t.fixedNodeConstraint.forEach(function(e, t) {
								...
								if (A < O.size / 2) v(t.relativePlacementConstraint), w = !1, T = !1;
									...
									var F = _(N, "horizontal"), I = _(P, "vertical");
									k[j].forEach(function(e, t) {
										C[t] = [l[c.get(e)], u[c.get(e)]], S[t] = [], F.has(e) ? S[t][0] = F.get(e) : S[t][0] = l[c.get(e)], I.has(e) ? S[t][1] = I.get(e) : S[t][1] = u[c.get(e)];
									}), w = !0;
								}
							}
							if (w) {
								for (var L = void 0, R = o.transpose(S), z = o.transpose(C), B = 0; B < R.length; B++) R[B] = o.multGamma(R[B]), z[B] = o.multGamma(z[B]);
								var te = o.multMat(R, o.transpose(z)), ne = s.svd(te);
								L = o.multMat(ne.V, o.transpose(ne.U));
								for (var V = 0; V < c.size; V++) {
									var re = [l[V], u[V]], ie = [L[0][0], L[1][0]], H = [L[0][1], L[1][1]];
						...
						if (i.ENFORCE_CONSTRAINTS) {
							...
							if (t.alignmentConstraint) {
								...
								if (t.alignmentConstraint.horizontal) for (var K = t.alignmentConstraint.horizontal, q = function(e) {
									var t = /* @__PURE__ */ new Set();
							...
							t.relativePlacementConstraint && (function() {
								...
								var N = b(S), P = b(C), ee = y(N), F = y(P), I = x(S), L = x(C), R = [], z = [];
								...
								var B = _(S, "horizontal", s, a, R), te = _(C, "vertical", d, o, z), ne = function(e) {
									r.get(e) ? r.get(e).forEach(function(t) {
										l[c.get(t)] = B.get(e);
									}) : l[c.get(e)] = B.get(e);
								}, V = !0, re = !1, ie = void 0;
								try {
									for (var H = B.keys()[Symbol.iterator](), U; !(V = (U = H.next()).done); V = !0) {
										var W = U.value;
										ne(W);
									}
								} catch (e) {
								...
								try {
									for (var J = te.keys()[Symbol.iterator](), Y; !(G = (Y = J.next()).done); G = !0) {
										var W = Y.value;
										ae(W);
									}
								} catch (e) {
			...
			var t = {
						...
						var v = function(e) {
							...
							for (var l = n.length, u = 0; u < l; u++) {
								...
								if (d.outerWidth() != null && d.outerHeight() != null) {
									if (c.randomize) {
										if (!d.isParent()) p = t.add(new a(i.graphManager, new o(h[m.get(d.id())] - v.w / 2, g[m.get(d.id())] - v.h / 2), new s(parseFloat(v.w), parseFloat(v.h))));
										else {
							...
							e.idealEdgeLength != null && (u.DEFAULT_EDGE_LENGTH = l.DEFAULT_EDGE_LENGTH = a > 0 ? i / a : v(e.idealEdgeLength) ? 50 : e.idealEdgeLength, u.MIN_REPULSION_DIST = l.MIN_REPULSION_DIST = l.DEFAULT_EDGE_LENGTH / 10, u.DEFAULT_RADIAL_SEPARATION = l.DEFAULT_EDGE_LENGTH);
						}, C = function(e, t) {
					...
					e.exports = function() {
						...
						return r(e, [{
							...
							value: function() {
								...
								var d = void 0, f = !1;
								if (n.layoutUtilities && t.packComponents && (d = n.layoutUtilities("get"), d || (d = n.layoutUtilities()), f = !0), r.nodes().length > 0) {
									if (f) {
											...
											l.forEach(function(e, n) {
												...
												if (t.quality == "draft" && (r = i[n].nodeIndexes), e.nodes().not(T).length > 0) {
													...
													e.nodes().not(T).forEach(function(e) {
														if (t.quality == "draft") {
															if (!e.isParent()) c = r.get(e.id()), s.nodes.push({
														...
														if (c.css("display") != "none" && l.css("display") != "none") {
															if (t.quality == "draft") {
								...
								var A = function(e, n) {
									if (t.quality == "default" || t.quality == "proof") {
										...
										}), t.nodeDimensionsIncludeLabels && (o.labelWidth && (o.labelPosHorizontal == "left" ? r.x += o.labelWidth / 2 : o.labelPosHorizontal == "right" && (r.x -= o.labelWidth / 2)), o.labelHeight && (o.labelPosVertical == "top" ? r.y += o.labelHeight / 2 : o.labelPosVertical == "bottom" && (r.y -= o.labelHeight / 2))), r ?? (r = {
											x: e.position("x"),
											y: e.position("y")
										}), {
											x: r.x,
				...
				657: ((e, t, n) => {
					...
					e.exports = { spectralLayout: function(e) {
						...
						try {
							for (var F = c.keys()[Symbol.iterator](), I; !(N = (I = F.next()).done); N = !0) {
								var L = I.value;
								l.set(L, j++);
							}
						} catch (e) {
						...
						try {
							for (var V = c.keys()[Symbol.iterator](), re; !(B = (re = V.next()).done); B = !0) {
								var ie = re.value;
								z(ie);
							}
						} catch (e) {
						...
						var ae = l.keys(), G = t.getElementById(ae.next().value), K = G.position(), q = G.outerWidth();
						if (f.push(K.x), p.push(K.y), y == 2) {
							var J = t.getElementById(ae.next().value).outerWidth();
							f.push(K.x + q / 2 + J / 2 + e.idealEdgeLength), p.push(K.y);
						}
						return H = {
							nodeIndexes: l,
							xCoords: f,
...
}, P = /* @__PURE__ */ r(function(e) {
	return F(e) ? e === "L" ? "R" : "L" : e === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), ee = /* @__PURE__ */ r(function(e) {
	let t = e;
	...
	let n = `${e}${t}`;
	return z(n) ? n : void 0;
}, "getArchitectureDirectionPair"), te = /* @__PURE__ */ r(function([e, t], n) {
	let r = n[0], i = n[1];
	return F(r) ? I(i) ? [e + (r === "L" ? -1 : 1), t + (i === "T" ? 1 : -1)] : [e + (r === "L" ? -1 : 1), t] : F(i) ? [e + (i === "L" ? 1 : -1), t + (r === "T" ? 1 : -1)] : [e, t + (r === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), ne = /* @__PURE__ */ r(function(e) {
	return e === "LT" || e === "TL" ? [1, 1] : e === "BL" || e === "LB" ? [1, -1] : e === "BR" || e === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), V = /* @__PURE__ */ r(function(e, t) {
	return L(e, t) ? "bend" : F(e) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), re = /* @__PURE__ */ r(function(e) {
	return e.type === "service";
}, "isArchitectureService"), ie = /* @__PURE__ */ r(function(e) {
	return e.type === "junction";
}, "isArchitectureJunction"), H = /* @__PURE__ */ r((e, t) => {
	let [n, r] = [e, t].sort();
	return `${JSON.stringify(n)}-${JSON.stringify(r)}`;
}, "architectureGroupAlignmentKey"), U = /* @__PURE__ */ r((e) => e.data(), "edgeData"), W = /* @__PURE__ */ r((e) => e.data(), "nodeData"), ae = f.architecture, G = (A = class {
	constructor() {
		this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", this.setAccTitle = l, this.getAccTitle = g, this.setDiagramTitle = c, this.getDiagramTitle = m, this.getAccDescription = p, this.setAccDescription = o, this.clear();
	}
	setDiagramId(e) {
		this.diagramId = e;
	}
	...
	clear() {
		this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.dataStructures = void 0, this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", u();
	}
	addService({ id: e, icon: t, in: n, title: r, iconText: i }) {
		if (this.registeredIds.has(e)) throw Error(`The service id [${e}] is already in use by another ${this.registeredIds.get(e)}`);
		if (n !== void 0) {
			if (e === n) throw Error(`The service [${e}] cannot be placed within itself`);
			if (!this.registeredIds.has(n)) throw Error(`The service [${e}]'s parent does not exist. Please make sure the parent is created before this service`);
			if (this.registeredIds.get(n) === "node") throw Error(`The service [${e}]'s parent is not a group`);
		}
		this.registeredIds.set(e, "node"), this.nodes.set(e, {
			id: e,
			type: "service",
			icon: t,
			iconText: i,
	...
	getServices() {
		return [...this.nodes.values()].filter(re);
	}
	addJunction({ id: e, in: t }) {
		if (this.registeredIds.has(e)) throw Error(`The junction id [${e}] is already in use by another ${this.registeredIds.get(e)}`);
		if (t !== void 0) {
			if (e === t) throw Error(`The junction [${e}] cannot be placed within itself`);
			if (!this.registeredIds.has(t)) throw Error(`The junction [${e}]'s parent does not exist. Please make sure the parent is created before this junction`);
			if (this.registeredIds.get(t) === "node") throw Error(`The junction [${e}]'s parent is not a group`);
		}
		this.registeredIds.set(e, "node"), this.nodes.set(e, {
			id: e,
			type: "junction",
	...
	getJunctions() {
		return [...this.nodes.values()].filter(ie);
	}
	getNodes() {
	...
	addGroup({ id: e, icon: t, in: n, title: r }) {
		if (this.registeredIds.has(e)) throw Error(`The group id [${e}] is already in use by another ${this.registeredIds.get(e)}`);
		if (n !== void 0) {
			if (e === n) throw Error(`The group [${e}] cannot be placed within itself`);
			if (!this.registeredIds.has(n)) throw Error(`The group [${e}]'s parent does not exist. Please make sure the parent is created before this group`);
			if (this.registeredIds.get(n) === "node") throw Error(`The group [${e}]'s parent is not a group`);
		}
		this.registeredIds.set(e, "group"), this.groups.set(e, {
			id: e,
			icon: t,
			title: r,
			in: n
	...
	addEdge({ lhsId: e, rhsId: t, lhsDir: n, rhsDir: r, lhsInto: i, rhsInto: a, lhsGroup: o, rhsGroup: s, title: c }) {
		if (!ee(n)) throw Error(`Invalid direction given for left hand side of edge ${e}--${t}. Expected (L,R,T,B) got ${String(n)}`);
		if (!ee(r)) throw Error(`Invalid direction given for right hand side of edge ${e}--${t}. Expected (L,R,T,B) got ${String(r)}`);
		if (!this.nodes.has(e) && !this.groups.has(e)) throw Error(`The left-hand id [${e}] does not yet exist. Please create the service/group before declaring an edge to it.`);
		if (!this.nodes.has(t) && !this.groups.has(t)) throw Error(`The right-hand id [${t}] does not yet exist. Please create the service/group before declaring an edge to it.`);
		let l = this.nodes.get(e).in, u = this.nodes.get(t).in;
		...
		this.edges.push(d);
		let f = this.nodes.get(e), p = this.nodes.get(t);
		f && p && (f.edges.push(this.edges[this.edges.length - 1]), p.edges.push(this.edges[this.edges.length - 1]));
	}
	getEdges() {
		return this.edges;
	}
	addLayoutHint(e) {
		if (e.members.length < 2) throw Error(`An align directive requires at least two members; got ${e.members.length}`);
		let t = /* @__PURE__ */ new Set();
		e.members.forEach((n) => {
			if (this.registeredIds.get(n) !== "node") throw Error(`align ${e.direction} references [${n}], which is not a service or junction`);
			if (t.has(n)) throw Error(`align ${e.direction} lists [${n}] more than once`);
			t.add(n);
		}), this.layoutHints.push(e);
	}
	getLayoutHints() {
	...
	getDataStructures() {
		if (this.dataStructures === void 0) {
			...
			for (let [n, r] of this.nodes.entries()) {
				let i = /* @__PURE__ */ new Map();
				for (let t of r.edges) {
					let r = this.getNode(t.lhsId)?.in, a = this.getNode(t.rhsId)?.in;
					if (r && a && r !== a) {
						let n = V(t.lhsDir, t.rhsDir);
						n !== "bend" && e.set(H(r, a), n);
					}
					if (t.lhsId === n) {
						let e = B(t.lhsDir, t.rhsDir);
						e && i.set(e, t.rhsId);
					} else {
						let e = B(t.rhsDir, t.lhsDir);
						e && i.set(e, t.lhsId);
					}
				}
				t.set(n, i);
			}
			let n = /* @__PURE__ */ new Set(), i = new Set(t.keys()), a = /* @__PURE__ */ r((e) => {
				let r = /* @__PURE__ */ new Map([[e, [0, 0]]]), a = [e];
				for (; a.length > 0;) {
					let e = a.shift();
					if (e) {
						n.add(e), i.delete(e);
						let o = t.get(e);
						if (!o) throw Error(`BFS error: adjacency list for id ${e} not found. Please report this as a bug.`);
						let s = r.get(e);
						if (!s) throw Error(`BFS error: position for id ${e} not found in spatial map. Please report this as a bug.`);
						let [c, l] = s;
						o.forEach((e, t) => {
							n.has(e) || (r.set(e, te([c, l], t)), a.push(e));
						});
					}
				}
				return r;
...
}, r(A, "ArchitectureDB"), A), K = /* @__PURE__ */ r((e, t) => {
	b(e, t), e.groups.map((e) => t.addGroup(e)), e.services.map((e) => t.addService({
		...e,
		type: "service"
	})), e.junctions.map((e) => t.addJunction({
		...e,
		type: "junction"
	})), e.edges.map((e) => t.addEdge(e)), e.alignments?.map((e) => t.addLayoutHint({
		direction: e.direction,
		members: [...e.members]
	}));
}, "populateDb"), q = {
...
r(Y, "withSeededRandom");
var X = /* @__PURE__ */ r((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), oe = {
	prefix: "mermaid-architecture",
	height: 80,
	width: 80,
	icons: {
		database: { body: X("<path id=\"b\" data-name=\"4\" d=\"m20,57.86c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path id=\"c\" data-name=\"3\" d=\"m20,45.95c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path id=\"d\" data-name=\"2\" d=\"m20,34.05c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse id=\"e\" data-name=\"1\" cx=\"40\" cy=\"22.14\" rx=\"20\" ry=\"7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"20\" y1=\"57.86\" x2=\"20\" y2=\"22.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"60\" y1=\"57.86\" x2=\"60\" y2=\"22.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/>") },
		server: { body: X("<rect x=\"17.5\" y=\"17.5\" width=\"45\" height=\"45\" rx=\"2\" ry=\"2\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"17.5\" y1=\"32.5\" x2=\"62.5\" y2=\"32.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"17.5\" y1=\"47.5\" x2=\"62.5\" y2=\"47.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><g><path d=\"m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: #fff; stroke-width: 0px;\"/><path d=\"m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><path d=\"m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: #fff; stroke-width: 0px;\"/><path d=\"m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><path d=\"m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: #fff; stroke-width: 0px;\"/><path d=\"m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><circle cx=\"32.5\" cy=\"25\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"27.5\" cy=\"25\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"22.5\" cy=\"25\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><circle cx=\"32.5\" cy=\"40\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"27.5\" cy=\"40\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"22.5\" cy=\"40\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><circle cx=\"32.5\" cy=\"55\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"27.5\" cy=\"55\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"22.5\" cy=\"55\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/></g>") },
		disk: { body: X("<rect x=\"20\" y=\"15\" width=\"40\" height=\"50\" rx=\"1\" ry=\"1\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"24\" cy=\"19.17\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"56\" cy=\"19.17\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"24\" cy=\"60.83\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"56\" cy=\"60.83\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"40\" cy=\"33.75\" rx=\"14\" ry=\"14.58\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"40\" cy=\"33.75\" rx=\"4\" ry=\"4.17\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path d=\"m37.51,42.52l-4.83,13.22c-.26.71-1.1,1.02-1.76.64l-4.18-2.42c-.66-.38-.81-1.26-.33-1.84l9.01-10.8c.88-1.05,2.56-.08,2.09,1.2Z\" style=\"fill: #fff; stroke-width: 0px;\"/>") },
		internet: { body: X("<circle cx=\"40\" cy=\"40\" r=\"22.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"40\" y1=\"17.5\" x2=\"40\" y2=\"62.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"17.5\" y1=\"40\" x2=\"62.5\" y2=\"40\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path d=\"m39.99,17.51c-15.28,11.1-15.28,33.88,0,44.98\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path d=\"m40.01,17.51c15.28,11.1,15.28,33.88,0,44.98\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"19.75\" y1=\"30.1\" x2=\"60.25\" y2=\"30.1\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"19.75\" y1=\"49.9\" x2=\"60.25\" y2=\"49.9\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/>") },
		cloud: { body: X("<path d=\"m65,47.5c0,2.76-2.24,5-5,5H20c-2.76,0-5-2.24-5-5,0-1.87,1.03-3.51,2.56-4.36-.04-.21-.06-.42-.06-.64,0-2.6,2.48-4.74,5.65-4.97,1.65-4.51,6.34-7.76,11.85-7.76.86,0,1.69.08,2.5.23,2.09-1.57,4.69-2.5,7.5-2.5,6.1,0,11.19,4.38,12.28,10.17,2.14.56,3.72,2.51,3.72,4.83,0,.03,0,.07-.01.1,2.29.46,4.01,2.48,4.01,4.9Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/>") },
		unknown: x,
		blank: { body: X("") }
	}
}, Z = /* @__PURE__ */ r(async function(e, t, n, r) {
	let i = n.getConfigField("padding"), a = n.getConfigField("iconSize"), o = a / 2, s = a / 6, c = s / 2;
	await Promise.all(t.edges().map(async (t) => {
		let { source: a, sourceDir: l, sourceArrow: u, sourceGroup: d, target: f, targetDir: p, targetArrow: m, targetGroup: g, label: _ } = U(t), { x: y, y: b } = t[0].sourceEndpoint(), { x, y: S } = t[0].midpoint(), { x: C, y: T } = t[0].targetEndpoint(), E = i + 4;
		if (d && (F(l) ? y += l === "L" ? -E : E : b += l === "T" ? -E : E + 18), g && (F(p) ? C += p === "L" ? -E : E : T += p === "T" ? -E : E + 18), !d && n.getNode(a)?.type === "junction" && (F(l) ? y += l === "L" ? o : -o : b += l === "T" ? o : -o), !g && n.getNode(f)?.type === "junction" && (F(p) ? C += p === "L" ? o : -o : T += p === "T" ? o : -o), t[0]._private.rscratch) {
			let t = e.insert("g");
			if (t.insert("path").attr("d", `M ${y},${b} L ${x},${S} L${C},${T} `).attr("class", "edge").attr("id", `${r}-${v(a, f, { prefix: "L" })}`), u) {
				let e = F(l) ? N[l](y, s) : y - c, n = I(l) ? N[l](b, s) : b - c;
				t.insert("polygon").attr("points", M[l](s)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (m) {
				let e = F(p) ? N[p](C, s) : C - c, n = I(p) ? N[p](T, s) : T - c;
				t.insert("polygon").attr("points", M[p](s)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (_) {
				let e = L(l, p) ? "XY" : F(l) ? "X" : "Y", n = 0;
				n = e === "X" ? Math.abs(y - C) : e === "Y" ? Math.abs(b - T) / 1.5 : Math.abs(y - C) / 2;
				let r = t.append("g");
				if (await w(r, _, {
					useHtmlLabels: !1,
					width: n,
					classes: "architecture-service-label"
				}, h()), r.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), e === "X") r.attr("transform", "translate(" + x + ", " + S + ")");
				else if (e === "Y") r.attr("transform", "translate(" + x + ", " + S + ") rotate(-90)");
				else if (e === "XY") {
					let e = B(l, p);
					if (e && R(e)) {
						let t = r.node().getBoundingClientRect(), [n, i] = ne(e);
...
}, "drawEdges"), se = /* @__PURE__ */ r(async function(e, t, n, r) {
	...
	await Promise.all(t.nodes().map(async (t) => {
		...
		if (s.type === "group") {
			...
			let p = e.append("g"), m = u, g = d;
			if (s.icon) {
				let e = p.append("g");
				e.html(`<g>${await C(s.icon, {
					height: i,
					width: i,
					fallbackPrefix: oe.prefix
				})}</g>`), e.attr("transform", "translate(" + (m + o + 1) + ", " + (g + o + 1) + ")"), m += i, g += a / 2 - 1 - 2;
			}
			if (s.label) {
				let e = p.append("g");
				await w(e, s.label, {
					...
					width: l,
					classes: "architecture-service-label"
				}, h()), e.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), e.attr("transform", "translate(" + (m + o + 4) + ", " + (g + o + 2) + ")");
			}
			n.setElementForId(s.id, f);
		}
	}));
}, "drawGroups"), ce = /* @__PURE__ */ r(async function(e, t, n, r) {
	let i = h();
	for (let a of n) {
		...
		if (a.icon) s.html(`<g>${await C(a.icon, {
			...
			let e = s.append("g").append("foreignObject").attr("width", o).attr("height", o).append("div").attr("class", "node-icon-text").attr("style", `height: ${o}px;`).append("div").html(_(a.iconText, i)), t = parseInt(window.getComputedStyle(e.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
	...
	return 0;
}, "drawServices"), le = /* @__PURE__ */ r(function(e, t, n, r) {
	n.forEach((n) => {
...
r(me, "addEdges");
function he(e, t, n, i = []) {
	let a = /* @__PURE__ */ r((e, t) => {
		let r = /* @__PURE__ */ new Map();
		for (let [i, a] of e.entries()) {
			let e = `${i}`, o = 0, s = [...a.entries()];
			if (s.length === 1) {
				r.set(e, s[0][1]);
				continue;
			}
			for (let i = 0; i < s.length - 1; i++) for (let a = i + 1; a < s.length; a++) {
				let [c, l] = s[i], [u, d] = s[a];
				if (n.get(H(c, u)) === t) r.set(e, [
					...r.get(e) ?? [],
					...l,
					...d
				]);
				else if (c === "default" || u === "default") r.set(e, [
					...r.get(e) ?? [],
					...l,
					...d
				]);
		...
		return r;
	}, "flattenAlignments"), [o, s] = t.map((t) => {
		let n = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map();
		return t.forEach(([t, i], a) => {
			let o = e.getNode(a)?.in ?? "default", s = n.get(i) ?? /* @__PURE__ */ new Map();
			n.has(i) || n.set(i, s);
			let c = r.get(t) ?? /* @__PURE__ */ new Map();
			r.has(t) || r.set(t, c);
			for (let e of [s, c]) {
				let t = e.get(o) ?? [];
				e.has(o) || e.set(o, t), t.push(a);
			}
		}), {
			horiz: [...a(n, "horizontal").values()].filter((e) => e.length > 1),
			vert: [...a(r, "vertical").values()].filter((e) => e.length > 1)
		};
	}).reduce(([e, t], { horiz: n, vert: r }) => [[...e, ...n], [...t, ...r]], [[], []]), c = /* @__PURE__ */ new Set();
	i.forEach((e) => e.members.forEach((e) => c.add(e)));
	let l = /* @__PURE__ */ r((e) => e.filter((e) => !e.some((e) => c.has(e))), "dropOverlapping"), u = l(o), d = l(s);
	return i.forEach((e) => {
		e.members.length < 2 || (e.direction === "row" ? u.push([...e.members]) : d.push([...e.members]));
	}), {
		horizontal: u,
		vertical: d
	};
...
r(he, "getAlignments");
function ge(e, t, n = []) {
	let i = [], a = t.getConfigField("iconSize"), o = t.getConfigField("idealEdgeLengthMultiplier"), s = o * a, c = /* @__PURE__ */ new Set();
	n.forEach((e) => {
		for (let t = 0; t < e.members.length - 1; t++) {
			let n = e.members[t], r = e.members[t + 1];
			c.add(`${n}|${r}`), c.add(`${r}|${n}`), e.direction === "row" ? i.push({
				left: n,
				right: r,
				gap: s
			}) : i.push({
	...
	let l = /* @__PURE__ */ r((e) => `${e[0]},${e[1]}`, "posToStr"), u = /* @__PURE__ */ r((e) => e.split(",").map((e) => parseInt(e)), "strToPos");
	return e.forEach((e) => {
		let t = new Map([...e.entries()].map(([e, t]) => [l(t), e])), n = [l([0, 0])], r = {}, s = {
			L: [-1, 0],
			R: [1, 0],
			T: [0, 1],
			B: [0, -1]
		...
		for (; n.length > 0;) {
			...
			if (e) {
				...
				if (d) {
					let f = u(e);
					Object.entries(s).forEach(([e, s]) => {
						let u = l([f[0] + s[0], f[1] + s[1]]), p = t.get(u);
						if (p && !r[u]) {
							if (n.push(u), c.has(`${d}|${p}`)) return;
							i.push({
								[j[e]]: p,
								[j[P(e)]]: d,
								gap: o * a
...
r(ge, "getRelativeConstraints");
function _e(e, t, n, o, s, { spatialMaps: c, groupAlignments: l }) {
	return new Promise((u) => {
		let d = a("body").append("div").attr("id", "cy").attr("style", "display:none"), f = T({
		...
		d.remove(), pe(n, f), ue(e, f, s), de(t, f, s), me(o, f);
		let p = s.getLayoutHints(), m = he(s, c, l, p), h = ge(c, s, p), g = s.getConfigField("iconSize"), _ = s.getConfigField("idealEdgeLengthMultiplier") * g, v = .5 * g, y = s.getConfigField("edgeElasticity"), b = s.getConfigField("seed"), x = f.layout({
			name: "fcose",
			quality: "proof",
			...
			nodeDimensionsIncludeLabels: !1,
			idealEdgeLength(e) {
				let [t, n] = e.connectedNodes(), { parent: r } = W(t), { parent: i } = W(n);
				return r === i ? _ : v;
			},
			edgeElasticity(e) {
				let [t, n] = e.connectedNodes(), { parent: r } = W(t), { parent: i } = W(n);
...
var ve = {
	...
	renderer: { draw: /* @__PURE__ */ r(async (e, t, n, r) => {
		let i = r.db;
		i.setDiagramId(t);
		let a = i.getServices(), o = i.getJunctions(), c = i.getGroups(), l = i.getEdges(), u = i.getDataStructures(), d = E(t), f = d.append("g");
		f.attr("class", "architecture-edges");
		let p = d.append("g");
		p.attr("class", "architecture-services");
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await ce(i, p, a, t), le(i, p, o, t);
		let h = await _e(a, o, c, l, i, u);
		await Z(f, h, i, t), await se(m, h, i, t), fe(i, h), s(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
	styles: J
};
//#endregion
