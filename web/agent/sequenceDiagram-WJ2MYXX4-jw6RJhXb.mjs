...
import { A as r, F as i, G as a, H as o, K as s, O as c, U as l, a as u, b as d, c as f, i as p, r as m, s as h, v as g, w as _, x as v, y, z as b } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { t as x } from "./dist-DepzDghu.mjs";
import { g as S, p as C } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { a as w, c as T, i as E, n as D, r as O, s as k } from "./chunk-F27PBJKO-BmGuo1wo.mjs";
import { t as A } from "./chunk-2Q5K7J3B-BDbtAK2d.mjs";
import { n as j, t as M } from "./mermaid.core-DuekSTCI.mjs";
//#region node_modules/mermaid/dist/chunks/mermaid.core/sequenceDiagram-WJ2MYXX4.mjs
var N = x(), P, F = (function() {
	var t = /* @__PURE__ */ e(function(e, t, n, r) {
		...
		64,
		73
	], ee = [1, 74], L = [1, 80], te = [1, 81], R = [1, 82], ne = [1, 83], re = [1, 84], z = [1, 85], B = [1, 86], V = [1, 87], ie = [1, 88], H = [1, 89], U = [1, 90], W = [1, 91], ae = [1, 92], oe = [1, 93], se = [1, 94], G = [1, 95], ce = [1, 96], K = [1, 97], le = [1, 98], ue = [1, 99], de = [1, 100], fe = [1, 101], pe = [1, 102], me = [1, 103], he = [1, 104], ge = [1, 105], _e = [2, 78], ve = [
		4,
		5,
		17,
		51,
		...
		performAction: /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
			...
			switch (i) {
				...
				case 104:
					...
					break;
				case 105: this.$ = r.parseMessage(a[s].trim().substring(1));
			}
		}, "anonymous"),
		table: [
			{
		...
		parse: /* @__PURE__ */ e(function(t) {
			...
			this.parseError = typeof g.yy.parseError == "function" ? g.yy.parseError : Object.getPrototypeOf(this).parseError;
			function b(e) {
			...
			for (var S, C, w, T, E, D = {}, O, k, A, j;;) {
				if (w = r[r.length - 1], this.defaultActions[w] ? T = this.defaultActions[w] : (S ?? (S = x()), T = s[w] && s[w][S]), T === void 0 || !T.length || !T[0]) {
					var M = "";
...
var I = F, ee = {
	...
	constructor() {
		...
		})), this.setAccTitle = l, this.setAccDescription = o, this.setDiagramTitle = s, this.getAccTitle = y, this.getAccDescription = g, this.getDiagramTitle = _, this.apply = this.apply.bind(this), this.parseBoxData = this.parseBoxData.bind(this), this.parseMessage = this.parseMessage.bind(this), this.clear(), this.setWrap(v().wrap), this.LINETYPE = ee, this.ARROWTYPE = L, this.PLACEMENT = te;
	}
	addBox(e) {
	...
	addALink(e, n) {
		let r = this.getActor(e);
		try {
			let e = {}, t = b(n.text, v()), i = t.indexOf("@");
	...
	addProperties(e, n) {
		let r = this.getActor(e);
		try {
			let e = b(n.text, v()), t = JSON.parse(e);
	...
	apply(e) {
		if (Array.isArray(e)) e.forEach((e) => {
			...
			case "breakStart":
				...
				break;
			case "breakEnd": this.addSignal(void 0, void 0, void 0, e.signalType);
		}
	}
	getConfig() {
		return v().sequence;
	}
}, e(P, "SequenceDB"), P), re = /* @__PURE__ */ e((e) => {
...
`;
}, "getStyles"), z = 36, B = "actor-top", V = "actor-bottom", ie = "actor-box", H = "actor-man", U = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), W = /* @__PURE__ */ e(function(e, t) {
	let n = w(e, t);
	return d().look === "neo" && n.attr("data-look", "neo"), n;
}, "drawRect"), ae = /* @__PURE__ */ e(function(e, t, n, r, i) {
	...
	if (f.attr("class", "actorPopupMenuPanel" + u), f.attr("x", s.x), f.attr("y", s.height), f.attr("fill", s.fill), f.attr("stroke", s.stroke), f.attr("width", d), f.attr("height", s.height), f.attr("rx", s.rx), f.attr("ry", s.ry), a != null) {
		...
		for (let e in a) {
			...
			m.attr("xlink:href", h), m.attr("target", "_blank"), Me(r)(e, m, s.x + 10, s.height + p, d, 20, { class: "actor" }, r), p += 30;
		}
	}
	...
	let r = 0, i = 0, a = n.text.split(h.lineBreakRegex), [o, s] = C(n.fontSize), c = [], l = 0, u = /* @__PURE__ */ e(() => n.y, "yfunc");
	if (n.valign !== void 0 && n.textMargin !== void 0 && n.textMargin > 0) switch (n.valign) {
		case "top":
		case "start":
			u = /* @__PURE__ */ e(() => Math.round(n.y + n.textMargin), "yfunc");
			break;
		case "middle":
		case "center":
			u = /* @__PURE__ */ e(() => Math.round(n.y + (r + i + n.textMargin) / 2), "yfunc");
			break;
		case "bottom":
		case "end": u = /* @__PURE__ */ e(() => Math.round(n.y + (r + i + 2 * n.textMargin) - n.textMargin), "yfunc");
	}
	if (n.anchor !== void 0 && n.textMargin !== void 0 && n.width !== void 0) switch (n.anchor) {
		...
		case "center":
			...
			break;
		case "right":
		case "end": n.x = Math.round(n.x + n.width - n.textMargin), n.anchor = "end", n.dominantBaseline = "middle", n.alignmentBaseline = "middle";
	}
	for (let [e, d] of a.entries()) {
		n.textMargin !== void 0 && n.textMargin === 0 && o !== void 0 && (l = e * o);
		let a = t.append("text");
	...
	return c;
}, "drawText"), ce = /* @__PURE__ */ e(function(t, n) {
...
}, "drawLabel"), K = -1, le = /* @__PURE__ */ e((e, t, n, r) => {
...
}, "fixLifeLineHeights"), ue = /* @__PURE__ */ e(function(e, t, n, i, a) {
	...
	let g = k();
	var _ = "actor";
	t.properties?.class ? _ = t.properties.class : g.fill = "#eaeaea", _ += i ? ` ${V}` : ` ${B}`, g.x = t.x, g.y = o, g.width = t.width, g.height = t.height, g.class = _, g.rx = 3, g.ry = 3, g.name = t.name, l === "neo" && (g.rx = 6, g.ry = 6);
	...
	i || (h.attr("data-et", "participant"), h.attr("data-type", "participant"), h.attr("data-id", t.name)), Y(n, r(t.description))(t.description, h, g.x, g.y, g.width, g.height, { class: `actor ${ie}` }, n);
	let b = t.height;
	if (v.node) {
	...
	return b;
}, "drawActorTypeParticipant"), de = /* @__PURE__ */ e(function(e, t, n, i, a) {
	let o = i ? t.stopy : t.starty, s = t.x + t.width / 2, c = o + t.height, { look: l, theme: u, themeVariables: d } = n, { bkgColorArray: f, borderColorArray: p } = d, m = e.append("g").lower();
	var h = m;
	i || (K++, Object.keys(t.links || {}).length && !n.forceMenus && h.attr("onclick", oe(`actor${K}_popup`)).attr("cursor", "pointer"), h.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), h = m.append("g"), t.actorCnt = K, t.links != null && h.attr("id", "root-" + K), l === "neo" && h.attr("data-look", "neo"));
	let g = k();
	var _ = "actor";
	t.properties?.class ? _ = t.properties.class : g.fill = "#eaeaea", _ += i ? ` ${V}` : ` ${B}`, g.x = t.x, g.y = o, g.width = t.width, g.height = t.height, g.class = _, g.name = t.name;
	let v = {
		...g,
		x: g.x + -6,
		y: g.y + 6,
	...
	Y(n, r(t.description))(t.description, h, g.x - 6, g.y + 6, g.width, g.height, { class: `actor ${ie}` }, n);
	let S = t.height;
	if (y.node) {
...
}, "drawActorTypeCollections"), fe = /* @__PURE__ */ e(function(e, t, n, i, a) {
	...
	i || (K++, Object.keys(t.links || {}).length && !n.forceMenus && h.attr("onclick", oe(`actor${K}_popup`)).attr("cursor", "pointer"), h.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), h = m.append("g"), t.actorCnt = K, t.links != null && h.attr("id", "root-" + K), l === "neo" && h.attr("data-look", "neo"));
	let g = k(), _ = "actor";
	t.properties?.class ? _ = t.properties.class : g.fill = "#eaeaea", _ += i ? ` ${V}` : ` ${B}`, h.attr("class", _), g.x = t.x, g.y = o, g.width = t.width, g.height = t.height, g.name = t.name;
  ...
  `;
	...
	Y(n, r(t.description))(t.description, h, g.x, g.y, g.width, g.height, { class: `actor ${ie}` }, n);
...
}, "drawActorTypeQueue"), pe = /* @__PURE__ */ e(function(e, t, n, i, a, o) {
	...
	y += i ? ` ${V}` : ` ${B}`, v.attr("class", y), v.attr("name", t.name);
	let b = k();
...
}, "drawActorTypeControl"), me = /* @__PURE__ */ e(function(e, t, n, i, a) {
	...
	g += i ? ` ${V}` : ` ${B}`, h.attr("class", g), h.attr("name", t.name);
	let _ = k();
	...
	i || (K++, Object.keys(t.links || {}).length && !n.forceMenus && g.attr("onclick", oe(`actor${K}_popup`)).attr("cursor", "pointer"), g.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), g = h.append("g"), t.actorCnt = K, t.links != null && g.attr("id", "root-" + K), d === "neo" && g.attr("data-look", "neo"));
	let _ = k(), v = "actor";
	t.properties?.class ? v = t.properties.class : _.fill = "#eaeaea", v += i ? ` ${V}` : ` ${B}`, _.x = t.x, _.y = o, _.width = t.width, _.height = t.height, _.class = v, _.name = t.name, _.x = t.x, _.y = o;
...
`;
	...
	U.has(l) ? (C.style("stroke", p[T % p.length]), C.style("fill", f[T % p.length])) : C.style("stroke", m), C.attr("transform", `translate(${y}, ${S})`), t.rectData = _, Y(n, r(t.description))(t.description, g, _.x, _.y + 35, _.width, _.height, { class: `actor ${ie}` }, n);
...
}, "drawActorTypeDatabase"), ge = /* @__PURE__ */ e(function(e, t, n, i, a) {
	...
	_ += i ? ` ${V}` : ` ${B}`, g.attr("class", _), g.attr("name", t.name);
	let v = k();
	v.x = t.x, v.y = o, v.fill = "#eaeaea", v.width = t.width, v.height = t.height, v.class = "actor", g.append("line").attr("id", "actor-man-torso" + K).attr("x1", t.x + t.width / 2 - 55).attr("y1", o + 12).attr("x2", t.x + t.width / 2 - 15).attr("y2", o + 12), g.append("line").attr("id", "actor-man-arms" + K).attr("x1", t.x + t.width / 2 - 55).attr("y1", o + 2).attr("x2", t.x + t.width / 2 - 55).attr("y2", o + 22), g.append("circle").attr("cx", t.x + t.width / 2).attr("cy", o + 12).attr("r", 22), u === "neo" && g.attr("filter", "url(#drop-shadow)");
...
}, "drawActorTypeBoundary"), _e = /* @__PURE__ */ e(function(e, t, n, i, a) {
	...
	let g = e.append("g"), _ = H;
	_ += i ? ` ${V}` : ` ${B}`, g.attr("class", _), g.attr("name", t.name), i || g.attr("data-et", "participant").attr("data-type", "actor").attr("data-id", t.name);
...
}, "drawActorTypeActor"), ve = /* @__PURE__ */ e(async function(e, t, n, r, i, a, o) {
	let s = o ?? new Map([...a.db.getActors().values()].map((e, t) => [e.name, t]));
	switch (t.type) {
		case "actor": return await _e(e, t, n, r, s);
		case "participant": return await ue(e, t, n, r, s);
		case "boundary": return await ge(e, t, n, r, s);
		case "control": return await pe(e, t, n, r, i, s);
		case "entity": return await me(e, t, n, r, s);
		case "database": return await he(e, t, n, r, s);
		case "collections": return await de(e, t, n, r, s);
		case "queue": return await fe(e, t, n, r, s);
	}
}, "drawActor"), ye = /* @__PURE__ */ e(function(e, t, n) {
	let r = e.append("g");
	Ce(r, t), t.name && Y(n)(t.name, r, t.x, t.y + n.boxTextMargin + (t.textMaxHeight || 0) / 2, t.width, 0, { class: "text" }, n), r.lower();
}, "drawBox"), be = /* @__PURE__ */ e(function(e) {
	return e.append("g");
}, "anchorElement"), xe = /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
...
}, "drawActivation"), Se = /* @__PURE__ */ e(async function(t, n, i, a, o) {
	let { boxMargin: s, boxTextMargin: c, labelBoxHeight: l, labelBoxWidth: u, messageFontFamily: d, messageFontSize: f, messageFontWeight: p } = a, m = t.append("g").attr("data-et", "control-structure").attr("data-id", "i" + o.id), h = /* @__PURE__ */ e(function(e, t, n, r) {
	...
	let g = T();
	g.text = i, g.x = n.startx, g.y = n.starty, g.fontFamily = d, g.fontSize = f, g.fontWeight = p, g.anchor = "middle", g.valign = "middle", g.tspan = !1, g.width = Math.max(u ?? 0, 50), g.height = l + (a.look === "neo" ? 15 : 0) || 20, g.textMargin = c, g.class = "labelText", ce(m, g), g = Ae(), g.text = n.title, g.x = n.startx + u / 2 + (n.stopx - n.startx) / 2, g.y = n.starty + s + c, g.anchor = "middle", g.valign = "middle", g.textMargin = c, g.class = "loopText", g.fontFamily = d, g.fontSize = f, g.fontWeight = p, g.wrap = !0;
	let _ = r(g.text) ? await se(m, g, n) : G(m, g);
	if (n.sectionTitles !== void 0) {
		for (let [e, t] of Object.entries(n.sectionTitles)) if (t.message) {
			g.text = t.message, g.x = n.startx + (n.stopx - n.startx) / 2, g.y = n.sections[e].y + s + c, g.class = "sectionTitle", g.anchor = "middle", g.valign = "middle", g.tspan = !1, g.fontFamily = d, g.fontSize = f, g.fontWeight = p, g.wrap = n.wrap, r(g.text) ? (n.starty = n.sections[e].y, await se(m, g, n)) : G(m, g);
...
}, "drawLoop"), Ce = /* @__PURE__ */ e(function(e, t) {
	D(e, t);
}, "drawBackgroundRect"), q = /* @__PURE__ */ e(function(e, t) {
...
}, "insertDatabaseIcon"), J = /* @__PURE__ */ e(function(e, t) {
...
}, "insertComputerIcon"), we = /* @__PURE__ */ e(function(e, t) {
...
}, "insertClockIcon"), Te = /* @__PURE__ */ e(function(e, t) {
...
}, "insertArrowHead"), Ee = /* @__PURE__ */ e(function(e, t) {
...
}, "insertArrowFilledHead"), De = /* @__PURE__ */ e(function(e, t) {
...
}, "insertSequenceNumber"), Oe = /* @__PURE__ */ e(function(e, t) {
...
}, "insertArrowCrossHead"), ke = /* @__PURE__ */ e(function(e, t) {
	let { theme: n } = t;
...
}, "insertDropShadow"), Ae = /* @__PURE__ */ e(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), je = /* @__PURE__ */ e(function() {
	return {
		x: 0,
		y: 0,
		fill: "#EDF2AE",
	...
	return e(o, "_setTextAttrs"), function(e, i = !1) {
		return i ? a : e.textPlacement === "fo" ? r : e.textPlacement === "old" ? t : n;
	};
	...
	insertDatabaseIcon: q,
	insertComputerIcon: J,
	insertClockIcon: we,
	getTextObj: Ae,
	getNoteRect: je,
	fixLifeLineHeights: le,
	...
	init: /* @__PURE__ */ e(function() {
		this.sequenceItems = [], this.activations = [], this.models.clear(), this.data = {
			...
			starty: void 0,
			stopy: void 0
		}, this.verticalPos = 0, Ue(v());
	}, "init"),
	updateVal: /* @__PURE__ */ e(function(e, t, n, r) {
		e[t] = e[t] === void 0 ? n : r(n, e[t]);
	}, "updateVal"),
	...
	newActivation: /* @__PURE__ */ e(function(e, t, n) {
		let r = n.get(e.from), i = We(e.from).length || 0, a = r.x + r.width / 2 + (i - 1) * Z.activationWidth / 2;
...
}, Ne = /* @__PURE__ */ e(async function(e, t, n) {
	...
	let c = r(s.text) ? await se(a, s) : G(a, s), l = Math.round(c.map((e) => (e._groups || e)[0][0].getBBox().height).reduce((e, t) => e + t));
...
}, "drawNote"), Pe = /* @__PURE__ */ e(function(t, n, r, i, a, o, s) {
	let c = i.db.getActors(), l = c.get(n.from), u = c.get(n.to), d = r.sequenceVisible, f = l.x + l.width / 2, p = u.x + u.width / 2, m = f <= p, h = nt(n, i), g = t.append("g"), _ = /* @__PURE__ */ e((e, t) => {
		let n = e ? 16.5 : -16.5;
		return t ? -n : n;
...
async function Re(e, t) {
	...
	let { startx: n, stopx: i, message: a } = t, o = h.splitBreaks(a).length, s = r(a), c = s ? await p(a, v()) : S.calculateTextDimensions(a, Fe(Z));
	if (!s) {
		let e = c.height / o;
...
e(Re, "boundMessage");
var ze = /* @__PURE__ */ e(async function(e, t, n, i, a, o) {
	let { startx: s, stopx: l, starty: u, message: d, type: f, sequenceIndex: p, sequenceVisible: m } = t, g = S.calculateTextDimensions(d, Fe(Z)), _ = T();
	_.x = Math.min(s, l), _.y = u + 10, _.width = Math.abs(l - s), _.class = "messageText", _.dy = "1em", _.text = d, _.fontFamily = Z.messageFontFamily, _.fontSize = Z.messageFontSize, _.fontWeight = Z.messageFontWeight, _.anchor = Z.messageAlign, _.valign = "center", _.textMargin = Z.wrapPadding, _.tspan = !1, r(_.text) ? await se(e, _, {
		startx: s,
		stopx: l,
		starty: n
	}) : G(e, _);
	let v = g.width, y;
	if (s === l) {
		let r = m || Z.showSequenceNumbers, o = nt(a, i), c = rt(a, i), u = s + (r && (o || c) ? 10 : 0);
		y = Z.rightAngles ? e.append("path").attr("d", `M  ${u},${n} H ${s + h.getMax(Z.width / 2, v / 2)} V ${n + 25} H ${s}`) : e.append("path").attr("d", "M " + u + "," + n + " C " + (u + 60) + "," + (n - 10) + " " + (s + 60) + "," + (n + 30) + " " + s + "," + (n + 20)), et(a, i) && Pe(e, a, t, i, s, l, n);
	} else y = e.append("line"), y.attr("x1", s), y.attr("y1", n), y.attr("x2", l), y.attr("y2", n), et(a, i) && Pe(e, a, t, i, s, l, n);
...
}, "drawMessage"), Be = /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
	let s = 0, c = 0, l, u = 0;
	for (let e of r) {
...
}, "addActorRenderingData"), Ve = /* @__PURE__ */ e(async function(e, t, n, r, i, a, o) {
	if (r) {
		let r = 0;
		Q.bumpVerticalPos(Z.boxMargin * 2);
		for (let s of n) {
			let n = t.get(s);
			n.stopy || (n.stopy = Q.getVerticalPos());
...
}, "drawActors"), He = /* @__PURE__ */ e(function(e, t, n, r) {
	let i = 0, a = 0;
	for (let o of n) {
		let n = t.get(o), s = Ye(n), c = X.drawPopup(e, n, s, Z, Z.forceMenus, r);
...
}, "drawActorsPopup"), Ue = /* @__PURE__ */ e(function(e) {
...
}, "setConf"), We = /* @__PURE__ */ e(function(e) {
	return Q.activations.filter(function(t) {
		return t.actor === e;
	});
}, "actorActivations"), Ge = /* @__PURE__ */ e(function(e, t) {
	let n = t.get(e), r = We(e);
...
function $(e, n, r, i, a) {
	...
	if (n.id && n.message && e[n.id]) {
		let r = e[n.id].width, a = Fe(Z);
		n.message = S.wrapLabel(`[${n.message}]`, r - 2 * Z.wrapPadding, a), n.width = r, n.wrap = !0;
		let s = S.calculateTextDimensions(n.message, a), c = h.getMax(s.height, Z.labelBoxHeight);
		o = i + c, t.debug(`${c} - ${n.message}`);
	}
	a(n), Q.bumpVerticalPos(o);
}
e($, "adjustLoopHeightForWrap");
function Ke(t, n, r, i, a, o, s) {
	function c(e, r) {
...
e(Ke, "adjustCreatedDestroyedData");
var qe = /* @__PURE__ */ e(async function(r, i, a, o) {
	let { securityLevel: s, sequence: c, look: l, themeVariables: u } = v();
	Z = c;
	let d;
	s === "sandbox" && (d = n("#i" + i));
	let p = n(s === "sandbox" ? d.nodes()[0].contentDocument.body : "body"), m = s === "sandbox" ? d.nodes()[0].contentDocument : document;
	Q.init(), t.debug(o.db);
	let h = s === "sandbox" ? p.select(`[id="${i}"]`) : n(`[id="${i}"]`), g = o.db.getActors(), _ = o.db.getCreatedActors(), y = o.db.getDestroyedActors(), b = o.db.getBoxes(), x = o.db.getActorKeys(), S = o.db.getMessages(), C = o.db.getDiagramTitle(), w = o.db.hasAtLeastOneBox(), T = o.db.hasAtLeastOneBoxWithTitle(), E = await Je(g, S, o);
	if (Z.height = await Xe(g, E, b), X.insertComputerIcon(h, i), X.insertDatabaseIcon(h, i), X.insertClockIcon(h, i), w && (Q.bumpVerticalPos(Z.boxMargin), T && Q.bumpVerticalPos(b[0].textMaxHeight)), Z.hideUnusedParticipants === !0) {
		let e = /* @__PURE__ */ new Set();
		S.forEach((t) => {
			e.add(t.from), e.add(t.to);
		}), x = x.filter((t) => e.has(t));
	}
	let D = new Map(x.map((e, t) => [g.get(e)?.name ?? e, t]));
	Be(h, g, _, x, 0, S, !1);
	let O = await at(S, g, E, o);
	X.insertArrowHead(h, i), X.insertArrowCrossHead(h, i), X.insertArrowFilledHead(h, i), X.insertSequenceNumber(h, i), X.insertSolidTopArrowHead(h, i), X.insertSolidBottomArrowHead(h, i), X.insertStickTopArrowHead(h, i), X.insertStickBottomArrowHead(h, i), l === "neo" && X.insertDropShadow(h, Z);
	function k(e, t) {
		let n = Q.endActivation(e);
		n.starty + 18 > t && (n.starty = t - 6, t += 12), X.drawActivation(h, n, t, Z, We(e.from).length, o, D), Q.insert(n.startx, t - 10, n.stopx, t);
	}
	e(k, "activeEnd");
	let A = 1, j = 1, M = [], N = [], P = 0;
	for (let e of S) {
		...
		switch (e.type) {
			case o.db.LINETYPE.NOTE:
				Q.resetVerticalPos(), r = e.noteModel, await Ne(h, r, e.id);
				break;
			case o.db.LINETYPE.ACTIVE_START:
				Q.newActivation(e, h, g);
				break;
			...
			case o.db.LINETYPE.LOOP_START:
				$(O, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case o.db.LINETYPE.LOOP_END:
				n = Q.endLoop(), await X.drawLoop(h, n, "loop", Z, e), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.RECT_START:
				$(O, e, Z.boxMargin, Z.boxMargin, (e) => {
					let t = e.message;
					t || (t = u?.rectBkgColor || u?.actorBkg || "rgba(128, 128, 128, 0.5)"), Q.newLoop(void 0, t);
				});
				break;
			case o.db.LINETYPE.RECT_END:
				n = Q.endLoop(), N.push(n), Q.models.addLoop(n), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos());
				break;
			case o.db.LINETYPE.OPT_START:
				$(O, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case o.db.LINETYPE.OPT_END:
				n = Q.endLoop(), await X.drawLoop(h, n, "opt", Z, e), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.ALT_START:
				$(O, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case o.db.LINETYPE.ALT_ELSE:
				$(O, e, Z.boxMargin + Z.boxTextMargin, Z.boxMargin, (e) => Q.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.ALT_END:
				n = Q.endLoop(), await X.drawLoop(h, n, "alt", Z, e), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.PAR_START:
			case o.db.LINETYPE.PAR_OVER_START:
				$(O, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e)), Q.saveVerticalPos();
				break;
			case o.db.LINETYPE.PAR_AND:
				$(O, e, Z.boxMargin + Z.boxTextMargin, Z.boxMargin, (e) => Q.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.PAR_END:
				n = Q.endLoop(), await X.drawLoop(h, n, "par", Z, e), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.AUTONUMBER:
				A = e.message.start || A, j = e.message.step || j, e.message.visible ? o.db.enableSequenceNumbers() : o.db.disableSequenceNumbers();
				break;
			...
			case o.db.LINETYPE.CRITICAL_END:
				n = Q.endLoop(), await X.drawLoop(h, n, "critical", Z, e), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.BREAK_START:
				$(O, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case o.db.LINETYPE.BREAK_END:
				n = Q.endLoop(), await X.drawLoop(h, n, "break", Z, e), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			default: try {
				i = e.msgModel, i.starty = Q.getVerticalPos(), i.sequenceIndex = A, i.sequenceVisible = o.db.showSequenceNumbers(), i.id = e.id, i.from = e.from, i.to = e.to;
				let t = await Re(h, i);
				Ke(e, i, t, P, g, _, y), M.push({
					messageModel: i,
					lineStartY: t,
					msg: e
		...
		].includes(e.type) && (A = Math.round((A + j) * 100) / 100), P++;
	}
	t.debug("createdActors", _), t.debug("destroyedActors", y), await Ve(h, g, x, !1, i, o, D);
	for (let e of M) await ze(h, e.messageModel, e.lineStartY, o, e.msg, i);
	Z.mirrorActors && await Ve(h, g, x, !0, i, o, D), N.forEach((e) => X.drawBackgroundRect(h, e)), le(h, g, x, Z);
	for (let e of Q.models.boxes) {
		e.height = Q.getVerticalPos() - e.y, Q.insert(e.x, e.y, e.x + e.width, e.height);
		let t = Z.boxMargin * 2;
		e.startx = e.x - t, e.starty = e.y - t * .25, e.stopx = e.startx + e.width + 2 * t, e.stopy = e.starty + e.height + t * .75, e.stroke = "rgb(0,0,0, 0.5)", X.drawBox(h, e, Z);
	}
	w && Q.bumpVerticalPos(Z.boxMargin);
	let F = He(h, g, x, m), { bounds: I } = Q.getBounds();
	I.startx === void 0 && (I.startx = 0), I.starty === void 0 && (I.starty = 0), I.stopx === void 0 && (I.stopx = 0), I.stopy === void 0 && (I.stopy = 0);
	let ee = I.stopy - I.starty;
	ee < F.maxHeight && (ee = F.maxHeight);
	let L = ee + 2 * Z.diagramMarginY;
	Z.mirrorActors && (L = L - Z.boxMargin + Z.bottomMarginAdj);
	let te = I.stopx - I.startx;
	te < F.maxWidth && (te = F.maxWidth);
	let R = te + 2 * Z.diagramMarginX;
	C && h.append("text").text(C).attr("x", (I.stopx - I.startx) / 2 - 2 * Z.diagramMarginX).attr("y", -25), f(h, L, R, Z.useMaxWidth);
	let ne = C ? 40 : 0, re = g.size && l === "neo" ? 30 : 0;
	h.attr("viewBox", I.startx - Z.diagramMarginX + " -" + (Z.diagramMarginY + ne) + " " + R + " " + (L + ne + re)), t.debug("models:", Q.models);
}, "draw");
async function Je(e, n, i) {
	...
	for (let t of n) if (e.get(t.to) && e.get(t.from)) {
		...
		let o = t.placement !== void 0, s = !o, c = o ? Ie(Z) : Fe(Z), l = t.wrap ? S.wrapLabel(t.message, Z.width - 2 * Z.wrapPadding, c) : t.message, u = (r(l) ? await p(t.message, v()) : S.calculateTextDimensions(l, c)).width + 2 * Z.wrapPadding;
		s && t.from === n.nextActor ? a[t.to] = h.getMax(a[t.to] || 0, u) : s && t.from === n.prevActor ? a[t.from] = h.getMax(a[t.from] || 0, u) : s && t.from === t.to ? (a[t.from] = h.getMax(a[t.from] || 0, u / 2), a[t.to] = h.getMax(a[t.to] || 0, u / 2)) : t.placement === i.db.PLACEMENT.RIGHTOF ? a[t.from] = h.getMax(a[t.from] || 0, u) : t.placement === i.db.PLACEMENT.LEFTOF ? a[n.prevActor] = h.getMax(a[n.prevActor] || 0, u) : t.placement === i.db.PLACEMENT.OVER && (n.prevActor && (a[n.prevActor] = h.getMax(a[n.prevActor] || 0, u / 2)), n.nextActor && (a[t.from] = h.getMax(a[t.from] || 0, u / 2)));
	}
	return t.debug("maxMessageWidthPerActor:", a), a;
}
e(Je, "getMaxMessageWidthPerActor");
var Ye = /* @__PURE__ */ e(function(e) {
	let t = 0, n = Le(Z);
...
async function Xe(e, t, n) {
	...
	for (let t of e.keys()) {
		let n = e.get(t);
		n.wrap && (n.description = S.wrapLabel(n.description, Z.width - 2 * Z.wrapPadding, Le(Z)));
		let a = r(n.description) ? await p(n.description, v()) : S.calculateTextDimensions(n.description, Le(Z));
	...
	let a = 0;
	return n.forEach((t) => {
		let n = Fe(Z), r = t.actorKeys.reduce((t, n) => t += e.get(n).width + (e.get(n).margin || 0), 0), i = Z.boxMargin * 8;
...
e(Xe, "calculateActorMargins");
var Ze = /* @__PURE__ */ e(async function(e, n, i) {
	let a = n.get(e.from), o = n.get(e.to), s = a.x, c = o.x, l = e.wrap && e.message, u = r(e.message) ? await p(e.message, v()) : S.calculateTextDimensions(l ? S.wrapLabel(e.message, Z.width, Ie(Z)) : e.message, Ie(Z)), d = {
	...
	return e.placement === i.db.PLACEMENT.RIGHTOF ? (d.width = l ? h.getMax(Z.width, u.width) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s + (a.width + Z.actorMargin) / 2) : e.placement === i.db.PLACEMENT.LEFTOF ? (d.width = l ? h.getMax(Z.width, u.width + 2 * Z.noteMargin) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s - d.width + (a.width - Z.actorMargin) / 2) : e.to === e.from ? (u = S.calculateTextDimensions(l ? S.wrapLabel(e.message, h.getMax(Z.width, a.width), Ie(Z)) : e.message, Ie(Z)), d.width = l ? h.getMax(Z.width, a.width) : h.getMax(a.width, Z.width, u.width + 2 * Z.noteMargin), d.startx = s + (a.width - d.width) / 2) : (d.width = Math.abs(s + a.width / 2 - (c + o.width / 2)) + Z.actorMargin, d.startx = s < c ? s + a.width / 2 - Z.actorMargin / 2 : c + o.width / 2 - Z.actorMargin / 2), l && (d.message = S.wrapLabel(e.message, d.width - 2 * Z.wrapPadding, Ie(Z))), t.debug(`NM:[${d.startx},${d.stopx},${d.starty},${d.stopy}:${d.width},${d.height}=${e.message}]`), d;
}, "buildNoteModel"), Qe = 4, $e = 6, et = /* @__PURE__ */ e(function(e, t) {
...
}, "hasCentralConnection"), tt = /* @__PURE__ */ e(function(e, t, n) {
	...
	return (e.centralConnection === r || e.centralConnection === i) && (s += Qe), (e.centralConnection === r || e.centralConnection === i) && (e.type === a || e.type === o) && (s += n ? 0 : -$e), s;
}, "calculateCentralConnectionOffset"), nt = /* @__PURE__ */ e(function(e, t) {
...
}, "isReverseArrowType"), rt = /* @__PURE__ */ e(function(e, t) {
	let { BIDIRECTIONAL_SOLID: n, BIDIRECTIONAL_DOTTED: r } = t.db.LINETYPE;
	return [n, r].includes(e.type);
}, "isBidirectionalArrowType"), it = /* @__PURE__ */ e(function(t, n, r) {
	let { look: i } = v();
	if (![
	...
	let [a, o] = Ge(t.from, n), [s, c] = Ge(t.to, n), l = a <= s, u = l ? o : a, d = l ? s : c;
	i === "neo" && (t.type !== r.db.LINETYPE.SOLID_OPEN && (d += l ? -3 : 3), (t.type === r.db.LINETYPE.BIDIRECTIONAL_SOLID || t.type === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (u += l ? 3 : -3)), u += tt(t, r, l);
	let f = Math.abs(s - c) > 2, p = /* @__PURE__ */ e((e) => l ? -e : e, "adjustValue");
	t.from === t.to ? d = u : (t.activate && !f && (d += p(Z.activationWidth / 2 - 1)), [
		r.db.LINETYPE.SOLID_OPEN,
		r.db.LINETYPE.DOTTED_OPEN,
		r.db.LINETYPE.STICK_TOP,
		r.db.LINETYPE.STICK_BOTTOM,
	...
	t.wrap && t.message && (t.message = S.wrapLabel(t.message, h.getMax(g + 2 * Z.wrapPadding, Z.width), Fe(Z)));
	let _ = S.calculateTextDimensions(t.message, Fe(Z));
	return {
		width: h.getMax(t.wrap ? 0 : _.width + 2 * Z.wrapPadding, g + 2 * Z.wrapPadding, Z.width),
		height: 0,
		startx: u,
		stopx: d,
		starty: 0,
...
}, "buildMessageModel"), at = /* @__PURE__ */ e(async function(e, n, r, i) {
	let a = {}, o = [], s, c, l;
	for (let t of e) {
		switch (t.type) {
			...
			case i.db.LINETYPE.CRITICAL_OPTION:
				t.message && (s = o.pop(), a[s.id] = s, a[t.id] = s, o.push(s));
				break;
			...
			case i.db.LINETYPE.ACTIVE_START:
				{
					let e = n.get(t.from ? t.from : t.to.actor), r = We(t.from ? t.from : t.to.actor).length, i = e.x + e.width / 2 + (r - 1) * Z.activationWidth / 2, a = {
						startx: i,
		...
		t.placement === void 0 ? (l = it(t, n, i), t.msgModel = l, l.startx && l.stopx && o.length > 0 && o.forEach((e) => {
		...
		})) : (c = await Ze(t, n, i), t.noteModel = c, o.forEach((e) => {
	...
	return Q.activations = [], t.debug("Loop type widths:", a), a;
}, "calculateLoopBounds"), ot = {
	parser: I,
	get db() {
		return new ne();
	},
	...
	styles: re,
	init: /* @__PURE__ */ e((e) => {
		e.sequence || (e.sequence = {}), e.wrap && (e.sequence.wrap = e.wrap, a({ sequence: { wrap: e.wrap } }));
	}, "init")
};
//#endregion
