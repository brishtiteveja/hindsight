...
}, r = /([A-Z])/g, i = (e) => e.replace(r, "-$1").toLowerCase(), a = {
	"&": "&amp;",
	">": "&gt;",
	"<": "&lt;",
	"\"": "&quot;",
	"'": "&#x27;"
}, o = /[&><"']/g, s = (e) => String(e).replace(o, (e) => a[e]), c = (e) => e.type === "ordgroup" || e.type === "color" ? e.body.length === 1 ? c(e.body[0]) : e : e.type === "font" ? c(e.body) : e, l = /* @__PURE__ */ new Set([
	"mathord",
	"textord",
	"atom"
]), u = (e) => l.has(c(e).type), d = (e) => {
...
function m(e) {
	return e.default === void 0 ? p(Array.isArray(e.type) ? e.type[0] : e.type) : e.default;
}
function h(e, t, n, r) {
	var i = n[t];
	e[t] = i === void 0 ? m(r) : r.processor ? r.processor(i) : i;
}
var g = class {
	constructor(e) {
	...
	reportNonstrict(e, t, r) {
		...
		if (typeof i == "function" && (i = i(e, t, r)), i && i !== "ignore") {
			if (i === !0 || i === "error") throw new n("LaTeX-incompatible input and strict mode is set to 'error': " + (t + " [" + e + "]"), r);
...
}, v = 0, y = 1, b = 2, x = 3, S = 4, C = 5, w = 6, T = 7, E = [
	new _(v, 0, !1),
	new _(y, 0, !0),
	new _(b, 1, !1),
	new _(x, 1, !0),
...
var O = (e) => e + " " + e, ue = 80, de = function(e, t) {
	...
	switch (e) {
		case "⎜": return O("M291 0 H417 V" + t + " H291z");
		case "∣": return O("M145 0 H188 V" + t + " H145z");
		case "∥": return O("M145 0 H188 V" + t + " H145z") + O("M367 0 H410 V" + t + " H367z");
		case "⎟": return O("M457 0 H583 V" + t + " H457z");
		case "⎢": return O("M319 0 H403 V" + t + " H319z");
		case "⎥": return O("M263 0 H347 V" + t + " H263z");
		case "⎪": return O("M384 0 H504 V" + t + " H384z");
		case "⏐": return O("M312 0 H355 V" + t + " H312z");
		case "‖": return O("M257 0 H300 V" + t + " H257z") + O("M478 0 H521 V" + t + " H478z");
		default: return "";
	}
}, be = {
	...
	leftlinesegment: O("M40 281 V428 H0 V94 H40 V241 H400000 v40z"),
	leftbracketunder: O("M0 0 h120 V290 H399995 v120 H0z"),
	leftbracketover: O("M0 440 h120 V150 H399995 v-120 H0z"),
	leftmapsto: O("M40 281 V448H0V74H40V241H400000v40z"),
	leftToFrom: "M0 147h400000v40H0zm0 214c68 40 115.7 95.7 143 167h22c15.3 0 23\n-.3 23-1 0-1.3-5.3-13.7-16-37-18-35.3-41.3-69-70-101l-7-8h399905v-40H95l7-8\nc28.7-32 52-65.7 70-101 10.7-23.3 16-35.7 16-37 0-.7-7.7-1-23-1h-22C115.7 265.3\n 68 321 0 361zm0-174v-40h399900v40zm100 154v40h399900v-40z",
	longequal: O("M0 50 h400000 v40H0z m0 194h40000v40H0z"),
	...
	rightlinesegment: O("M399960 241 V94 h40 V428 h-40 V281 H0 v-40z"),
	rightbracketunder: O("M399995 0 h-120 V290 H0 v120 H400000z"),
	rightbracketover: O("M399995 440 h-120 V150 H0 v-120 H399995z"),
...
var Ce = class {
	...
	var r;
	if (e.unit in we) r = we[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
	else if (e.unit === "mu") r = t.fontMetrics().cssEmPerMu;
	else {
		var i = t.style.isTight() ? t.havingStyle(t.style.text()) : t;
		if (e.unit === "ex") r = i.fontMetrics().xHeight;
		else if (e.unit === "em") r = i.fontMetrics().quad;
		else throw new n("Invalid unit: '" + e.unit + "'");
	...
	return t;
}, je = /[\s"'>/=\x00-\x1f]/, Me = function(e) {
	var t = "<" + e;
	this.classes.length && (t += " class=\"" + s(De(this.classes)) + "\"");
	var r = Oe(this.style);
	r && (t += " style=\"" + s(r) + "\"");
	for (var i of Object.keys(this.attributes)) {
		if (je.test(i)) throw new n("Invalid attribute name '" + i + "'");
		t += " " + i + "=\"" + s(this.attributes[i]) + "\"";
	}
	t += ">";
	...
	toMarkup() {
		var e = "<img src=\"" + s(this.src) + "\"" + (" alt=\"" + s(this.alt) + "\""), t = Oe(this.style);
		return t && (e += " style=\"" + s(t) + "\""), e += "'/>", e;
	}
}, Ie = {
	î: "ı̂",
	ï: "ı̈",
	...
	toNode() {
		...
		return this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = A(this.italic)), this.classes.length > 0 && (t = t || document.createElement("span"), t.className = De(this.classes)), Object.keys(this.style).length > 0 && (t = t || document.createElement("span"), Object.assign(t.style, this.style)), t ? (t.appendChild(e), t) : e;
	}
	toMarkup() {
		var e = !1, t = "<span";
		this.classes.length && (e = !0, t += " class=\"", t += s(De(this.classes)), t += "\"");
		var n = "";
		this.italic > 0 && (n += "margin-right:" + A(this.italic) + ";"), n += Oe(this.style), n && (e = !0, t += " style=\"" + s(n) + "\"");
		var r = s(this.text);
	...
	toMarkup() {
		...
		for (var t of Object.keys(this.attributes)) e += " " + t + "=\"" + s(this.attributes[t]) + "\"";
		e += ">";
	...
	toMarkup() {
		return this.alternate ? "<path d=\"" + s(this.alternate) + "\"/>" : "<path d=\"" + s(be[this.pathName]) + "\"/>";
	}
}, Be = class {
	constructor(e) {
...
M(P, F, H, "–", "--", !0), M(P, F, H, "–", "\\textendash"), M(P, F, H, "—", "---", !0), M(P, F, H, "—", "\\textemdash"), M(P, F, H, "‘", "`", !0), M(P, F, H, "‘", "\\textquoteleft"), M(P, F, H, "’", "'", !0), M(P, F, H, "’", "\\textquoteright"), M(P, F, H, "“", "``", !0), M(P, F, H, "“", "\\textquotedblleft"), M(P, F, H, "”", "''", !0), M(P, F, H, "”", "\\textquotedblright"), M(N, F, H, "°", "\\degree", !0), M(P, F, H, "°", "\\degree"), M(P, F, H, "°", "\\textdegree", !0), M(N, F, H, "£", "\\pounds"), M(N, F, H, "£", "\\mathsterling", !0), M(P, F, H, "£", "\\pounds"), M(P, F, H, "£", "\\textsterling", !0), M(N, I, H, "✠", "\\maltese"), M(P, I, H, "✠", "\\maltese");
...
for (var lt = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", ut = 0; ut < lt.length; ut++) {
	var dt = lt.charAt(ut);
	M(N, F, z, dt, dt), M(P, F, H, dt, dt);
}
M(N, I, H, "C", "ℂ"), M(P, I, H, "C", "ℂ"), M(N, I, H, "H", "ℍ"), M(P, I, H, "H", "ℍ"), M(N, I, H, "N", "ℕ"), M(P, I, H, "N", "ℕ"), M(N, I, H, "P", "ℙ"), M(P, I, H, "P", "ℙ"), M(N, I, H, "Q", "ℚ"), M(P, I, H, "Q", "ℚ"), M(N, I, H, "R", "ℝ"), M(P, I, H, "R", "ℝ"), M(N, I, H, "Z", "ℤ"), M(P, I, H, "Z", "ℤ"), M(N, F, z, "h", "ℎ"), M(P, F, z, "h", "ℎ");
for (var U, ft = 0; ft < lt.length; ft++) {
	var W = lt.charAt(ft);
	U = String.fromCharCode(55349, 56320 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56372 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56424 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56580 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56684 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56736 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56788 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56840 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56944 + ft), M(N, F, z, W, U), M(P, F, H, W, U), ft < 26 && (U = String.fromCharCode(55349, 56632 + ft), M(N, F, z, W, U), M(P, F, H, W, U), U = String.fromCharCode(55349, 56476 + ft), M(N, F, z, W, U), M(P, F, H, W, U));
}
U = String.fromCharCode(55349, 56668), M(N, F, z, "k", U), M(P, F, H, "k", U);
for (var pt = 0; pt < 10; pt++) {
	var mt = pt.toString();
	U = String.fromCharCode(55349, 57294 + pt), M(N, F, z, mt, U), M(P, F, H, mt, U), U = String.fromCharCode(55349, 57314 + pt), M(N, F, z, mt, U), M(P, F, H, mt, U), U = String.fromCharCode(55349, 57324 + pt), M(N, F, z, mt, U), M(P, F, H, mt, U), U = String.fromCharCode(55349, 57334 + pt), M(N, F, z, mt, U), M(P, F, H, mt, U);
}
for (var ht = "ÐÞþ", gt = 0; gt < ht.length; gt++) {
	var _t = ht.charAt(gt);
	M(N, F, z, _t, _t), M(P, F, H, _t, _t);
}
var vt = {
	mathClass: "mathbf",
	textClass: "textbf",
	...
	var t = e.charCodeAt(0), r = e.charCodeAt(1), i = (t - 55296) * 1024 + (r - 56320) + 65536;
	...
	return r === void 0 && (r = []), n.font === "boldsymbol" && Nt(e, "Main-Bold", t).metrics ? Pt(e, "Main-Bold", t, n, r.concat(["mathbf"])) : e === "\\" || j[t][e].font === "main" ? Pt(e, "Main-Regular", t, n, r) : Pt(e, "AMS-Regular", t, n, r.concat(["amsrm"]));
}, It = function(e, t, n) {
	...
	var r = G([e], [], t);
	return r.height = Math.max(n || t.fontMetrics().defaultRuleThickness, t.minRuleThickness), r.style.borderBottomWidth = A(r.height), r.maxFontSize = 1, r;
}, Ut = function(e, t, n, r) {
	...
	return e instanceof Ce ? G([], [e], t) : e;
}, Kt = function(e) {
	...
	for (var l = [], u = r, d = r, f = r, p = 0; p < n.length; p++) {
		...
		if (m.type === "kern") f += m.size;
			...
			v.style.top = A(-i - f - h.depth), m.marginLeft && (v.style.marginLeft = m.marginLeft), m.marginRight && (v.style.marginRight = m.marginRight), l.push(v), f += h.height + h.depth;
		}
	...
	if (u < 0) {
		var x = G(["vlist"], [G([], [])]);
		x.style.height = A(-u), b = [G(["vlist-r"], [y, G(["vlist-s"], [new Le("​")])]), G(["vlist-r"], [x])];
	} else b = [G(["vlist-r"], [y])];
	var S = G(["vlist-t"], b);
	return b.length === 2 && S.classes.push("vlist-t2"), S.height = d, S.depth = -u, S;
}, qt = (e, t) => {
	var n = G(["mspace"], [], t), r = k(e, t);
	return n.style.marginRight = A(r), n;
}, Jt = (e, t, n) => {
	var r, i;
	switch (e) {
		case "amsrm":
	...
	return a.height = i, a.style.height = A(i), a.style.width = A(r), a;
}, q = {
	number: 3,
	unit: "mu"
}, Qt = {
...
var sn = function(e) {
	...
	if (e.length === 1) {
		var l = e[0];
		l.type === "sizing" ? c = t.havingSize(l.size) : l.type === "styling" && (c = t.havingStyle(dn[l.style]));
	}
	var u = G([r[0] || "leftmost"], [], t), d = G([r[1] || "rightmost"], [], t), f = n === "root";
	return mn(i, (e, t) => {
		var n = t.classes[0], r = e.classes[0];
		n === "mbin" && un.has(r) ? t.classes[0] = "mord" : r === "mbin" && ln.has(n) && (e.classes[0] = "mord");
	}, { node: u }, d, f), mn(i, (e, t) => {
		var n = _n(t), r = _n(e), i = n && r ? e.hasClass("mtight") ? tn[n]?.[r] : en[n]?.[r] : null;
		if (i) return qt(i, c);
	}, { node: u }, d, f), i;
	...
	if (n) {
		var r = n.children;
		if (r.length) {
			if (t === "right") return gn(r[r.length - 1], "right");
			if (t === "left") return gn(r[0], "left");
		}
	}
	return e;
}, _n = function(e, t) {
	return e ? (t && (e = gn(e, t)), fn[e.classes[0]] || null) : null;
}, vn = function(e, t) {
...
function yn(e, t) {
	...
	return r.style.height = A(n.height + n.depth), n.depth && (r.style.verticalAlign = A(-n.depth)), n.children.unshift(r), n;
}
function bn(e, t) {
	var n = null;
	...
	for (var a = [], o = [], s = 0; s < r.length; s++) if (o.push(r[s]), r[s].hasClass("mbin") || r[s].hasClass("mrel") || r[s].hasClass("allowbreak")) {
		...
		c || (a.push(yn(o, t)), o = []);
	} else r[s].hasClass("newline") && (o.pop(), o.length > 0 && (a.push(yn(o, t)), o = []), a.push(r[s]));
	o.length > 0 && a.push(yn(o, t));
	var l;
	n ? (l = yn(pn(n, t, !0), t), l.classes = ["tag"], a.push(l)) : i && a.push(i);
	var u = G(["katex-html"], a);
	if (u.setAttribute("aria-hidden", "true"), l) {
		var d = l.children[0];
		d.style.height = A(u.height + u.depth), u.depth && (d.style.verticalAlign = A(-u.depth));
	}
	return u;
}
function xn(e) {
...
var X = class {
	...
	toNode() {
		...
		for (var n = 0; n < this.children.length; n++) if (this.children[n] instanceof Sn && this.children[n + 1] instanceof Sn) {
			for (var r = this.children[n].toText() + this.children[++n].toText(); this.children[n + 1] instanceof Sn;) r += this.children[++n].toText();
			e.appendChild(new Sn(r).toNode());
		} else e.appendChild(this.children[n].toNode());
		return e;
	}
	toMarkup() {
		var e = "<" + this.type;
		for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + "=\"", e += s(this.attributes[t]), e += "\"");
		this.classes.length > 0 && (e += " class =\"" + s(De(this.classes)) + "\""), e += ">";
		for (var n = 0; n < this.children.length; n++) e += this.children[n].toMarkup();
...
}, wn = /* @__PURE__ */ new Set(["\\imath", "\\jmath"]), Tn = /* @__PURE__ */ new Set(["mrow", "mtable"]), En = function(e, t, n) {
	return j[t][e] && j[t][e].replace && e.charCodeAt(0) !== 55349 && !(nt.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = j[t][e].replace), new Sn(e);
}, Dn = function(e) {
...
var jn = function(e, t, n) {
	...
	for (var i = [], a, o = 0; o < e.length; o++) {
		...
		if (s instanceof X && a instanceof X) {
			...
			if (s.type === "mn" && An(a)) s.children = [...a.children, ...s.children], i.pop();
			else if ((s.type === "msup" || s.type === "msub") && s.children.length >= 1 && (a.type === "mn" || An(a))) {
				var c = s.children[0];
				c instanceof X && c.type === "mn" && (c.children = [...a.children, ...c.children], i.pop());
			} else if (a.type === "mi" && a.children.length === 1) {
				var l = a.children[0];
				if (l instanceof Sn && l.text === "̸" && (s.type === "mo" || s.type === "mi" || s.type === "mn")) {
					var u = s.children[0];
					u instanceof Sn && u.text.length > 0 && (u.text = u.text.slice(0, 1) + "̸" + u.text.slice(1), i.pop());
				}
			}
		}
		i.push(s), a = s;
	...
	if (!e) return new X("mrow");
	if (an[e.type]) return an[e.type](e, t);
	throw new n("Got group of unknown type: '" + e.type + "'");
};
function Nn(e, t, n, r, i) {
	var a = jn(e, n), o = a.length === 1 && a[0] instanceof X && Tn.has(a[0].type) ? a[0] : new X("mrow", a), s = new X("annotation", [new Sn(t)]);
...
var Pn = [
	...
	return t.size < 2 ? e : Pn[e - 1][t.size - 1];
}, Ln = class e {
	constructor(t) {
		this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = t.style, this.color = t.color, this.size = t.size || e.BASESIZE, this.textSize = t.textSize || this.size, this.phantom = !!t.phantom, this.font = t.font || "", this.fontFamily = t.fontFamily || "", this.fontWeight = t.fontWeight || "", this.fontShape = t.fontShape || "", this.sizeMultiplier = Fn[this.size - 1], this.maxSize = t.maxSize, this.minRuleThickness = t.minRuleThickness, this._fontMetrics = void 0;
	}
	extend(t) {
		var n = {
			style: this.style,
	...
	havingSize(e) {
		return this.size === e && this.textSize === e ? this : this.extend({
			...
			size: e,
			textSize: e,
			sizeMultiplier: Fn[e - 1]
		});
	}
	havingBaseStyle(t) {
		t = t || this.style.text();
		var n = In(e.BASESIZE, t);
	...
	fontMetrics() {
		return this._fontMetrics || (this._fontMetrics = Xe(this.size)), this._fontMetrics;
	}
	getColor() {
...
var Rn = function(e) {
	...
	var r = Rn(n), i;
	return n.output === "mathml" ? Nn(e, t, r, n.displayMode, !0) : (i = n.output === "html" ? G(["katex"], [bn(e, r)]) : G(["katex"], [Nn(e, t, r, n.displayMode, !1), bn(e, r)]), zn(i, n));
}, Vn = function(e, t, n) {
	return zn(G(["katex"], [bn(e, Rn(n))]), n);
}, Hn = {
	widehat: "^",
	widecheck: "ˇ",
	widetilde: "~",
	...
	var t = new X("mo", [new Sn(Hn[e.replace(/^\\/, "")])]);
	...
	return r.height = a, r.style.height = A(a), i > 0 && (r.style.minWidth = A(i)), r;
...
function Qn(e) {
	return e && (e.type === "atom" || Yn.hasOwnProperty(e.type)) ? e : null;
}
var $n = (e) => {
	if (e instanceof Le) return e;
	if (Ue(e) && e.children.length === 1) return $n(e.children[0]);
}, er = (e, t) => {
	var n, r, i;
	e && e.type === "supsub" ? (r = Q(e.base, "accent"), n = r.base, e.base = n, i = He(Y(e, t)), e.base = r) : (r = Q(e, "accent"), n = r.base);
	var a = Y(n, t.havingCrampedStyle()), o = r.isShifty && u(n), s = 0;
	o && (s = $n(a)?.skew ?? 0);
	var c = r.label === "\\c", l = c ? a.height + a.depth : Math.min(a.height, t.fontMetrics().xHeight), d;
	if (r.isStretchy) d = Kn(r, t), d = K({
		...
		r.label === "\\vec" ? (f = Zt("vec", t), p = Xt.vec[1]) : (f = Lt({
			...
			mode: r.mode,
			text: r.label
		}, t, "textord"), f = Ve(f), f.italic = 0, p = f.width, c && (l += f.depth)), d = G(["accent-body"], [f]);
		var m = r.label === "\\textcircled";
		m && (d.classes.push("accent-full"), l = a.height);
		var h = s;
		m || (h -= p / 2), d.style.left = A(h), r.label === "\\textcircled" && (d.style.top = ".2em"), d = K({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
	...
	var g = G(["mord", "accent"], [d], t);
	return i ? (i.children[0] = g, i.height = Math.max(g.height, i.height), i.classes[0] = "mord", i) : g;
}, tr = (e, t) => {
	var n = e.isStretchy ? Un(e.label) : new X("mo", [En(e.label, e.mode)]), r = new X("mover", [Z(e.base, t), n]);
...
J({
	...
	props: { numArgs: 1 },
	handler: (e, t) => {
		var n = sn(t[0]), r = !nr.test(e.funcName), i = !r || e.funcName === "\\widehat" || e.funcName === "\\widetilde" || e.funcName === "\\widecheck";
		return {
			type: "accent",
			mode: e.parser.mode,
			label: e.funcName,
	...
	htmlBuilder: (e, t) => {
		var n = Y(e.base, t), r = Kn(e, t), i = e.label === "\\utilde" ? .12 : 0;
	...
	mathmlBuilder: (e, t) => {
		var n = Un(e.label), r = new X("munder", [Z(e.base, t), n]);
...
J({
	...
	htmlBuilder(e, t) {
		var n = t.style, r = t.havingStyle(n.sup()), i = Gt(Y(e.body, r, t), t), a = e.label.slice(0, 2) === "\\x" ? "x" : "cd";
		i.classes.push(a + "-arrow-pad");
		var o;
		e.below && (r = t.havingStyle(n.sub()), o = Gt(Y(e.below, r, t), t), o.classes.push(a + "-arrow-pad"));
		var s = Kn(e, t), c = -t.fontMetrics().axisHeight + .5 * s.height, l = -t.fontMetrics().axisHeight - .5 * s.height - .111;
	...
	mathmlBuilder(e, t) {
		...
		} else e.below ? r = new X("munder", [n, rr(Z(e.below, t))]) : (r = rr(), r = new X("mover", [n, r]));
		return r;
	}
});
function ir(e, t) {
...
J({
	...
	props: { numArgs: 2 },
	handler(e, t) {
		var { parser: n, funcName: r } = e, i = t[1], a = t[0], o = r === "\\stackrel" ? "mrel" : or(i), s = {
			type: "op",
			mode: i.mode,
			limits: !0,
	...
	htmlBuilder(e, t) {
		var n = pn(e.body, t, !0), r = G([e.mclass], n, t);
		return r.style.textShadow = "0.02em 0.01em 0.04px", r;
	},
	mathmlBuilder(e, t) {
		var n = new X("mstyle", jn(e.body, t));
...
var sr = {
	...
	style: "display",
	resetFont: !0
}), lr = (e) => e.type === "textord" && e.text === "@", ur = (e, t) => (e.type === "mathord" || e.type === "atom") && e.text === t;
function dr(e, t, n) {
	var r = sr[e];
	switch (r) {
		case "\\\\cdrightarrow":
...
function fr(e) {
	...
	for (e.gullet.beginGroup(), e.gullet.macros.set("\\cr", "\\\\\\relax"), e.gullet.beginGroup();;) {
		...
		if (r === "&" || r === "\\\\") e.consume();
			...
			break;
		} else throw new n("Expected \\\\ or \\cr or \\end", e.nextToken);
	}
	for (var i = [], a = [i], o = 0; o < t.length; o++) {
		for (var s = t[o], c = cr(), l = 0; l < s.length; l++) if (!lr(s[l])) c.body.push(s[l]);
		else {
			i.push(c), l += 1;
			var u = Zn(s[l]).text, d = [, ,];
			if (d[0] = {
				...
				if ("<>AV".includes(u)) for (var f = 0; f < 2; f++) {
					for (var p = !0, m = l + 1; m < s.length; m++) {
						if (ur(s[m], u)) {
							p = !1, l = m;
							break;
						}
						if (lr(s[m])) throw new n("Missing a " + u + " character to complete a CD arrow.", s[m]);
						d[f].body.push(s[m]);
					}
					if (p) throw new n("Missing a " + u + " character to complete a CD arrow.", s[l]);
				}
				else throw new n("Expected one of \"<>AV=|.\" after @", s[l]);
			}
			var h = {
				type: "styling",
				body: [dr(u, d, e)],
...
J({
	...
	htmlBuilder(e, t) {
		var n = t.havingStyle(t.style.sup()), r = Gt(Y(e.label, n, t), t);
		return r.classes.push("cd-label-" + e.side), r.style.bottom = A(.8 - r.depth), r.height = 0, r.depth = 0, r;
	},
	mathmlBuilder(e, t) {
	...
	handler(e, t) {
		for (var { parser: r } = e, i = Q(t[0], "ordgroup").body, a = "", o = 0; o < i.length; o++) {
			var s = Q(i[o], "textord");
			a += s.text;
		}
		var c = parseInt(a), l;
		if (isNaN(c)) throw new n("\\@char has non-numeric argument " + a);
		if (c < 0 || c >= 1114111) throw new n("\\@char with invalid code point " + a);
...
var pr = (e, t) => Wt(pn(e.body, t.withColor(e.color), !1)), mr = (e, t) => {
	var n = new X("mstyle", jn(e.body, t.withColor(e.color)));
...
J({
	...
	htmlBuilder(e, t) {
		var n = G(["mspace"], [], t);
		return e.newLine && (n.classes.push("newline"), e.size && (n.style.marginTop = A(k(e.size, t)))), n;
	},
	mathmlBuilder(e, t) {
		var n = new X("mspace");
		return e.newLine && (n.setAttribute("linebreak", "newline"), e.size && n.setAttribute("height", A(k(e.size, t)))), n;
	}
});
var hr = {
	"\\global": "\\global",
...
J({
	...
	handler(e) {
		...
		t.consumeSpaces();
		var i = t.fetch();
		if (hr[i.text]) return (r === "\\global" || r === "\\\\globallong") && (i.text = hr[i.text]), Q(t.parseFunction(), "internal");
		throw new n("Invalid token after macro prefix", i);
	}
}), J({
	type: "internal",
	names: [
	...
	handler(e) {
		var { parser: t, funcName: r } = e, i = t.gullet.popToken(), a = i.text;
		if (/^(?:[\\{}$&#^_]|EOF)$/.test(a)) throw new n("Expected a control sequence", i);
		for (var o = 0, s, c = [[]]; t.gullet.future().text !== "{";) if (i = t.gullet.popToken(), i.text === "#") {
			if (t.gullet.future().text === "{") {
				s = t.gullet.future(), c[o].push("{");
				break;
			}
			if (i = t.gullet.popToken(), !/^[1-9]$/.test(i.text)) throw new n("Invalid argument number \"" + i.text + "\"");
			if (parseInt(i.text) !== o + 1) throw new n("Argument number \"" + i.text + "\" out of order");
			o++, c.push([]);
		} else if (i.text === "EOF") throw new n("Expected a macro definition");
		else c[o].push(i.text);
		var { tokens: l } = t.gullet.consumeArg();
		return s && l.unshift(s), (r === "\\edef" || r === "\\xdef") && (l = t.gullet.expandTokens(l), l.reverse()), t.gullet.macros.set(a, {
			tokens: l,
			numArgs: o,
			delimiters: c
		}, r === hr[r]), {
	...
	handler(e) {
		...
		return t.gullet.consumeSpaces(), vr(t, r, _r(t), n === "\\\\globallet"), {
			type: "internal",
			mode: t.mode
		};
	}
	...
	handler(e) {
		...
		return vr(t, r, a, n === "\\\\globalfuture"), t.gullet.pushToken(a), t.gullet.pushToken(i), {
			type: "internal",
			mode: t.mode
		};
	}
...
var yr = function(e, t, n) {
	var r = Je(j.math[e] && j.math[e].replace || e, t, n);
	...
	var o = br(Pt(e, "Main-Regular", i, r), t, r, a);
	return n && xr(o, r, t), o;
}, Cr = function(e, t, n, r) {
	return Pt(e, "Size" + t + "-Regular", n, r);
}, wr = function(e, t, n, r, i, a) {
	var o = Cr(e, t, i, r), s = br(G(["delimsizing", "size" + t], [o], r), D.TEXT, r, a);
	return n && xr(s, r, D.TEXT), s;
}, Tr = function(e, t, n) {
	return {
		type: "elem",
		elem: G(["delimsizinginner", t === "Size1-Regular" ? "delim-size1" : "delim-size4"], [G([], [Pt(e, t, n)])])
	};
}, Er = function(e, t, n) {
	...
	return i.height = t, i.style.height = A(t), i.style.width = A(r), {
		type: "elem",
		elem: i
	};
}, Dr = .008, Or = {
	...
	var T = C / 2 - w, E = [];
	if (u.length > 0) {
		var ee = C - m - v, te = Math.round(C * 1e3), ne = xe(u, Math.round(ee * 1e3)), re = new ze(u, ne), ie = A(d / 1e3), ae = A(te / 1e3), oe = Vt([], [new Re([re], {
			width: ie,
			height: ae,
			viewBox: "0 0 " + d + " " + te
		})], r);
		...
		if (E.push(Tr(l, f, i)), E.push(Or), s === null) {
			var se = C - m - v + 2 * Dr;
			E.push(Er(c, se, r));
		} else {
			var ce = (C - m - v - y) / 2 + 2 * Dr;
			E.push(Er(c, ce, r)), E.push(Or), E.push(Tr(s, f, i)), E.push(Or), E.push(Er(c, ce, r));
		}
		E.push(Or), E.push(Tr(o, f, i));
	}
	var le = r.havingBaseStyle(D.TEXT);
	return br(G(["delimsizing", "mult"], [K({
		positionType: "bottom",
		positionData: T,
		children: E
	})], le), D.TEXT, r, a);
}, Mr = 80, Nr = .08, Pr = function(e, t, n, r, i) {
	...
	var n = t.havingBaseSizing(), r = Gr("\\surd", e * n.sizeMultiplier, Ur, n), i = n.sizeMultiplier, a = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), o, s, c, l, u;
	return r.type === "small" ? (l = 1e3 + 1e3 * a + Mr, e < 1 ? i = 1 : e < 1.4 && (i = .7), s = (1 + a + Nr) / i, c = (1 + a) / i, o = Pr("sqrtMain", s, l, a, t), o.style.minWidth = "0.853em", u = .833 / i) : r.type === "large" ? (l = (1e3 + Mr) * zr[r.size], c = (zr[r.size] + a) / i, s = (zr[r.size] + a + Nr) / i, o = Pr("sqrtSize" + r.size, s, l, a, t), o.style.minWidth = "1.02em", u = 1 / i) : (s = e + a + Nr, c = e + a, l = Math.floor(1e3 * e + a) + Mr, o = Pr("sqrtTall", s, l, a, t), o.style.minWidth = "0.742em", u = 1.056), o.height = c, o.style.height = A(s), {
		span: o,
		advanceWidth: u,
	...
	2.4,
	3
], Br = function(e, t, r, i, a) {
	if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), Ir.has(e) || Rr.has(e)) return wr(e, t, !1, r, i, a);
	if (Lr.has(e)) return jr(e, zr[t], !1, r, i, a);
	...
	for (var i = Math.min(2, 3 - r.style.size); i < n.length; i++) {
		...
		var o = yr(e, Wr(a), "math"), s = o.height + o.depth;
		if (a.type === "small") {
	...
	var o = Rr.has(e) ? Vr : Ir.has(e) ? Ur : Hr, s = Gr(e, t, o, r);
	return s.type === "small" ? Sr(e, s.style, n, r, i, a) : s.type === "large" ? wr(e, s.size, n, r, i, a) : jr(e, t, n, r, i, a);
}, qr = function(e, t, n, r, i, a) {
	var o = r.fontMetrics().axisHeight * r.sizeMultiplier, s = 901, c = 5 / r.fontMetrics().ptPerEm, l = Math.max(t - o, n + o);
	return Kr(e, Math.max(l / 500 * s, 2 * l - c), !0, r, i, a);
}, Jr = {
	"\\bigl": {
		mclass: "mopen",
		size: 1
...
}, Yr = /* @__PURE__ */ new Set(/* @__PURE__ */ "(,\\lparen,),\\rparen,[,\\lbrack,],\\rbrack,\\{,\\lbrace,\\},\\rbrace,\\lfloor,\\rfloor,⌊,⌋,\\lceil,\\rceil,⌈,⌉,<,>,\\langle,⟨,\\rangle,⟩,\\lt,\\gt,\\lvert,\\rvert,\\lVert,\\rVert,\\lgroup,\\rgroup,⟮,⟯,\\lmoustache,\\rmoustache,⎰,⎱,/,\\backslash,|,\\vert,\\|,\\Vert,\\uparrow,\\Uparrow,\\downarrow,\\Downarrow,\\updownarrow,\\Updownarrow,.".split(","));
function Xr(e) {
...
J({
	...
	handler: (e, t) => {
		...
		return {
			type: "delimsizing",
			mode: e.parser.mode,
			size: Jr[e.funcName].size,
			mclass: Jr[e.funcName].mclass,
			delim: n.text
		};
	},
	htmlBuilder: (e, t) => e.delim === "." ? G([e.mclass]) : Br(e.delim, e.size, t, e.mode, [e.mclass]),
	mathmlBuilder: (e) => {
		var t = [];
		e.delim !== "." && t.push(En(e.delim, e.mode));
		var n = new X("mo", t);
...
J({
	...
	handler: (e, t) => {
		...
		if (r && typeof r != "string") throw new n("\\current@color set to non-string in \\right");
		return {
			type: "leftright-right",
			mode: e.parser.mode,
			delim: Zr(t[0], e).text,
	...
	htmlBuilder: (e, t) => {
		Qr(e);
		for (var n = pn(e.body, t, !0, ["mopen", "mclose"]), r = 0, i = 0, a = !1, o = 0; o < n.length; o++) {
			var s = n[o];
			Xr(s) ? a = !0 : (r = Math.max(n[o].height, r), i = Math.max(n[o].depth, i));
		}
		r *= t.sizeMultiplier, i *= t.sizeMultiplier;
		var c = e.left === "." ? vn(t, ["mopen"]) : qr(e.left, r, i, t, e.mode, ["mopen"]);
		if (n.unshift(c), a) for (var l = 1; l < n.length; l++) {
			var u = n[l];
			if (Xr(u)) {
				var d = u.isMiddle;
				n[l] = qr(d.delim, r, i, d.options, e.mode, []);
			}
		}
		var f;
		if (e.right === ".") f = vn(t, ["mclose"]);
		else {
			var p = e.rightColor ? t.withColor(e.rightColor) : t;
			f = qr(e.right, r, i, p, e.mode, ["mclose"]);
		}
	...
	mathmlBuilder: (e, t) => {
		...
		var n = jn(e.body, t);
		if (e.left !== ".") {
			var r = new X("mo", [En(e.left, e.mode)]);
			r.setAttribute("fence", "true"), n.unshift(r);
		}
		if (e.right !== ".") {
			var i = new X("mo", [En(e.right, e.mode)]);
	...
	htmlBuilder: (e, t) => {
		var n;
		return e.delim === "." ? n = vn(t, []) : (n = Br(e.delim, 1, t, e.mode, []), n.isMiddle = {
			delim: e.delim,
			options: t
		}), n;
	},
	mathmlBuilder: (e, t) => {
		var n = new X("mo", [e.delim === "\\vert" || e.delim === "|" ? En("|", "text") : En(e.delim, e.mode)]);
		return n.setAttribute("fence", "true"), n.setAttribute("lspace", "0.05em"), n.setAttribute("rspace", "0.05em"), n;
	}
});
var $r = (e, t) => {
	var n = Gt(Y(e.body, t), t), r = e.label.slice(1), i = t.sizeMultiplier, a, o, s = u(e.body);
	if (r === "sout") a = G(["stretchy", "sout"]), a.height = t.fontMetrics().defaultRuleThickness / i, o = -.5 * t.fontMetrics().xHeight;
		...
		i /= d.sizeMultiplier;
		var f = n.height + n.depth + c + l;
		n.style.paddingLeft = A(f / 2 + c);
		...
		a = Vt(["hide-tail"], [new Re([new ze("phase", ge(p))], {
			...
			preserveAspectRatio: "xMinYMin slice"
		})], t), a.style.height = A(f), o = n.depth + c + l;
	} else {
		/cancel/.test(r) ? s || n.classes.push("cancel-pad") : r === "angl" ? n.classes.push("anglpad") : n.classes.push("boxpad");
		var m, h, g = 0;
		/box/.test(r) ? (g = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), m = t.fontMetrics().fboxsep + (r === "colorbox" ? 0 : g), h = m) : r === "angl" ? (g = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness), m = 4 * g, h = Math.max(0, .25 - n.depth)) : (m = s ? .2 : 0, h = m), a = qn(n, r, m, h, t), /fbox|boxed|fcolorbox/.test(r) ? (a.style.borderStyle = "solid", a.style.borderWidth = A(g)) : r === "angl" && g !== .049 && (a.style.borderTopWidth = A(g), a.style.borderRightWidth = A(g)), o = n.depth + h, e.backgroundColor && (a.style.backgroundColor = e.backgroundColor, e.borderColor && (a.style.borderColor = e.borderColor));
	}
	var _;
	if (e.backgroundColor) _ = K({
		positionType: "individualShift",
		children: [{
			type: "elem",
			elem: a,
	...
	return /cancel/.test(r) && (_.height = n.height, _.depth = n.depth), /cancel/.test(r) && !s ? G(["mord", "cancel-lap"], [_], t) : G(["mord"], [_], t);
}, ei = (e, t) => {
	...
	switch (e.label) {
		...
		case "\\colorbox":
			if (n = t.fontMetrics().fboxsep * t.fontMetrics().ptPerEm, r.setAttribute("width", "+" + 2 * n + "pt"), r.setAttribute("height", "+" + 2 * n + "pt"), r.setAttribute("lspace", n + "pt"), r.setAttribute("voffset", n + "pt"), e.label === "\\fcolorbox") {
				...
				r.setAttribute("style", "border: " + A(i) + " solid " + e.borderColor);
			}
			break;
...
var ii = class e {
	...
	range(t, n) {
		return new e(n, ii.range(this, t));
	}
};
function oi(e) {
	var t = [];
...
}, ci = /* @__PURE__ */ new Set(["gather", "gather*"]);
function li(e) {
	if (!e.includes("ed")) return !e.includes("*");
}
function ui(e, t, r) {
	var { hskipBeforeAndAfter: i, addJot: a, cols: o, arraystretch: s, colSeparationType: c, autoTag: l, singleRow: u, emptySingleRow: d, maxNumCols: f, leqno: p } = t;
	if (e.gullet.beginGroup(), u || e.gullet.macros.set("\\cr", "\\\\\\relax"), !s) {
		var m = e.gullet.expandMacroAsText("\\arraystretch");
		if (m == null) s = 1;
		else if (s = parseFloat(m), !s || s < 0) throw new n("Invalid \\arraystretch: " + m);
	}
	e.gullet.beginGroup();
	...
	function x() {
		y && (e.gullet.macros.get("\\df@tag") ? (y.push(e.subparse([new ai("\\df@tag")])), e.gullet.macros.set("\\df@tag", void 0, !0)) : y.push(!!l && e.gullet.macros.get("\\@eqnsw") === "1"));
	}
	for (b(), v.push(oi(e));;) {
		...
		if (w === "&") {
			if (f && h.length === f) {
				if (u || c) throw new n("Too many tab characters: &", e.nextToken);
			...
			e.consume();
			var T = void 0;
			e.gullet.future().text !== " " && (T = e.parseSizeGroup(!0)), _.push(T ? T.value : null), x(), v.push(oi(e)), h = [], g.push(h), b();
		} else throw new n("Expected & or \\\\ or \\cr or \\end", e.nextToken);
	}
	return e.gullet.endGroup(), e.gullet.endGroup(), {
		type: "array",
		mode: e.mode,
...
var fi = function(e, t) {
	var r, i, a = e.body.length, o = e.hLinesBeforeRow, s = 0, c = Array(a), l = [], u = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness), d = 1 / t.fontMetrics().ptPerEm, f = 5 * d;
	e.colSeparationType && e.colSeparationType === "small" && (f = .2778 * (t.havingStyle(D.SCRIPT).sizeMultiplier / t.sizeMultiplier));
	var p = e.colSeparationType === "CD" ? k({
		number: 3,
		unit: "ex"
	...
	for (y(o[0]), r = 0; r < e.body.length; ++r) {
		...
		var T = e.rowGaps[r], E = 0;
		T && (E = k(T, t), E > 0 && (E += _, S < E && (S = E), E = 0)), e.addJot && r < e.body.length - 1 && (S += m), C.height = x, C.depth = S, v += x, C.pos = v, v += S + E, c[r] = C, y(o[r + 1]);
	}
	var ee = v / 2 + t.fontMetrics().axisHeight, te = e.cols || [], ne = [], re, ie, ae = [];
	if (e.tags && e.tags.some((e) => e)) for (r = 0; r < a; ++r) {
		var oe = c[r], se = oe.pos - ee, ce = e.tags[r], le = void 0;
		le = ce === !0 ? G(["eqn-num"], [], t) : ce === !1 ? G([], [], t) : G([], pn(ce, t, !0), t), le.depth = oe.depth, le.height = oe.height, ae.push({
			type: "elem",
			elem: le,
			shift: se
		});
	}
	for (i = 0, ie = 0; i < s || ie < te.length; ++i, ++ie) {
		for (var O = te[ie], ue = !0; (de = O)?.type === "separator";) {
			var de;
			if (ue || (re = G(["arraycolsep"], []), re.style.width = A(t.fontMetrics().doubleRuleSep), ne.push(re)), O.separator === "|" || O.separator === ":") {
				var fe = O.separator === "|" ? "solid" : "dashed", pe = G(["vertical-separator"], [], t);
				pe.style.height = A(v), pe.style.borderRightWidth = A(u), pe.style.borderRightStyle = fe, pe.style.margin = "0 " + A(-u / 2);
				var me = v - ee;
				me && (pe.style.verticalAlign = A(-me)), ne.push(pe);
			} else throw new n("Invalid separator type: " + O.separator);
			ie++, O = te[ie], ue = !1;
		}
		if (!(i >= s)) {
			var he = void 0;
			(i > 0 || e.hskipBeforeAndAfter) && (he = O?.pregap ?? f, he !== 0 && (re = G(["arraycolsep"], []), re.style.width = A(he), ne.push(re)));
			var ge = [];
			for (r = 0; r < a; ++r) {
				var _e = c[r], ve = _e.cells[i];
				if (ve) {
					var ye = _e.pos - ee;
			...
			var be = K({
				positionType: "individualShift",
				children: ge
			}), xe = G(["col-align-" + (O?.align || "c")], [be]);
			ne.push(xe), (i < s - 1 || e.hskipBeforeAndAfter) && (he = O?.postgap ?? f, he !== 0 && (re = G(["arraycolsep"], []), re.style.width = A(he), ne.push(re)));
		}
	}
	var Se = G(["mtable"], ne);
	if (l.length > 0) {
		for (var Ce = Ht("hline", t, u), we = Ht("hdashline", t, u), Te = [{
			type: "elem",
			elem: Se,
			shift: 0
		}]; l.length > 0;) {
	...
	if (e.cols && e.cols.length > 0) {
		...
		for (var v = g; v < _; v++) {
			var y = p[v];
			y.type === "align" ? (f += pi[y.align], h && (m += "none "), h = !0) : y.type === "separator" && h && (m += y.separator === "|" ? "solid " : "dashed ", h = !1);
		}
	...
	e.envName.includes("ed") || si(e);
	var r = [], i = e.envName.includes("at") ? "alignat" : "align", a = e.envName === "split", o = ui(e.parser, {
		cols: r,
		addJot: !0,
		autoTag: a ? void 0 : li(e.envName),
		emptySingleRow: !0,
		colSeparationType: i,
	...
	o.body.forEach(function(e) {
		for (var t = 1; t < e.length; t += 2) Q(Q(e[t], "styling").body[0], "ordgroup").body.unshift(l);
		if (p) c < e.length && (c = e.length);
		else {
			var r = e.length / 2;
			if (s < r) throw new n("Too many math in a row: " + ("expected " + s + ", but got " + r), e[0]);
		}
	});
	for (var m = 0; m < c; ++m) {
		var h = "r", g = 0;
...
ni({
	...
	props: { numArgs: 1 },
	handler(e, t) {
		var r = (Qn(t[0]) ? [t[0]] : Q(t[0], "ordgroup").body).map(function(e) {
			var t = Zn(e).text;
		...
		return ui(e.parser, i, di(e.envName));
	},
	htmlBuilder: fi,
	mathmlBuilder: mi
}), ni({
	...
	handler(e) {
		...
		if (e.envName.charAt(e.envName.length - 1) === "*") {
			...
			if (a.consumeSpaces(), a.fetch().text === "[") {
				if (a.consume(), a.consumeSpaces(), r = a.fetch().text, !"lcr".includes(r)) throw new n("Expected l or c or r", a.nextToken);
		...
		var o = ui(e.parser, i, di(e.envName)), s = Math.max(0, ...o.body.map((e) => e.length));
	...
	props: { numArgs: 0 },
	handler(e) {
		var t = ui(e.parser, { arraystretch: .5 }, "script");
	...
	handler(e, t) {
		...
		var i = {
			...
			hskipBeforeAndAfter: !1,
			arraystretch: .5
		}, a = ui(e.parser, i, "script");
		if (a.body.length > 0 && a.body[0].length > 1) throw new n("{subarray} can contain only one column");
		return a;
	},
	htmlBuilder: fi,
	mathmlBuilder: mi
	...
	handler(e) {
		...
		var t = {
			...
			autoTag: li(e.envName),
			emptySingleRow: !0,
			leqno: e.parser.settings.leqno
		};
		return ui(e.parser, t, "display");
	},
	htmlBuilder: fi,
	mathmlBuilder: mi
}), ni({
...
J({
	...
	handler(e, t) {
		var { parser: r, funcName: i } = e, a = t[0];
		if (a.type !== "ordgroup") throw new n("Invalid environment name", a);
		for (var o = "", s = 0; s < a.body.length; ++s) o += Q(a.body[s], "textord").text;
		if (i === "\\begin") {
			if (!gi.hasOwnProperty(o)) throw new n("No such environment: " + o, a);
			var c = gi[o], { args: l, optArgs: u } = r.parseArguments("\\begin{" + o + "}", c), d = {
				mode: r.mode,
				envName: o,
				parser: r
			}, f = c.handler(d, l, u);
			...
			if (m.name !== o) throw new n("Mismatch: \\begin{" + o + "} matched by \\end{" + m.name + "}", p);
			return f;
		}
		return {
			type: "environment",
...
var bi = (e, t) => {
	...
	e.hasBarLine ? (e.barSize ? (d = k(e.barSize, t), u = Ht("frac-line", t, d)) : u = Ht("frac-line", t), d = u.height, f = u.height) : (u = null, d = 0, f = t.fontMetrics().defaultRuleThickness);
	var p, m, h;
	...
	if (!e.hasBarLine) n.setAttribute("linethickness", "0px");
		...
		var r = k(e.barSize, t);
		n.setAttribute("linethickness", A(r));
	}
	if (e.leftDelim != null || e.rightDelim != null) {
		var i = [];
		if (e.leftDelim != null) {
			var a = new X("mo", [new Sn(e.leftDelim.replace("\\", ""))]);
			a.setAttribute("fence", "true"), i.push(a);
		}
		if (i.push(n), e.rightDelim != null) {
			var o = new X("mo", [new Sn(e.rightDelim.replace("\\", ""))]);
...
J({
	...
	handler: (e, t) => {
		...
		return l || r.startsWith("\\d") ? u = "display" : r.startsWith("\\t") && (u = "text"), Si({
			type: "genfrac",
			mode: n.mode,
			numer: i,
			denom: a,
...
J({
	...
	handler(e, t) {
		var { parser: n } = e, r = t[4], i = t[5], a = sn(t[0]), o = a.type === "atom" && a.family === "open" ? wi(a.text) : null, s = sn(t[1]), c = s.type === "atom" && s.family === "close" ? wi(s.text) : null, l = Q(t[2], "size"), u, d = null;
		...
		} else p = Q(p, "textord"), f = Ci[Number(p.text)];
		return Si({
			type: "genfrac",
			mode: n.mode,
			numer: r,
...
var Ti = (e, t) => {
	...
	var a = Y(i.base, t.havingBaseStyle(D.DISPLAY)), o = Kn(i, t), s = i.isOver ? K({
		positionType: "firstBaseline",
		children: [
			{
				type: "elem",
...
J({
	...
	htmlBuilder(e, t) {
		return Wt(pn(e.body, t.withFont(""), !1));
	},
	mathmlBuilder(e, t) {
		return new X("mrow", jn(e.body, t.withFont("")));
	}
}), J({
	type: "html",
	names: [
	...
	handler: (e, t) => {
		var { parser: r, funcName: i, token: a } = e, o = Q(t[0], "raw").string, s = t[1];
		...
		switch (i) {
			...
			case "\\htmlData":
				for (var u = o.split(","), d = 0; d < u.length; d++) {
					...
					if (p < 0) throw new n("\\htmlData key/value '" + f + "' missing equals sign");
	...
	htmlBuilder: (e, t) => {
		var n = pn(e.body, t, !1), r = ["enclosing"];
	...
	htmlBuilder: (e, t) => Wt(pn(e.html, t, !1)),
	mathmlBuilder: (e, t) => Mn(e.mathml, t)
});
var Ei = function(e) {
	...
	if (!Ee(r)) throw new n("Invalid unit: '" + r.unit + "' in \\includegraphics.");
	return r;
};
J({
			...
			if (d.length === 2) {
				...
				switch (d[0].trim()) {
					...
					case "totalheight":
						s = Ei(f);
						break;
					default: throw new n("Invalid key: '" + d[0] + "' in \\includegraphics.");
				}
			}
		}
		var p = Q(t[0], "url").url;
	...
	htmlBuilder: (e, t) => {
		var n = k(e.height, t), r = 0;
		e.totalheight.number > 0 && (r = k(e.totalheight, t) - n);
		var i = 0;
		e.width.number > 0 && (i = k(e.width, t));
		var a = { height: A(n + r) };
		i > 0 && (a.width = A(i)), r > 0 && (a.verticalAlign = A(-r));
	...
	mathmlBuilder: (e, t) => {
		...
		var r = k(e.height, t), i = 0;
		if (e.totalheight.number > 0 && (i = k(e.totalheight, t) - r, n.setAttribute("valign", A(-i))), n.setAttribute("height", A(r + i)), e.width.number > 0) {
			var a = k(e.width, t);
			n.setAttribute("width", A(a));
		}
	...
	htmlBuilder: (e, t) => {
		var n;
		e.alignment === "clap" ? (n = G([], [Y(e.body, t)]), n = G(["inner"], [n], t)) : n = G(["inner"], [Y(e.body, t)]);
		var r = G(["fix"], []), i = G([e.alignment], [n, r], t), a = G(["strut"]);
		return a.style.height = A(i.height + i.depth), i.depth && (a.style.verticalAlign = A(-i.depth)), i.children.unshift(a), i = G(["thinbox"], [i], t), G(["mord", "vbox"], [i], t);
	},
	mathmlBuilder: (e, t) => {
...
J({
	...
	htmlBuilder: (e, t) => Wt(pn(Di(e, t), t, !1)),
	mathmlBuilder: (e, t) => Mn(Di(e, t), t)
});
var Oi = (e, t, n, r, i, a, o) => {
	e = G([], [e]);
	var s = n && u(n), c, l;
	if (t) {
	...
	if (c && a !== 0 && !s) {
		var h = G(["mspace"], [], r);
		h.style.marginRight = A(a), m.unshift(h);
	}
	return G(["mop", "op-limits"], m, r);
}, ki = /* @__PURE__ */ new Set(["\\smallint"]), Ai = (e, t) => {
	var n, r, i = !1, a;
	e.type === "supsub" ? (n = e.sup, r = e.sub, a = Q(e.base, "op"), i = !0) : a = Q(e, "op");
	var o = t.style, s = !1;
	o.size === D.DISPLAY.size && a.symbol && !ki.has(a.name) && (s = !0);
	var c, l;
	if (a.symbol) {
		...
		var p = pn(a.body, t, !0);
		p.length === 1 && p[0] instanceof Le ? (c = p[0], c.classes[0] = "mop") : c = G(["mop"], p, t);
	} else {
		for (var m = [], h = 1; h < a.name.length; h++) m.push(Ft(a.name[h], a.mode, t));
		c = G(["mop"], m, t);
	}
	var g = 0, _ = 0;
	return (c instanceof Le || a.name === "\\oiint" || a.name === "\\oiiint") && !a.suppressBaseShift && (g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight, _ = c.italic ?? 0), i ? Oi(c, n, r, t, o, _, g) : (g && (c.style.position = "relative", c.style.top = A(g)), c);
}, ji = (e, t) => {
	var n;
	if (e.symbol) n = new X("mo", [En(e.name, e.mode)]), ki.has(e.name) && n.setAttribute("largeop", "false");
	else if (e.body) n = new X("mo", jn(e.body, t));
	else {
		n = new X("mi", [new Sn(e.name.slice(1))]);
		var r = new X("mo", [En("⁡", "text")]);
		n = e.parentIsSupSub ? new X("mrow", [n, r]) : xn([n, r]);
	}
	return n;
}, Mi = {
	"∏": "\\prod",
...
var Pi = (e, t) => {
	...
	return i ? Oi(o, n, r, t, t.style, 0, 0) : o;
};
J({
	type: "operatorname",
	...
	htmlBuilder: Pi,
	mathmlBuilder: (e, t) => {
		for (var n = jn(e.body, t.withFont("mathrm")), r = !0, i = 0; i < n.length; i++) {
			var a = n[i];
			if (!(a instanceof Cn)) {
				if (a instanceof X) switch (a.type) {
					...
					case "mo":
						var o = a.children[0];
						a.children.length === 1 && o instanceof Sn ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : r = !1;
						break;
					default: r = !1;
				}
				else r = !1;
		...
		r && (n = [new Sn(n.map((e) => e.toText()).join(""))]);
		var s = new X("mi", n);
		s.setAttribute("mathvariant", "normal");
		var c = new X("mo", [En("⁡", "text")]);
		return e.parentIsSupSub ? new X("mrow", [s, c]) : xn([s, c]);
	}
}), $("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"), on({
	type: "ordgroup",
	htmlBuilder(e, t) {
		return e.semisimple ? Wt(pn(e.body, t, !1)) : G(["mord"], pn(e.body, t, !0), t);
	},
	mathmlBuilder(e, t) {
		return Mn(e.body, t, !0);
	}
}), J({
	type: "overline",
	names: ["\\overline"],
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t.havingCrampedStyle()), r = Ht("overline-line", t), i = t.fontMetrics().defaultRuleThickness;
	...
	htmlBuilder: (e, t) => Wt(pn(e.body, t.withPhantom(), !1)),
	mathmlBuilder: (e, t) => new X("mphantom", jn(e.body, t))
}), $("\\hphantom", "\\smash{\\phantom{#1}}"), J({
	type: "vphantom",
	names: ["\\vphantom"],
	props: {
		numArgs: 1,
	...
	htmlBuilder: (e, t) => G(["mord", "rlap"], [G(["inner"], [Y(e.body, t.withPhantom())]), G(["fix"], [])], t),
	mathmlBuilder: (e, t) => {
		var n = new X("mpadded", [new X("mphantom", jn(cn(e.body), t))]);
		return n.setAttribute("width", "0px"), n;
	}
}), J({
	type: "raisebox",
	...
	htmlBuilder(e, t) {
		var n = G(["mord", "rule"], [], t), r = k(e.width, t), i = k(e.height, t), a = e.shift ? k(e.shift, t) : 0;
		return n.style.borderRightWidth = A(r), n.style.borderTopWidth = A(i), n.style.bottom = A(a), n.width = r, n.height = i + a, n.depth = -a, n.maxFontSize = i * 1.125 * t.sizeMultiplier, n;
	},
	mathmlBuilder(e, t) {
		var n = k(e.width, t), r = k(e.height, t), i = e.shift ? k(e.shift, t) : 0, a = t.color && t.getColor() || "black", o = new X("mspace");
		o.setAttribute("mathbackground", a), o.setAttribute("width", A(n)), o.setAttribute("height", A(r));
		var s = new X("mpadded", [o]);
		return i >= 0 ? s.setAttribute("height", A(i)) : (s.setAttribute("height", A(i)), s.setAttribute("depth", A(-i))), s.setAttribute("voffset", A(i)), s;
	}
});
function Fi(e, t, n) {
	for (var r = pn(e, t, !1), i = t.sizeMultiplier / n.sizeMultiplier, a = 0; a < r.length; a++) {
...
J({
	...
	mathmlBuilder: (e, t) => {
		var n = t.havingSize(e.size), r = new X("mstyle", jn(e.body, n));
		return r.setAttribute("mathsize", A(n.sizeMultiplier)), r;
	}
}), J({
	type: "smash",
	names: ["\\smash"],
	...
	htmlBuilder(e, t) {
		...
		var a = r + i / 4, { span: o, ruleWidth: s, advanceWidth: c } = Fr(n.height + n.depth + a + r, t), l = o.height - s;
		l > n.height + n.depth + a && (a = (a + l - n.height - n.depth) / 2);
		var u = o.height - n.height - a - s;
		n.style.paddingLeft = A(c);
		var d = K({
			positionType: "firstBaseline",
			children: [
				{
		...
		if (e.index) {
			var f = t.havingStyle(D.SCRIPTSCRIPT), p = Y(e.index, f, t);
...
J({
	...
	handler(e, t) {
		...
		if (!Ri(o)) throw Error("Unknown style: " + o);
		return {
			type: "styling",
			mode: i.mode,
			style: o,
	...
	htmlBuilder(e, t) {
		var n = Li[e.style], r = t.havingStyle(n);
		return e.resetFont && (r = r.withFont("")), Fi(e.body, r, t);
	},
	mathmlBuilder(e, t) {
		var n = Li[e.style], r = t.havingStyle(n);
		e.resetFont && (r = r.withFont(""));
		var i = new X("mstyle", jn(e.body, r)), a = {
			display: ["0", "true"],
			text: ["0", "false"],
			script: ["1", "false"],
...
var zi = function(e, t) {
	var n = e.base;
	return n ? n.type === "op" ? n.limits && (t.style.size === D.DISPLAY.size || n.alwaysHandleSupSub) ? Ai : null : n.type === "operatorname" ? n.alwaysHandleSupSub && (t.style.size === D.DISPLAY.size || n.limits) ? Pi : null : n.type === "accent" ? u(n.base) ? er : null : n.type === "horizBrace" && !e.sub === n.isOver ? Ti : null : null;
};
on({
	type: "supsub",
	htmlBuilder(e, t) {
		var n = zi(e, t);
		if (n) return n(e, t);
		var { base: r, sup: i, sub: a } = e, o = Y(r, t), s, c, l = t.fontMetrics(), d = 0, f = 0, p = r && u(r);
		if (i) {
		...
		if (a) {
			...
			c = Y(a, h, t), p || (f = o.depth + h.fontMetrics().subDrop * h.sizeMultiplier / t.sizeMultiplier);
		}
		var g = t.style === D.DISPLAY ? l.sup1 : t.style.cramped ? l.sup3 : l.sup2, _ = t.sizeMultiplier, v = A(.5 / l.ptPerEm / _), y = null;
		if (c) {
			var b = e.base && e.base.type === "op" && e.base.name && (e.base.name === "\\oiint" || e.base.name === "\\oiiint");
			(o instanceof Le || b) && (y = A(-(o.italic ?? 0)));
		}
		var x;
		if (s && c) {
			d = Math.max(d, g, s.depth + .25 * l.xHeight), f = Math.max(f, l.sub2);
			var S = 4 * l.defaultRuleThickness;
			if (d - s.depth - (c.height - f) < S) {
				f = S - (d - s.depth) + c.height;
				var C = .8 * l.xHeight - (d - s.depth);
				C > 0 && (d += C, f -= C);
			}
			x = K({
				positionType: "individualShift",
		...
		} else if (c) f = Math.max(f, l.sub1, c.height - .8 * l.xHeight), x = K({
			positionType: "shift",
			positionData: f,
			children: [{
				type: "elem",
		...
		else if (s) d = Math.max(d, g, s.depth + .25 * l.xHeight), x = K({
			positionType: "shift",
			positionData: -d,
			children: [{
				type: "elem",
		...
		return G([_n(o, "right") || "mord"], [o, G(["msupsub"], [x])], t);
	},
	mathmlBuilder(e, t) {
		var n = !1, r, i;
	...
	mathmlBuilder(e, t) {
		var n = new X("mo", [En(e.text, e.mode)]);
		if (e.family === "bin") {
			var r = kn(e, t);
...
on({
	...
	mathmlBuilder(e, t) {
		var n = new X("mi", [En(e.text, e.mode, t)]), r = kn(e, t) || "italic";
		return r !== Bi[n.type] && n.setAttribute("mathvariant", r), n;
	}
}), on({
	type: "textord",
	htmlBuilder(e, t) {
	...
	mathmlBuilder(e, t) {
		var n = En(e.text, e.mode, t), r = kn(e, t) || "normal", i = e.mode === "text" ? new X("mtext", [n]) : /[0-9]/.test(e.text) ? new X("mn", [n]) : e.text === "\\prime" ? new X("mo", [n]) : new X("mi", [n]);
		return r !== Bi[i.type] && i.setAttribute("mathvariant", r), i;
	}
});
var Vi = {
	"\\nobreak": "nobreak",
...
on({
	type: "spacing",
	htmlBuilder(e, t) {
		if (Hi.hasOwnProperty(e.text)) {
			var r = Hi[e.text].className || "";
			if (e.mode === "text") {
				var i = Lt(e, t, "textord");
				return i.classes.push(r), i;
			}
			return G(["mspace", r], [Ft(e.text, e.mode, t)], t);
		}
		if (Vi.hasOwnProperty(e.text)) return G(["mspace", Vi[e.text]], [], t);
		throw new n("Unknown type of space \"" + e.text + "\"");
	},
	mathmlBuilder(e, t) {
		var r;
		if (Hi.hasOwnProperty(e.text)) r = new X("mtext", [new Sn("\xA0")]);
		else if (Vi.hasOwnProperty(e.text)) return new X("mspace");
		else throw new n("Unknown type of space \"" + e.text + "\"");
		return r;
	}
});
var Ui = () => {
...
on({
	...
	mathmlBuilder(e, t) {
		var n = new X("mtable", [new X("mtr", [
			Ui(),
			new X("mtd", [Mn(e.body, t)]),
			Ui(),
			new X("mtd", [Mn(e.tag, t)])
		])]);
...
var Wi = {
	...
	var n = e.font;
	return n ? Wi[n] ? t.withTextFontFamily(Wi[n]) : Gi[n] ? t.withTextFontWeight(Gi[n]) : n === "\\emph" ? t.fontShape === "textit" ? t.withTextFontShape("textup") : t.withTextFontShape("textit") : t.withTextFontShape(Ki[n]) : t;
};
J({
	type: "text",
	names: [
	...
	htmlBuilder(e, t) {
		var n = qi(e, t);
		return G(["mord", "text"], pn(e.body, n, !0), n);
	},
	mathmlBuilder(e, t) {
		var n = qi(e, t);
		return Mn(e.body, n);
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t), r = Ht("underline-line", t), i = t.fontMetrics().defaultRuleThickness;
	...
	htmlBuilder(e, t) {
		for (var n = Ji(e), r = [], i = t.havingStyle(t.style.text()), a = 0; a < n.length; a++) {
			var o = n[a];
			o === "~" && (o = "\\textasciitilde"), r.push(Pt(o, "Typewriter-Regular", e.mode, i, ["mord", "texttt"]));
		}
		return G(["mord", "text"].concat(i.sizingClasses(t)), zt(r), i);
	},
	mathmlBuilder(e, t) {
		var n = new X("mtext", [new Sn(Ji(e))]);
		return n.setAttribute("mathvariant", "monospace"), n;
	}
});
var Ji = (e) => e.body.replace(/ /g, e.star ? "␣" : "\xA0"), Yi = nn, Xi = "[ \r\n	]", Zi = "\\\\[a-zA-Z@]+", Qi = "\\\\[^\ud800-\udfff]", $i = "(" + Zi + ")" + Xi + "*", ea = "\\\\(\n|[ \r	]+\n?)[ \r	]*", ta = "[̀-ͯ]", na = RegExp(ta + "+$"), ra = "(" + Xi + "+)|" + (ea + "|") + "([!-\\[\\]-‧‪-퟿豈-￿]" + (ta + "*") + "|[\ud800-\udbff][\udc00-\udfff]" + (ta + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + $i) + ("|" + Qi + ")"), ia = class {
	constructor(e, t) {
		this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = new RegExp(ra, "g"), this.catcodes = {
			"%": 14,
			"~": 13
		};
	}
	...
	lex() {
		...
		if (t === e.length) return new ai("EOF", new ii(this, t, t));
		var r = this.tokenRegex.exec(e);
		if (r === null || r.index !== t) throw new n("Unexpected character: '" + e[t] + "'", new ai(e[t], new ii(this, t, t + 1)));
		var i = r[6] || r[3] || (r[2] ? "\\ " : " ");
		...
		return new ai(i, new ii(this, t, this.tokenRegex.lastIndex));
	}
}, aa = class {
	constructor(e, t) {
...
$("\\char", function(e) {
	var t = e.popToken(), r, i = 0;
	if (t.text === "'") r = 8, t = e.popToken();
	else if (t.text === "\"") r = 16, t = e.popToken();
	else if (t.text === "`") {
		if (t = e.popToken(), t.text[0] === "\\") i = t.text.charCodeAt(1);
		else if (t.text === "EOF") throw new n("\\char` missing argument");
		else i = t.text.charCodeAt(0);
	} else r = 10;
	if (r) {
		if (i = sa[t.text], i == null || i >= r) throw new n("Invalid base-" + r + " digit " + t.text);
		for (var a; (a = sa[e.future().text]) != null && a < r;) i *= r, i += a, e.popToken();
	}
	return "\\@char{" + i + "}";
});
var ca = (e, t, r, i) => {
	var a = e.consumeArg().tokens;
	if (a.length !== 1) throw new n("\\newcommand's first argument must be a macro name");
	var o = a[0].text, s = e.isDefined(o);
	if (s && !t) throw new n("\\newcommand{" + o + "} attempting to redefine " + (o + "; use \\renewcommand"));
	if (!s && !r) throw new n("\\renewcommand{" + o + "} when command " + o + " does not yet exist; use \\newcommand");
	var c = 0;
	...
	return s && i || e.macros.set(o, {
		tokens: a,
		numArgs: c
	}), "";
};
$("\\newcommand", (e) => ca(e, !1, !0, !1)), $("\\renewcommand", (e) => ca(e, !0, !1, !1)), $("\\providecommand", (e) => ca(e, !0, !0, !0)), $("\\message", (e) => {
	...
	return console.log(t, e.macros.get(n), Yi[n], j.math[n], j.text[n]), "";
...
var la = {
	...
	"\\idotsint": "\\dotsi",
	"\\DOTSX": "\\dotsx"
}, ua = /* @__PURE__ */ new Set(["bin", "rel"]);
$("\\dots", function(e) {
	var t = "\\dotso", n = e.expandAfterFuture().text;
	return n in la ? t = la[n] : (n.slice(0, 4) === "\\not" || n in j.math && ua.has(j.math[n].group)) && (t = "\\dotsb"), t;
});
var da = {
	")": !0,
	"]": !0,
...
var ma = {
	...
	constructor(e, t, n) {
		this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new aa(oa, t.macros), this.mode = n, this.stack = [];
	}
	feed(e) {
	...
	scanArgument(e) {
		...
		return this.pushToken(new ai("EOF", n.loc)), this.pushTokens(r), new ai("", ii.range(t, n));
	}
	consumeSpaces() {
	...
	consumeArg(e) {
		...
		do {
			if (a = this.popToken(), t.push(a), a.text === "{") ++o;
				...
				if (--o, o === -1) throw new n("Extra }", a);
			} else if (a.text === "EOF") throw new n("Unexpected end of input in a macro argument, expected '" + (e && r ? e[s] : "}") + "'", a);
			if (e && r) {
	...
	consumeArgs(e, t) {
		if (t) {
			...
			for (var r = t[0], i = 0; i < r.length; i++) {
				var a = this.popToken();
				if (r[i] !== a.text) throw new n("Use of the macro doesn't match its definition", a);
			}
		}
	...
	expandOnce(e) {
		...
		if (i == null || e && i.unexpandable) {
			if (e && i == null && r[0] === "\\" && !this.isDefined(r)) throw new n("Undefined control sequence: " + r);
		...
		if (i.numArgs) {
			...
			for (var s = a.length - 1; s >= 0; --s) {
				var c = a[s];
				if (c.text === "#") {
					if (s === 0) throw new n("Incomplete placeholder at end of macro body", c);
					if (c = a[--s], c.text === "#") a.splice(s + 1, 1);
					else if (/^[1-9]$/.test(c.text)) a.splice(s, 2, ...o[c.text - 1]);
					else throw new n("Not a valid argument number", c);
				}
			}
		}
	...
	expandMacro(e) {
		return this.macros.has(e) ? this.expandTokens([new ai(e)]) : void 0;
	}
	expandTokens(e) {
	...
	_getExpansion(e) {
		...
		if (typeof r == "string") {
			...
			for (var o = new ia(r, this.settings), s = [], c = o.lex(); c.text !== "EOF";) s.push(c), c = o.lex();
			return s.reverse(), {
				tokens: s,
				numArgs: i
			};
	...
	isDefined(e) {
		return this.macros.has(e) || Yi.hasOwnProperty(e) || j.math.hasOwnProperty(e) || j.text.hasOwnProperty(e) || ma.hasOwnProperty(e);
	}
	isExpandable(e) {
		var t = this.macros.get(e);
		return t == null ? Yi.hasOwnProperty(e) && !Yi[e].primitive : typeof t == "string" || typeof t == "function" || !t.unexpandable;
	}
}, ga = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, _a = Object.freeze({
	"₊": "+",
	"₋": "-",
	"₌": "=",
	"₍": "(",
	...
	constructor(e, t) {
		this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new ha(e, t, this.mode), this.settings = t, this.leftrightDepth = 0, this.nextToken = null;
	}
	expect(e, t) {
		if (t === void 0 && (t = !0), this.fetch().text !== e) throw new n("Expected '" + e + "', got '" + this.fetch().text + "'", this.fetch());
		t && this.consume();
	}
	consume() {
		this.nextToken = null;
	...
	subparse(e) {
		...
		this.consume(), this.gullet.pushToken(new ai("}")), this.gullet.pushTokens(e);
	...
	parseExpression(t, n) {
		for (var r = [];;) {
			...
			var i = this.fetch();
			if (e.endOfExpression.has(i.text) || n && i.text === n || t && Yi[i.text] && Yi[i.text].infix) break;
	...
	handleInfixNodes(e) {
		for (var t = -1, r, i = 0; i < e.length; i++) {
			var a = e[i];
			if (a.type === "infix") {
				if (t !== -1) throw new n("only one infix operator per group", a.token);
				t = i, r = a.replaceWith;
			}
		}
		if (t !== -1 && r) {
	...
	handleSupSubscript(e) {
		...
		if (!i) throw new n("Expected group after '" + r + "'", t);
		return i;
	}
	...
	parseAtom(e) {
		...
		for (var r, i;;) {
			...
			if (a.text === "\\limits" || a.text === "\\nolimits") {
				if (t && t.type === "op") t.limits = a.text === "\\limits", t.alwaysHandleSupSub = !0;
				else if (t && t.type === "operatorname") t.alwaysHandleSupSub && (t.limits = a.text === "\\limits");
				else throw new n("Limit controls must follow a math operator", a);
				this.consume();
			} else if (a.text === "^") {
				if (r) throw new n("Double superscript", a);
				r = this.handleSupSubscript("superscript");
			} else if (a.text === "_") {
				if (i) throw new n("Double subscript", a);
				...
				var c = ga.test(a.text), l = [];
				for (l.push(new ai(_a[a.text])), this.consume();;) {
					var u = this.fetch().text;
					if (!_a[u] || ga.test(u) !== c) break;
					l.unshift(new ai(_a[u])), this.consume();
				}
	...
	parseFunction(e, t) {
		var r = this.fetch(), i = r.text, a = Yi[i];
		if (!a) return null;
		if (this.consume(), t && t !== "atom" && !a.allowedInArgument) throw new n("Got function '" + i + "' with no arguments" + (t ? " as " + t : ""), r);
		if (this.mode === "text" && !a.allowedInText) throw new n("Can't use function '" + i + "' in text mode", r);
		if (this.mode === "math" && a.allowedInMath === !1) throw new n("Can't use function '" + i + "' in math mode", r);
		var { args: o, optArgs: s } = this.parseArguments(i, a);
		return this.callFunction(i, o, s, r, e);
	}
	callFunction(e, t, r, i, a) {
		var o = {
			funcName: e,
			parser: this,
			token: i,
	...
	parseArguments(e, t) {
		...
		for (var i = [], a = [], o = 0; o < r; o++) {
			var s = t.argTypes && t.argTypes[o], c = o < t.numOptionalArgs;
	...
	parseGroupOfType(e, t, r) {
		switch (t) {
			...
			case "primitive":
				...
				if (o == null) throw new n("Expected group as " + e, this.fetch());
				return o;
			case "original":
			case null:
	...
	parseRegexGroup(e, t) {
		for (var r = this.fetch(), i = r, a = "", o; (o = this.fetch()).text !== "EOF" && e.test(a + o.text);) i = o, a += i.text, this.consume();
		if (a === "") throw new n("Invalid " + t + ": '" + r.text + "'", r);
		return r.range(i, a);
	}
	parseColorGroup(e) {
	...
	parseSizeGroup(e) {
		...
		if (!i) throw new n("Invalid size: '" + t.text + "'", t);
		var a = {
			number: +(i[1] + i[2]),
			unit: i[3]
		};
		if (!Ee(a)) throw new n("Invalid unit: '" + a.unit + "'", t);
		return {
			type: "size",
			mode: this.mode,
			value: a,
	...
	parseGroup(e, t) {
		...
		} else if (a = this.parseFunction(t, e) || this.parseSymbol(), a == null && i[0] === "\\" && !ma.hasOwnProperty(i)) {
			if (this.settings.throwOnError) throw new n("Undefined control sequence: " + i, r);
	...
	parseSymbol() {
		...
		if (/^\\verb[^a-zA-Z]/.test(t)) {
			...
			if (i && (r = r.slice(1)), r.length < 2 || r.charAt(0) !== r.slice(-1)) throw new n("\\verb assertion failed --\n                    please report what input caused this bug");
		...
		ya.hasOwnProperty(t[0]) && !j[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Accented Unicode text character \"" + t[0] + "\" used in math mode", e), t = ya[t[0]] + t.slice(1));
		var a = na.exec(t);
		a && (t = t.substring(0, a.index), t === "i" ? t = "ı" : t === "j" && (t = "ȷ"));
		var o;
		if (j[this.mode][t]) {
			this.settings.strict && this.mode === "math" && ht.includes(t) && this.settings.reportNonstrict("unicodeTextInMathMode", "Latin-1/Unicode text character \"" + t[0] + "\" used in math mode", e);
			var s = j[this.mode][t].group, c = ii.range(e);
			o = Xn(s) ? {
				type: "atom",
				mode: this.mode,
				family: s,
		...
		} else if (t.charCodeAt(0) >= 128) this.settings.strict && (le(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Unicode text character \"" + t[0] + "\" used in math mode", e) : this.settings.reportNonstrict("unknownSymbol", "Unrecognized Unicode character \"" + t[0] + "\"" + (" (" + t.charCodeAt(0) + ")"), e)), o = {
			type: "textord",
			mode: "text",
			loc: ii.range(e),
			text: t
		...
		if (this.consume(), a) for (var l = 0; l < a[0].length; l++) {
			var u = a[0][l];
			if (!va[u]) throw new n("Unknown accent ' " + u + "'", e);
...
ba.endOfExpression = /* @__PURE__ */ new Set([
	"}",
	"\\endgroup",
	"\\end",
	"\\right",
...
typeof document < "u" && document.compatMode !== "CSS1Compat" && (typeof console < "u" && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), Sa = function() {
