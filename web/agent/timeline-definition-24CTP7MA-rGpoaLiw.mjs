...
import { J as i, a, b as o, et as s, o as c, rt as l, tt as u, x as d } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { t as f } from "./arc-BMQtrKqw.mjs";
import { p } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { f as m } from "./mermaid.core-DuekSTCI.mjs";
		...
		performAction: /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
			...
			switch (i) {
				...
				case 18:
					...
					break;
				case 19: r.addEvent(a[s].substr(2)), this.$ = a[s];
			}
		}, "anonymous"),
		table: [
			{
...
var v = "", y = 0, b = "LR", x = [], S = [], C = [], w = /* @__PURE__ */ e(() => c, "getCommonDb"), T = /* @__PURE__ */ e(function() {
	x.length = 0, S.length = 0, v = "", C.length = 0, b = "LR", a();
...
}, "drawRect"), te = /* @__PURE__ */ e(function(t, n) {
	...
	i.append("circle").attr("cx", n.cx - 5).attr("cy", n.cy - 5).attr("r", 1.5).attr("stroke-width", 2).attr("fill", "#666").attr("stroke", "#666"), i.append("circle").attr("cx", n.cx + 5).attr("cy", n.cy - 5).attr("r", 1.5).attr("stroke-width", 2).attr("fill", "#666").attr("stroke", "#666");
	function a(e) {
...
}, "drawFace"), ne = /* @__PURE__ */ e(function(e, t) {
...
}, "drawCircle"), L = /* @__PURE__ */ e(function(e, t) {
...
}, "drawText"), re = /* @__PURE__ */ e(function(t, n) {
	function r(e, t, n, r, i) {
		return e + "," + t + " " + (e + n) + "," + t + " " + (e + n) + "," + (t + r - i) + " " + (e + n - i * 1.2) + "," + (t + r) + " " + e + "," + (t + r);
	}
	e(r, "genPoints");
	let i = t.append("polygon");
	i.attr("points", r(n.x, n.y, 50, 20, 7)), i.attr("class", "labelBox"), n.y += n.labelMargin, n.x += .5 * n.labelMargin, L(t, n);
}, "drawLabel"), R = /* @__PURE__ */ e(function(e, t, n) {
...
}, "drawSection"), z = -1, ie = /* @__PURE__ */ e(function(e, t, n, r) {
...
}, "drawTask"), ae = /* @__PURE__ */ e(function(e, t) {
	I(e, {
		x: t.startx,
		y: t.starty,
...
}, "drawBackgroundRect"), oe = /* @__PURE__ */ e(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), B = /* @__PURE__ */ e(function() {
	return {
		x: 0,
		y: 0,
		width: 100,
...
e(H, "wrap");
var ce = /* @__PURE__ */ e(function(e, t, n, i, a, o = !1) {
	...
	if (t.height = m.height + h * 1.1 * .5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width += 2 * t.padding, p.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), l && p.attr("transform", `translate(${t.width / 2}, ${o ? t.padding / 2 + 3 : t.padding})`), ue(f, t, u, a, i), c === "neo" && (d.attr("data-look", "neo"), l)) {
		let t = s.includes("dark"), n = e.node()?.ownerSVGElement ?? e.node(), i = r(n), a = i.attr("id") ?? "", o = a ? `${a}-drop-shadow` : "drop-shadow";
		if (i.select(`#${o}`).empty()) {
			let e = i.select("defs");
			(e.empty() ? i.append("defs") : e).append("filter").attr("id", o).attr("height", "130%").attr("width", "130%").append("feDropShadow").attr("dx", "4").attr("dy", "4").attr("stdDeviation", 0).attr("flood-opacity", t ? "0.2" : "0.06").attr("flood-color", t ? "#FFFFFF" : "#000000");
		}
	}
	return t;
}, "drawNode"), le = /* @__PURE__ */ e(function(e, t, n) {
...
}, "getVirtualNodeHeight"), ue = /* @__PURE__ */ e(function(e, t, n, r, i) {
	...
	x.forEach(function(e) {
		let t = {
			...
			padding: 20,
			maxHeight: S
		}, r = U.getVirtualNodeHeight(v, t, s);
		n.debug("sectionHeight before draw", r), S = Math.max(S, r + 20);
	});
	let A = 0, j = 0;
	n.debug("tasks.length", y.length);
	for (let [e, t] of y.entries()) {
		...
		n.debug("taskHeight before draw", i), C = Math.max(C, i + 20), A = Math.max(A, t.events.length);
		let a = 0;
		for (let e of t.events) {
			...
			a += U.getVirtualNodeHeight(v, n, s);
		}
		t.events.length > 0 && (a += (t.events.length - 1) * 10), j = Math.max(j, a);
	}
	n.debug("maxSectionHeight before draw", S), n.debug("maxTaskHeight before draw", C), x && x.length > 0 ? x.forEach((e) => {
		let r = y.filter((t) => t.section === e), i = {
			number: O,
			descr: e,
			section: O,
		...
		n.debug("sectionNode", i);
		let a = v.append("g"), o = U.drawNode(a, i, O, s, t);
		n.debug("sectionNode output", o), a.attr("transform", `translate(${E}, ${T})`), D += S + 50, r.length > 0 && W(v, r, O, E, D, C, s, A, j, S, !1, t), E += 200 * Math.max(r.length, 1), D = T, O++;
	}) : (k = !1, W(v, y, O, E, D, C, s, A, j, S, !0, t));
	let M = v.node().getBBox();
	if (n.debug("bounds", M), b && v.append("text").text(b).attr("x", c === "neo" ? M.x * 2 + h : M.width / 2 - h).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), w = k ? S + C + 150 : C + 100, v.append("g").attr("class", "lineWrapper").append("line").attr("x1", h).attr("y1", w).attr("x2", M.width + 3 * h).attr("y2", w).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", `url(#${t}-arrowhead)`), c === "neo" && f && l !== "neutral") {
	...
	i(void 0, v, s.timeline?.padding ?? 50, s.timeline?.useMaxWidth ?? !1);
}, "draw"), W = /* @__PURE__ */ e(function(e, t, r, i, a, o, s, c, l, u, d, f) {
	for (let c of t) {
		let t = {
			descr: c.task,
			section: r,
		...
		n.debug("taskNode", t);
		let u = e.append("g").attr("class", "taskWrapper"), p = U.drawNode(u, t, r, s, f).height;
		if (n.debug("taskHeight after draw", p), u.attr("transform", `translate(${i}, ${a})`), o = Math.max(o, p), c.events) {
			let t = e.append("g").attr("class", "lineWrapper"), n = o;
			a += 100, n += fe(e, c.events, r, i, a, s, f), a -= 100, t.append("line").attr("x1", i + 95).attr("y1", a + o).attr("x2", i + 95).attr("y2", a + o + 100 + l + 100).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", `url(#${f}-arrowhead)`).attr("stroke-dasharray", "5,5");
		}
		i += 200, d && !s.timeline?.disableMulticolor && r++;
	}
	a -= 10;
}, "drawTasks"), fe = /* @__PURE__ */ e(function(e, t, r, i, a, o, s) {
	let c = 0, l = a;
	a += 100;
	for (let l of t) {
		let t = {
		...
		n.debug("eventNode", t);
		let u = e.append("g").attr("class", "eventWrapper"), d = U.drawNode(u, t, r, o, s, !0).height;
	...
	draw: de
}, G = 200, K = 5, me = G + K * 2, q = G + 100, he = q + K * 2, J = 10, ge = 0, Y = 20, X = 20, Z = 30, Q = 50, _e = /* @__PURE__ */ e(function(e, t, r, a) {
	let o = d(), s = o.timeline?.leftMargin ?? 50;
	n.debug("timeline", a.db);
	let c = m(t);
	c.append("g");
	let l = a.db.getTasks(), u = a.db.getCommonDb().getDiagramTitle();
	n.debug("task", l), U.initGraphics(c);
	...
	f.forEach(function(e) {
		let t = {
			...
			padding: K,
			maxHeight: h
		}, r = U.getVirtualNodeHeight(c, t, o);
		n.debug("sectionHeight before draw", r), h = Math.max(h, r);
	});
	let O = 0;
	n.debug("tasks.length", l.length);
	for (let [e, t] of l.entries()) {
		...
		n.debug("taskHeight before draw", i), g = Math.max(g, i);
		let a = 0;
		for (let e of t.events) {
			let n = {
				descr: e,
			...
			a += U.getVirtualNodeHeight(c, n, o);
		}
		t.events.length > 0 && (a += (t.events.length - 1) * J), O = Math.max(O, a) + ge;
	}
	n.debug("maxSectionHeight before draw", h), n.debug("maxTaskHeight before draw", g);
	let k = Math.max(g, O) + Z;
	T ? f.forEach((e) => {
		let t = l.filter((t) => t.section === e), r = {
			number: w,
			descr: e,
			section: w,
			width: D,
		...
		n.debug("sectionNode output", a);
		let s = E - x;
		i.attr("transform", `translate(${s}, ${v})`);
		let u = v + a.height + Y;
		t.length > 0 && $(c, t, w, E, u, g, o, k, !1);
		let d = t.length, f = a.height + Y + k * Math.max(d, 1) - (d > 0 ? Z * 2 : 0);
		v += f, w++;
	}) : $(c, l, w, E, v, g, o, k, !0);
	let A = c.node()?.getBBox();
	if (!A) throw Error("bbox not found");
	if (n.debug("bounds", A), u) {
		...
		n.debug("bounds after title", A);
	}
	let [j] = p(o.fontSize), M = (j ?? 16) * 2, N = (j ?? 16) * .5 + 20, P = c.append("g").attr("class", "lineWrapper");
	P.append("line").attr("x1", E).attr("y1", y - M).attr("x2", E).attr("y2", A.y + A.height + N).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), P.lower(), i(void 0, c, o.timeline?.padding ?? 50, o.timeline?.useMaxWidth ?? !1);
}, "draw"), $ = /* @__PURE__ */ e(function(e, t, r, i, a, o, s, c, l) {
	for (let u of t) {
		let t = {
			descr: u.task,
			section: r,
		...
		n.debug("taskNode", t);
		let d = e.append("g").attr("class", "taskWrapper"), f = U.drawNode(d, t, r, s), p = f.height;
		n.debug("taskHeight after draw", p);
		let m = i - X - f.width;
		if (d.attr("transform", `translate(${m}, ${a})`), o = Math.max(o, p), u.events && u.events.length > 0) {
			let t = a, n = i + Q;
			ve(e, u.events, r, i, n, t, s);
		}
		a += c, l && !s.timeline?.disableMulticolor && r++;
	}
}, "drawTasks"), ve = /* @__PURE__ */ e(function(e, t, r, i, a, o, s) {
	let c = o;
	for (let o of t) {
		let t = {
			descr: o,
		...
		n.debug("eventNode", t);
		let l = e.append("g").attr("class", "eventWrapper"), u = U.drawNode(l, t, r, s).height;
	...
	let { theme: t } = o(), n = t?.includes("dark"), r = t?.includes("color"), i = e.svgId?.replace(/^#/, "") ?? "", a = i ? `url(#${i}-drop-shadow)` : e.dropShadow ?? "none", s = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) {
		let i = `${17 - 3 * t}`, o = r ? e.borderColorArray[t] : e.mainBkg, c = r ? e.borderColorArray[t] : e.nodeBorder;
		s += `
    .section-${t - 1} rect,
    .section-${t - 1} path,
    .section-${t - 1} circle {
      fill: ${n && r ? e.mainBkg : o};
      stroke: ${c};
	...
	let t = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t], l(e["lineColor" + t]) ? e["lineColor" + t] = u(e["lineColor" + t], 20) : e["lineColor" + t] = s(e["lineColor" + t], 20);
	...
	renderer: {
		setConf: /* @__PURE__ */ e(() => {}, "setConf"),
		draw: /* @__PURE__ */ e((e, t, n, r) => (r?.db?.getDirection?.() ?? "LR") === "TD" ? ye.draw(e, t, n, r) : pe.draw(e, t, n, r), "draw")
	},
	parser: g,
	styles: /* @__PURE__ */ e((e) => {
		let { theme: t } = o(), n = t?.includes("redux"), r = t === "neutral", i = e.svgId?.replace(/^#/, "") ?? "", a = "";
