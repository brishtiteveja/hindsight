...
import { H as r, K as i, U as a, a as o, b as s, c, f as l, v as u, w as d, y as f, z as p } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { i as m } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { t as h } from "./chunk-JWPE2WC7-DIKiF5cm.mjs";
import { r as g, t as _ } from "./chunk-PWAF6VOD-CPL-Te_E.mjs";
import { t as v } from "./chunk-2Q5K7J3B-BDbtAK2d.mjs";
import { f as y } from "./mermaid.core-DuekSTCI.mjs";
...
var j = new v(() => ({
	...
	j.reset(), o();
}, "clear"), N = /* @__PURE__ */ t(() => j.records.stack[0], "getRoot"), P = /* @__PURE__ */ t(() => j.records.cnt, "getCount"), F = l.treeView, I = {
	clear: M,
	...
	getRoot: N,
	getCount: P,
	getConfig: /* @__PURE__ */ t(() => m(F, s().treeView), "getConfig"),
	getAccTitle: f,
	getAccDescription: u,
	getDiagramTitle: d,
	setAccDescription: r,
	...
	for (let t of e.nodes) {
		...
		r && (n = n.slice(0, -1));
		let i = r ? "directory" : "file", a = t.classAnnotation || void 0, o = t.iconAnnotation, c = o === void 0 ? void 0 : o || "none", l = t.descAnnotation || void 0, u = l ? p(l, s()) : void 0;
		I.addNode(e, n, i, a, c, u);
	}
}, "populate"), R = { parse: /* @__PURE__ */ t(async (t) => {
	let { text: r, lineMap: i } = A(t);
	try {
		let t = await e("treeView", r);
		n.debug(t), L(t);
	} catch (e) {
		throw i.size > 0 && e instanceof Error && (e.message = k(e.message, i)), e;
	}
}, "parse") }, z = {
...
var U = 14, W = 4, G = 16, K = /* @__PURE__ */ t(async (e, n) => {
	let r = [], i = /* @__PURE__ */ t((e) => {
		let t = H(e, n);
		t && r.push({
			icon: t,
			node: e
	...
	i(e);
	let a = await Promise.all(r.map(async ({ icon: e, node: t }) => ({
		id: t.id,
		svg: await _(e, {
			height: U,
			width: U
	...
	return new Map(a.map(({ id: e, svg: t }) => [e, t]));
}, "resolveNodeIcons"), q = /* @__PURE__ */ t((e, t, n, r, i, a) => {
	...
	l && o.append("g").attr("class", "treeView-node-icon").attr("transform", `translate(${e + i.paddingX}, ${t + i.paddingY})`).html(a.get(n.id) ?? "");
...
}, "positionLabel"), J = /* @__PURE__ */ t((e, t, n, r, i, a) => e.append("line").attr("x1", t).attr("y1", n).attr("x2", r).attr("y2", i).attr("stroke-width", a).attr("class", "treeView-node-line"), "positionLine"), Y = /* @__PURE__ */ t((e, n, r, i) => {
	let a = 0, o = 0, s = [], c = /* @__PURE__ */ t((e, t, n, r) => {
		let c = r * (n.rowIndent + n.paddingX), l = q(c, a, t, e, n, i);
		s.push(l);
		let { height: u, width: d } = t.BBox;
		J(e, c - n.rowIndent, a + u / 2, c, a + u / 2, n.lineThickness), o = Math.max(o, c + d), a += u;
		...
		if (t.children.length) {
			...
			J(e, i + r.paddingX, a + o, i + r.paddingX, n + s / 2 + r.lineThickness / 2, r.lineThickness);
		}
	}, "processNode");
	l(n);
...
}, "drawTree"), X = { draw: /* @__PURE__ */ t(async (e, t, r, i) => {
	n.debug("Rendering treeView diagram\n" + e);
	let a = i.db, o = a.getRoot(), s = a.getConfig(), l = y(t), u = l.append("g");
	u.attr("class", "tree-view");
	let { totalHeight: d, totalWidth: f } = Y(u, o, s, await K(o, s));
	l.attr("viewBox", `-${s.lineThickness / 2} 0 ${f} ${d}`), c(l, d, f, s.useMaxWidth);
}, "draw") }, Z = {
	labelFontSize: "16px",
	labelColor: "black",
	lineColor: "black",
	...
	styles: /* @__PURE__ */ t(({ treeView: e }) => {
		let { labelFontSize: t, labelColor: n, lineColor: r, iconColor: i, descriptionColor: a, highlightBg: o, highlightStroke: s } = m(Z, e);
		return `
    .treeView-node-label {
        font-size: ${t};
        fill: ${n};
