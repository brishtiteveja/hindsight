...
import { $ as r, H as i, K as a, U as o, a as s, s as c, v as l, w as u, x as d, y as f } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { g as p, s as m } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { t as h } from "./chunk-F27PBJKO-BmGuo1wo.mjs";
import { t as g } from "./chunk-XXDRQBXY-DPtumRZh.mjs";
import { t as _ } from "./chunk-POPQ4Y6H-C5gbCr3a.mjs";
import { d as v } from "./mermaid.core-DuekSTCI.mjs";
		...
		return {
			...
			performAction: /* @__PURE__ */ e(function(t, n, r, i) {
				...
				switch (e(a, "processId"), r) {
					...
					case 52: throw Error("Error: State name must be a single word. Found: \"" + n.yytext.trim() + "\"");
					case 53: return 19;
					case 54:
						this.popState();
						break;
					...
					case 65: return a() ? (this.popState(), "ID") : void 0;
					case 66: return a() ? (this.popState(), this.pushState("NOTE_TEXT"), 24) : void 0;
					case 67: return this.popState(), n.yytext = n.yytext.substr(2).trim(), 31;
					case 68: return this.popState(), n.yytext = n.yytext.slice(0, -8).trim(), 31;
					case 69: return 6;
					case 70: return 6;
					case 71: return 16;
					case 72: return 57;
					case 73: return a() ? 24 : void 0;
					case 74: return n.yytext = n.yytext.trim(), 14;
					case 75: return 15;
					case 76: return 28;
					case 77: return 58;
					case 78: return 5;
...
var x = b, S = "TB", C = "TB", w = "dir", T = "state", E = "root", D = "relation", O = "classDef", k = "style", A = "applyClass", j = "default", M = "divider", N = "fill:none", P = "fill: #333", ee = "c", F = "markdown", te = "normal", I = "rect", L = "rectWithTitle", ne = "stateStart", re = "stateEnd", R = "divider", z = "roundedWithTitle", ie = "note", ae = "noteGroup", B = "statediagram", oe = `${B}-state`, V = "transition", se = "note", ce = `${V} note-edge`, le = `${B}-${se}`, ue = `${B}-cluster`, de = `${B}-cluster-alt`, H = "parent", U = "note", fe = "state", W = "----", pe = `${W}${U}`, G = `${W}${H}`, K = /* @__PURE__ */ e((e, t = C) => {
	...
	draw: /* @__PURE__ */ e(async function(e, n, r, i) {
		...
		let c = i.db.getData(), l = g(n, a);
		c.type = i.type, c.layoutAlgorithm = s, c.nodeSpacing = o?.nodeSpacing || 50, c.rankSpacing = o?.rankSpacing || 50, c.markers = d().look === "neo" ? ["barbNeo"] : ["barb"], c.diagramId = n, await v(c, l);
		try {
			(typeof i.db.getLinks == "function" ? i.db.getLinks() : /* @__PURE__ */ new Map()).forEach((e, n) => {
				let r = typeof n == "string" ? n : typeof n?.id == "string" ? n.id : "", i = c.nodes.find((e) => e.id === r);
				if (!r) {
					t.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(n));
					return;
				}
				let a = l.node()?.querySelectorAll("g.node, g.rough-node"), o;
				if (a?.forEach((e) => {
					let t = e.textContent?.trim();
					(e.id === i?.domId || t === r) && (o = e);
				}), !o) {
				...
				let u = document.createElementNS("http://www.w3.org/2000/svg", "a"), d = e.url.replace(/^"+|"+$/g, "");
				if (u.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", d), u.setAttribute("target", "_blank"), e.tooltip) {
					let t = e.tooltip.replace(/^"+|"+$/g, "");
					u.setAttribute("title", t), o.setAttribute("title", t);
				}
				s.replaceChild(u, o), u.appendChild(o), t.info("🔗 Wrapped node in <a> tag for:", r, e.url);
			});
		} catch (e) {
			t.error("❌ Error injecting clickable links:", e);
		}
		p.insertTitle(l, "statediagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), _(l, 8, B, o?.useMaxWidth ?? !0);
	}, "draw"),
	getDir: K
}, q = /* @__PURE__ */ new Map(), J = 0;
function Y(e = "", t = 0, n = "", r = W) {
	return `${fe}-${e}${n !== null && n.length > 0 ? `${r}${n}` : ""}-${t}`;
}
e(Y, "stateDomId");
var he = /* @__PURE__ */ e((e, n, r, i, a, o, s, l) => {
	t.trace("items", n), n.forEach((t) => {
		switch (t.stmt) {
			...
			case j:
				...
				break;
			case D: {
				Z(e, t.state1, r, i, a, o, s, l), Z(e, t.state2, r, i, a, o, s, l);
				let n = s === "neo", u = {
					id: "edge" + J,
					start: t.state1.id,
					end: t.state2.id,
					...
					style: N,
					labelStyle: "",
					label: c.sanitizeText(t.description ?? "", d()),
					arrowheadStyle: P,
					labelpos: ee,
					labelType: F,
					thickness: te,
...
e(X, "insertOrUpdateNode");
function _e(e) {
	return e?.classes?.join(" ") ?? "";
}
e(_e, "getClassesFromDbInfo");
function ve(e) {
	return e?.styles ?? [];
}
e(ve, "getStylesFromDbInfo");
var Z = /* @__PURE__ */ e((e, n, r, i, a, o, s, l) => {
	let u = n.id, f = r.get(u), p = _e(f), m = ve(f), h = d();
	if (t.info("dataFetcher parsedItem", n, f, m), u !== "root") {
		let r = I;
		n.start === !0 ? r = ne : n.start === !1 && (r = re), n.type !== j && (r = n.type), q.get(u) || q.set(u, {
			id: u,
			shape: r,
		...
		if (f.shape === R && (f.label = ""), e && e.id !== "root" && (t.trace("Setting node ", u, " to be child of its parent ", e.id), f.parentId = e.id), f.centerLabel = !0, n.note) {
			let e = {
				labelStyle: "",
				shape: ie,
				label: n.note.text,
			...
			J++, r.id = t, e.parentId = t, X(i, r, l), X(i, e, l), X(i, f, l);
			let o = u, c = e.id;
			n.note.position === "left of" && (o = e.id, c = u), a.push({
				id: o + "-" + c,
				start: o,
				end: c,
				arrowhead: "none",
	...
	n.doc && (t.trace("Adding nodes children "), he(n, n.doc, r, i, a, !o, s, l));
}, "dataFetcher"), ye = /* @__PURE__ */ e(() => {
	q.clear(), J = 0;
}, "reset"), Q = {
	START_NODE: "[*]",
	START_TYPE: "start",
	...
	BG_FILL: "bgFill",
	STYLECLASS_SEP: ","
}, be = /* @__PURE__ */ e(() => /* @__PURE__ */ new Map(), "newClassesList"), xe = /* @__PURE__ */ e(() => ({
	relations: [],
	states: /* @__PURE__ */ new Map(),
	documents: {}
}), "newDoc"), $ = /* @__PURE__ */ e((e) => JSON.parse(JSON.stringify(e)), "clone"), Se = (y = class {
	constructor(e) {
		this.version = e, this.nodes = [], this.edges = [], this.rootDoc = [], this.classes = be(), this.documents = { root: xe() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.dividerCnt = 0, this.links = /* @__PURE__ */ new Map(), this.funs = [], this.getAccTitle = f, this.setAccTitle = o, this.getAccDescription = l, this.setAccDescription = i, this.setDiagramTitle = a, this.getDiagramTitle = u, this.clear(), this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this), this.bindFunctions = this.bindFunctions.bind(this);
	}
	extract(e) {
		this.clear(!0);
		...
		ye(), Z(void 0, this.getRootDocV2(), t, this.nodes, this.edges, !0, n.look, this.classes);
	...
	docTranslator(e, t, n) {
		...
		if (t.stmt === T && (t.id === Q.START_NODE ? (t.id = e.id + (n ? "_start" : "_end"), t.start = n) : t.id = t.id.trim()), t.stmt !== E && t.stmt !== T || !t.doc) return;
		let r = [], i = [];
		for (let e of t.doc) if (e.type === M) {
			let t = $(e);
			t.doc = $(i), r.push(t), i = [];
		} else i.push(e);
	...
	addState(e, n = j, r = void 0, i = void 0, a = void 0, o = void 0, s = void 0, l = void 0) {
		let u = e?.trim();
		if (!this.currentDocument.states.has(u)) t.info("Adding state ", u, i), this.currentDocument.states.set(u, {
			stmt: T,
			id: u,
			descriptions: [],
			type: n,
			...
			e.doc || (e.doc = r), e.type || (e.type = n);
		}
		if (i && (t.info("Setting state description", u, i), (Array.isArray(i) ? i : [i]).forEach((e) => this.addDescription(u, e.trim()))), a) {
			let e = this.currentDocument.states.get(u);
			if (!e) throw Error(`State not found: ${u}`);
			e.note = a, e.note.text = c.sanitizeText(e.note.text, d());
		}
		o && (t.info("Setting state classes", u, o), (Array.isArray(o) ? o : [o]).forEach((e) => this.setCssClass(u, e.trim()))), s && (t.info("Setting state styles", u, s), (Array.isArray(s) ? s : [s]).forEach((e) => this.setStyle(u, e.trim()))), l && (t.info("Setting state styles", u, s), (Array.isArray(l) ? l : [l]).forEach((e) => this.setTextStyle(u, e.trim())));
	}
	clear(e) {
		this.nodes = [], this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.documents = { root: xe() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = be(), e || (this.links = /* @__PURE__ */ new Map(), s());
	}
	getState(e) {
	...
	addDescription(e, t) {
		...
		n?.descriptions?.push(c.sanitizeText(r, d()));
	}
	cleanupLabel(e) {
	...
	setupToolTips(e) {
		let t = h();
		n(e).select("svg").selectAll("g.node, g.rough-node").on("mouseover", (e) => {
			let i = n(e.currentTarget), a = i.attr("title");
			if (a === null) return;
			let o = e.currentTarget?.getBoundingClientRect();
			t.transition().duration(200).style("opacity", ".9"), t.style("left", window.scrollX + o.left + (o.right - o.left) / 2 + "px").style("top", window.scrollY + o.bottom + "px"), t.html(r.sanitize(a)), i.classed("hover", !0);
		}).on("mouseout", (e) => {
	...
	getDirectionStatement() {
		return this.rootDoc.find((e) => e.stmt === w);
	}
	getDirection() {
		return this.getDirectionStatement()?.value ?? S;
	}
	setDirection(e) {
...
`, "getStyles");
//#endregion
export { Ce as i, x as n, me as r, Se as t };
