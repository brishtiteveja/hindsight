import { l as e, n as t, o as n, r, t as i } from "./src-DKnM293t.mjs";
import { i as a, n as o, r as s, t as c } from "./defaultLocale-N-0uLSyg.mjs";
import { t as l } from "./init-CsQUQz36.mjs";
...
function U() {
	...
	function f(t) {
		return t == null || isNaN(t = +t) ? o : (l || (l = c(e.map(i), n, r)))(i(s(t)));
	}
	return f.invert = function(r) {
		return s(a((u || (u = c(n, e.map(i), t)))(r)));
	}, f.domain = function(t) {
...
function G(e, t, n, r) {
	...
	switch (r = s(r ?? ",f"), r.type) {
		...
		case "r":
			...
			break;
		case "f":
		case "%": r.precision == null && !isNaN(a = j(i)) && (r.precision = a - (r.type === "%") * 2);
	}
	return c(r);
}
//#endregion
