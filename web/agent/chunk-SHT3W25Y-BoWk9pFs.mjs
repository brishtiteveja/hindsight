...
import { $ as r, G as i, H as a, K as o, U as s, a as c, d as l, it as u, k as d, s as f, v as p, w as ee, x as m, y as h } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { t as g } from "./channel-B0B0j90Y.mjs";
import { c as _, g as v } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { t as te } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import { i as ne } from "./chunk-4HAMMTFA-DyLvtKHk.mjs";
import { t as y } from "./chunk-F27PBJKO-BmGuo1wo.mjs";
import { t as b } from "./chunk-XXDRQBXY-DPtumRZh.mjs";
import { t as x } from "./chunk-POPQ4Y6H-C5gbCr3a.mjs";
import { d as S, n as C, t as w, u as T } from "./mermaid.core-DuekSTCI.mjs";
//#region node_modules/mermaid/dist/chunks/mermaid.core/chunk-SHT3W25Y.mjs
var E, D = "flowchart-", O = (E = class {
	constructor() {
		this.vertexCounter = 0, this.config = m(), this.diagramId = "", this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = !0, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = s, this.setAccDescription = a, this.setDiagramTitle = o, this.getAccTitle = h, this.getAccDescription = p, this.getDiagramTitle = ee, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = { firstGraph: this.firstGraph.bind(this) }, this.clear(), this.setGen("gen-2");
	}
	sanitizeText(e) {
		return f.sanitizeText(e, this.config);
	}
	...
	addVertex(e, n, r, i, a, o, s = {}, c) {
		...
		let u = this.subGraphLookup.get(e);
		if (u && l) {
			u.metadata = {
				...u.metadata,
				...l
		...
		if (p === void 0 && (n === void 0 && r === void 0 && i != null && t.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), p = {
			id: e,
			labelType: "text",
			domId: D + e + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(e, p)), this.vertexCounter++, n === void 0 ? p.text === void 0 && (p.text = e) : (this.config = m(), f = this.sanitizeText(n.text.trim()), p.labelType = n.type, f.startsWith("\"") && f.endsWith("\"") && (f = f.substring(1, f.length - 1)), p.text = f), r !== void 0 && (p.type = r), i?.forEach((e) => {
			p.styles.push(e);
		}), a?.forEach((e) => {
			p.classes.push(e);
	...
	addSingleLink(e, n, r, i) {
		...
		if (o !== void 0 && (a.text = this.sanitizeText(o.text.trim()), a.text.startsWith("\"") && a.text.endsWith("\"") && (a.text = a.text.substring(1, a.text.length - 1)), a.labelType = this.sanitizeNodeLabelType(o.type)), r !== void 0 && (a.type = r.type, a.stroke = r.stroke, a.length = r.length > 10 ? 10 : r.length), i && !this.edges.some((e) => e.id === i)) a.id = i, a.isUserDefinedId = !0;
			...
			a.id = e.length === 0 ? _(a.start, a.end, {
				counter: 0,
				prefix: "L"
			}) : _(a.start, a.end, {
				counter: e.length + 1,
...
You have to call mermaid.initialize.`);
	...
	setLink(e, t, n) {
		e.split(",").forEach((e) => {
			...
			r !== void 0 && (r.link = v.formatUrl(t, this.config), r.linkTarget = n);
	...
	setupToolTips(e) {
		let t = y();
		n(e).select("svg").selectAll("g.node").on("mouseover", (e) => {
			let i = n(e.currentTarget), a = i.attr("title");
			if (a === null) return;
			let o = e.currentTarget?.getBoundingClientRect();
			t.transition().duration(200).style("opacity", ".9"), t.text(i.attr("title")).style("left", window.scrollX + o.left + (o.right - o.left) / 2 + "px").style("top", window.scrollY + o.bottom + "px"), t.html(r.sanitize(a)), i.classed("hover", !0);
		}).on("mouseout", (e) => {
			t.transition().duration(500).style("opacity", 0), n(e.currentTarget).classed("hover", !1);
		});
	}
	clear(e = "gen-2") {
		this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.diagramId = "", this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = !0, this.version = e, this.config = m(), c();
	}
	setGen(e) {
	...
	addSubGraph(n, r, i) {
		...
		}, "uniq"))(r.flat()), c = s.nodeList, l = s.dir, u = m().flowchart ?? {};
		if (l = l ?? (u.inheritDir ? this.getDirection() ?? m().direction ?? void 0 : void 0), this.version === "gen-1") for (let e = 0; e < c.length; e++) c[e] = this.lookUpDomId(c[e]);
		...
		return t.info("Adding", d.id, d.nodes, d.dir), d.nodes = this.makeUniq(d, this.subGraphs).nodes, this.subGraphs.push(d), this.subGraphLookup.set(a, d), a;
	}
	getPosForId(e) {
	...
	destructStartLink(e) {
		...
		switch (t[0]) {
			...
			case "x":
				...
				break;
			case "o": n = "arrow_circle", t = t.slice(1);
		}
		let r = "normal";
	...
	destructEndLink(e) {
		...
		switch (t.slice(-1)) {
			...
			case ">":
				...
				break;
			case "o": r = "arrow_circle", t.startsWith("o") && (r = "double_" + r, n = n.slice(1));
		}
	...
	destructEdgeType(e) {
		...
		switch (e) {
			...
			case "double_arrow_cross": t = e.replace("double_", ""), n = t;
		}
		return {
			arrowTypeStart: t,
			arrowTypeEnd: n
	...
	getData() {
		let t = m(), n = [], r = [], i = this.getSubGraphs(), a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map();
		for (let e of i) for (let t of e.nodes) this.subGraphLookup.has(t) && s.set(t, e.id);
		let c = /* @__PURE__ */ e((e) => this.subGraphLookup.get(e)?.metadata?.view === "collapsed", "isCollapsed"), l = /* @__PURE__ */ e((e) => {
			let t, n = /* @__PURE__ */ new Set(), r = e;
			for (; r !== void 0 && !n.has(r);) n.add(r), c(r) && (t = r), r = s.get(r);
			return t;
		}, "outermostCollapsed"), u = /* @__PURE__ */ new Set(), d = /* @__PURE__ */ new Map();
		for (let e of i) {
			let t = l(e.id);
			if (t !== void 0) {
				e.id !== t && (u.add(e.id), d.set(e.id, t));
				for (let n of e.nodes) n !== t && (u.add(n), d.set(n, t));
			}
		}
		...
		for (let e = i.length - 1; e >= 0; e--) {
			let r = i[e];
			u.has(r.id) || (r.metadata?.view === "collapsed" ? n.push({
				id: r.id,
				label: r.title,
				labelStyle: "",
		...
		this.getVertices().forEach((e) => {
			u.has(e.id) || this.addNodeFromVertex(e, n, a, o, t, t.look || "classic");
		});
		let f = this.getEdges();
		return f.forEach((e, n) => {
			let { arrowTypeStart: i, arrowTypeEnd: a } = this.destructEdgeType(e.type), o = [...f.defaultStyle ?? []], s = d.get(e.start) ?? e.start, c = d.get(e.end) ?? e.end;
			if (s === c && (d.has(e.start) || d.has(e.end))) return;
			e.style && o.push(...e.style);
			let l = {
				id: _(s, c, {
					counter: n,
					prefix: "L"
				...
				arrowTypeStart: e?.stroke === "invisible" || e?.type === "arrow_open" ? "none" : i,
	...
	draw: /* @__PURE__ */ e(async function(e, n, r, i) {
		...
		let { securityLevel: a, flowchart: o, layout: s } = m();
		i.db.setDiagramId(n), t.debug("Before getData: ");
		let c = i.db.getData();
		t.debug("Data: ", c);
		let l = b(n, a), u = i.db.getDirection();
		c.type = i.type, c.layoutAlgorithm = T(s), c.layoutAlgorithm === "dagre" && s === "elk" && t.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), c.direction = u, c.nodeSpacing = o?.nodeSpacing || 50, c.rankSpacing = o?.rankSpacing || 50, c.markers = [
			"point",
			"circle",
			"cross"
		], c.diagramId = n, t.debug("REF1:", c), await S(c, l);
		let d = c.config.flowchart?.diagramPadding ?? 8;
		v.insertTitle(l, "flowchartTitleText", o?.titleTopMargin || 0, i.db.getDiagramTitle()), x(l, d, "flowchart", o?.useMaxWidth || !1);
	}, "draw")
}, ie = (function() {
	var t = /* @__PURE__ */ e(function(e, t, n, r) {
		...
		parse: /* @__PURE__ */ e(function(t) {
			...
			this.parseError = typeof h.yy.parseError == "function" ? h.yy.parseError : Object.getPrototypeOf(this).parseError;
			function te(e) {
			...
			for (var y, b, x, S, C, w = {}, T, E, D, O;;) {
				if (x = r[r.length - 1], this.defaultActions[x] ? S = this.defaultActions[x] : (y ?? (y = ne()), S = s[x] && s[x][y]), S === void 0 || !S.length || !S[0]) {
					var re = "";
		...
		return {
			...
			performAction: /* @__PURE__ */ e(function(e, t, n, r) {
				switch (n) {
					...
					case 38: return e.lex.firstGraph() && this.begin("dir"), 12;
					case 39: return 27;
					case 40: return 32;
					case 41: return 98;
					case 42: return 98;
					case 43: return 98;
					case 44: return 98;
					case 45: return this.popState(), 13;
					...
					case 55: return this.popState(), 14;
					case 56: return 121;
					case 57: return 122;
					case 58: return 123;
					case 59: return 124;
					...
					case 68: return 106;
					case 69: return 115;
					case 70: return this.popState(), 77;
					case 71: return this.pushState("edgeText"), 75;
					case 72: return 119;
					case 73: return this.popState(), 77;
					case 74: return this.pushState("thickEdgeText"), 75;
					case 75: return 119;
					case 76: return this.popState(), 77;
					case 77: return this.pushState("dottedEdgeText"), 75;
					case 78: return 119;
					case 79: return 77;
					case 80: return this.popState(), 53;
					case 81: return "TEXT";
					case 82: return this.pushState("ellipseText"), 52;
					case 83: return this.popState(), 55;
					case 84: return this.pushState("text"), 54;
					case 85: return this.popState(), 57;
					case 86: return this.pushState("text"), 56;
					case 87: return 58;
					case 88: return this.pushState("text"), 67;
					case 89: return this.popState(), 64;
					case 90: return this.pushState("text"), 63;
					case 91: return this.popState(), 49;
					case 92: return this.pushState("text"), 48;
					case 93: return this.popState(), 69;
					case 94: return this.popState(), 71;
					case 95: return 117;
					case 96: return this.pushState("trapText"), 68;
					case 97: return this.pushState("trapText"), 70;
					case 98: return 118;
					case 99: return 67;
					case 100: return 90;
					case 101: return "SEP";
					...
					case 107: return 114;
					case 108: return 116;
					case 109: return this.popState(), 62;
					case 110: return this.pushState("text"), 62;
					case 111: return this.popState(), 51;
					case 112: return this.pushState("text"), 50;
					case 113: return this.popState(), 31;
					case 114: return this.pushState("text"), 29;
					case 115: return this.popState(), 66;
					case 116: return this.pushState("text"), 65;
...
ie.parser = ie;
var ae = ie, oe = Object.assign({}, ae);
oe.parse = (e) => {
	let t = e.replace(/}\s*\n/g, "}\n");
	return ae.parse(t);
};
var k = oe, A = /* @__PURE__ */ e((e, t) => {
	let n = g, r = n(e, "r"), i = n(e, "g"), a = n(e, "b");
	return u(r, i, a, t);
}, "fade"), j = /* @__PURE__ */ e((e) => `.label {
  ...
  .labelBkg {
    background-color: ${A(e.edgeLabelBackground, .5)};
    // background-color:
  }
  ...
  ${te()}
`, "getStyles"), M = /* @__PURE__ */ e(({ defaultLayout: t, styles: n = j } = {}) => ({
	parser: k,
	get db() {
		return new O();
	},
	...
	init: /* @__PURE__ */ e((e) => {
		...
		let n = d().layout ?? t ?? e.layout;
		n && i({ layout: n }), e.flowchart.arrowMarkerAbsolute = e.arrowMarkerAbsolute, i({ flowchart: { arrowMarkerAbsolute: e.arrowMarkerAbsolute } });
	}, "init")
}), "createFlowDiagram"), N = M();
//#endregion
export { N as n, j as r, M as t };
