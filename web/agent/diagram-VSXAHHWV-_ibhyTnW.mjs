import { T as e } from "./chunk-FOHPRMQF-H8SL32G3.mjs";
import { n as t } from "./mermaid-parser.core-CocydDMZ.mjs";
import { n } from "./chunk-Y2CYZVJY-i11wjrBe.mjs";
import { m as r, p as i } from "./src-DKnM293t.mjs";
import { H as a, K as o, U as s, Y as c, a as l, b as u, f as d, v as f, w as p, x as m, y as h, z as g } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { _, i as ee, t as te } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { t as ne } from "./chunk-JWPE2WC7-DIKiF5cm.mjs";
//#region node_modules/mermaid/dist/chunks/mermaid.core/diagram-VSXAHHWV.mjs
var v = "position frame", y = "frame positioned", b = "position relation", x = "relation positioned", re = /* @__PURE__ */ n(function(e) {
	r.debug("options str", e);
}, "setOptions"), ie = /* @__PURE__ */ n(function() {
	return {};
}, "getOptions"), ae = /* @__PURE__ */ n(function() {
	S(), l();
}, "clear");
function S() {
	C = {};
...
n(S, "reset");
var oe = d.eventmodeling, se = /* @__PURE__ */ n(() => ee({
	...oe,
	...u().eventmodeling
}), "getConfig"), C = {};
function w() {
	...
	return t.frames.forEach((i, a) => {
		...
		let s;
		V(i) ? (r.debug("source frame", i.sourceFrames), s = t.frames.filter((e) => i.sourceFrames.some((t) => t.$refText === e.name)), s.forEach((t) => {
			e = J(e, {
				$kind: b,
				index: a,
				frame: i,
...
n(N, "calculateEntityVisualProps");
function P(e, t, n) {
	let i = u(), a = g(k(e.entityIdentifier) ?? "", i), o, s = {
		fontSize: 16,
		fontWeight: 700,
		fontFamily: "\"trebuchet ms\", verdana, arial, sans-serif",
		joinWith: "<br/>"
	}, c = `<b>${_(a, n.textMaxWidth, s)}</b>`;
	if (e.dataInlineValue && (o = e.dataInlineValue, o = o.substring(o.indexOf("{") + 1), o = o.substring(0, o.lastIndexOf("}") - 1), o = g(o, i), o = _(o, n.textMaxWidth, s), o = o.replaceAll(" ", "&nbsp;")), e.dataReference) {
		let r = t.find((t) => t.name === e.dataReference?.$refText);
		r && (o = r.dataBlockValue, o = o.substring(o.indexOf("{\n") + 2), o = o.substring(0, o.lastIndexOf("}") - 1), o = g(o, i), o = _(o, n.textMaxWidth, s), o = o.replaceAll(" ", "&nbsp;"), o += "<br/>");
	}
	let l = o !== void 0;
	l && (c += `<br/><br/><code style="text-align: left; display: block;max-width:${n.textMaxWidth}px">${o}</code>`);
	let d = {
		fontSize: s.fontSize,
		fontWeight: s.fontWeight,
		fontFamily: s.fontFamily
	}, f = te(c, d), p = l ? f.width / 3 : f.width, m = {
		content: c,
		width: p,
		height: f.height
	};
...
n(U, "findBoxByLineIndex");
function W(t, n) {
	let r = n;
	if (e(r.frame) || B(r.index, r.frame)) return [];
	let i = H(t.boxes, r.frame);
	if (i === void 0) throw Error(`Target box not found for frame ${r.frame.name}`);
	let a;
	return a = r.sourceFrame ? H(t.boxes, r.sourceFrame) : U(t.boxes, i.swimlane.index, r.index - 1), a === void 0 ? [] : [{
		$kind: x,
		frame: r.frame,
		index: r.index,
		sourceBox: a,
...
var Y = {
	...
	getDiagramProps: D,
	getState: w
}, de = { parse: /* @__PURE__ */ n(async (e) => {
	let n = await t("eventmodeling", e);
	r.debug(n), Y.setAst(n), ne(n, Y);
}, "parse") }, fe = m()?.eventmodeling;
function X(e, t) {
	return (n) => {
...
var pe = {
	parser: de,
	db: Y,
	renderer: { draw: /* @__PURE__ */ n(function(e, t, n, a) {
		if (r.debug("in eventmodeling renderer", e + "\n", "id:", t, n), !fe) throw Error("EventModeling config not found");
		let o = a.db, { themeVariables: s, eventmodeling: l } = m(), u = i(`[id="${t}"]`), d = o.getDiagramProps(), f = o.getState(), p = `em-arrowhead-${t}`, h = s.emArrowhead ?? "#000000";
		f.sortedSwimlanesArray.forEach($(u, f.maxR, d, s)), f.boxes.forEach(X(u, d)), f.relations.forEach(Q(u, d, p, s)), u.append("defs").append("marker").attr("id", p).attr("markerWidth", "10").attr("markerHeight", "7").attr("refX", "10").attr("refY", "3.5").attr("orient", "auto").append("polygon").attr("points", "0 0, 10 3.5, 0 7").attr("fill", h), c(void 0, u, l?.padding ?? 30, l?.useMaxWidth);
	}, "draw") },
