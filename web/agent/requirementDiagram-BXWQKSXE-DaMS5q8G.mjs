...
import { H as r, K as i, U as a, a as o, b as s, v as c, w as l, x as u, y as d } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { g as f } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
...
import { t as p } from "./chunk-XXDRQBXY-DPtumRZh.mjs";
import { t as m } from "./chunk-POPQ4Y6H-C5gbCr3a.mjs";
import "./chunk-L3NEJ4N5-xQTuRmpd.mjs";
import { d as h, u as g } from "./mermaid.core-DuekSTCI.mjs";
...
var _, v = (function() {
	...
	return e(ue, "Parser"), ue.prototype = le, le.Parser = ue, new ue();
})();
v.parser = v;
var y = v, b = (_ = class {
	constructor() {
		this.relations = [], this.latestRequirement = this.getInitialRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.latestElement = this.getInitialElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.direction = "TB", this.RequirementType = {
			...
			REFINES: "refines",
			TRACES: "traces"
		}, this.setAccTitle = a, this.getAccTitle = d, this.setAccDescription = r, this.getAccDescription = c, this.setDiagramTitle = i, this.getDiagramTitle = l, this.getConfig = /* @__PURE__ */ e(() => u().requirement, "getConfig"), this.clear(), this.setDirection = this.setDirection.bind(this), this.addRequirement = this.addRequirement.bind(this), this.setNewReqId = this.setNewReqId.bind(this), this.setNewReqRisk = this.setNewReqRisk.bind(this), this.setNewReqText = this.setNewReqText.bind(this), this.setNewReqVerifyMethod = this.setNewReqVerifyMethod.bind(this), this.addElement = this.addElement.bind(this), this.setNewElementType = this.setNewElementType.bind(this), this.setNewElementDocRef = this.setNewElementDocRef.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setCssStyle = this.setCssStyle.bind(this), this.setClass = this.setClass.bind(this), this.defineClass = this.defineClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	getDirection() {
	...
	addElement(e) {
		return this.elements.has(e) || (this.elements.set(e, {
			...
			cssStyles: [],
			classes: ["default"]
		}), n.info("Added new element: ", e)), this.resetLatestElement(), this.elements.get(e);
	}
	getElements() {
	...
	clear() {
		this.relations = [], this.resetLatestRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.resetLatestElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), o();
	}
	setCssStyle(e, t) {
		for (let n of e) {
	...
	getData() {
		...
		for (let n of this.requirements.values()) {
			let r = n;
			r.id = n.name, r.cssStyles = n.cssStyles, r.cssClasses = n.classes.join(" "), r.shape = "requirementBox", r.look = e.look, r.colorIndex = t.length, t.push(r);
		}
		for (let n of this.elements.values()) {
			let r = n;
			r.shape = "requirementBox", r.look = e.look, r.id = n.name, r.cssStyles = n.cssStyles, r.cssClasses = n.classes.join(" "), r.colorIndex = t.length, t.push(r);
		}
		let r = 0;
		for (let t of this.relations) {
			let i = t.type === this.Relationships.CONTAINS, a = {
				id: `${t.src}-${t.dst}-${r++}`,
...
}, e(_, "RequirementDB"), _), x = /* @__PURE__ */ e((e) => {
	let { themeVariables: t, look: n } = s(), { bkgColorArray: r, borderColorArray: i } = t;
	if (!i?.length) return "";
	let a = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) a += `
    ...
    `;
	return a;
}, "genColor"), S = /* @__PURE__ */ e((e) => {
	let { look: t, themeVariables: n } = s(), { requirementEdgeLabelBackground: r } = n;
	return `
  ${x(e)}
  marker {
...
t(C, { draw: () => w });
var w = /* @__PURE__ */ e(async function(e, t, r, i) {
	n.info("REF0:"), n.info("Drawing requirement diagram (unified)", t);
	let { securityLevel: a, state: o, layout: s, look: c } = u(), l = i.db.getData(), d = p(t, a);
	l.type = i.type, l.layoutAlgorithm = g(s), l.nodeSpacing = o?.nodeSpacing ?? 50, l.rankSpacing = o?.rankSpacing ?? 50, l.markers = c === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], l.diagramId = t, await h(l, d), f.insertTitle(d, "requirementDiagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), m(d, 8, "requirementDiagram", o?.useMaxWidth ?? !0);
}, "draw"), T = {
	parser: y,
	get db() {
		return new b();
