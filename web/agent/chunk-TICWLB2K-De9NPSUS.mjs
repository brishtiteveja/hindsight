...
import { $ as r, H as i, K as a, M as o, U as s, a as c, s as l, v as u, w as d, x as f, y as p, z as m } from "./chunk-DU6HZSFF-Bv553b-w.mjs";
import { c as h, g } from "./chunk-75Z2AOVW-DlpwHa_5.mjs";
import { t as _ } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import { t as v } from "./chunk-F27PBJKO-BmGuo1wo.mjs";
import { t as y } from "./chunk-XXDRQBXY-DPtumRZh.mjs";
import { t as b } from "./chunk-POPQ4Y6H-C5gbCr3a.mjs";
import { d as x, u as S } from "./mermaid.core-DuekSTCI.mjs";
...
var C, w, T = (function() {
	...
	return e($, "Parser"), $.prototype = ce, ce.Parser = $, new $();
})();
T.parser = T;
var E = T, D = [
	"#",
	...
	parseMember(e) {
		...
		if (this.memberType === "method") {
			...
			if (n) {
				let e = n[1] ? n[1].trim() : "";
				if (D.includes(e) && (this.visibility = e), this.id = n[2], this.parameters = n[3] ? n[3].trim() : "", t = n[4] ? n[4].trim() : "", this.returnType = n[5] ? n[5].trim() : "", t === "") {
			...
			D.includes(r) && (this.visibility = r), /[$*]/.exec(i) && (t = i), this.id = e.substring(this.visibility === "" ? 0 : 1, t === "" ? n : n - 1);
		}
		this.classifier = t, this.id = this.id.startsWith(" ") ? " " + this.id.trim() : this.id.trim();
		let n = `${this.visibility ? "\\" + this.visibility : ""}${o(this.id)}${this.memberType === "method" ? `(${o(this.parameters)})${this.returnType ? " : " + o(this.returnType) : ""}` : ""}`;
...
}, e(C, "ClassMember"), C), k = "classId-", A = 0, j = /* @__PURE__ */ e((e) => l.sanitizeText(e, f()), "sanitizeText"), M = (w = class o {
	constructor() {
		this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.functions = [], this.lineType = {
			...
			DEPENDENCY: 3,
			LOLLIPOP: 4
		}, this.setupToolTips = /* @__PURE__ */ e((e) => {
			let t = v();
	...
	addRelation(e) {
		...
		e.relation.type1 === this.relationType.LOLLIPOP && !n.includes(e.relation.type2) ? (this.addClass(e.id2), this.addInterface(e.id1, e.id2), e.id1 = `interface${this.interfaces.length - 1}`) : e.relation.type2 === this.relationType.LOLLIPOP && !n.includes(e.relation.type1) ? (this.addClass(e.id1), this.addInterface(e.id2, e.id1), e.id2 = `interface${this.interfaces.length - 1}`) : (this.addClass(e.id1), this.addClass(e.id2)), e.id1 = this.splitClassNameAndType(e.id1).className, e.id2 = this.splitClassNameAndType(e.id2).className, e.relationTitle1 = l.sanitizeText(e.relationTitle1.trim(), f()), e.relationTitle2 = l.sanitizeText(e.relationTitle2.trim(), f()), this.relations.push(e);
	}
	addAnnotation(e, t) {
	...
	addMember(e, t) {
		...
		if (typeof t == "string") {
			let e = t.trim();
			e.startsWith("<<") && e.endsWith(">>") ? r.annotations.push(j(e.substring(2, e.length - 2))) : e.indexOf(")") > 0 ? r.methods.push(new O(e, "method")) : e && r.members.push(new O(e, "attribute"));
		}
	}
	addMembers(e, t) {
	...
	cleanupLabel(e) {
		return e.startsWith(":") && (e = e.substring(1)), j(e.trim());
	}
	setCssClass(e, t) {
		e.split(",").forEach((e) => {
			let n = e;
			/\d/.exec(e[0]) && (n = k + n), n = this.splitClassNameAndType(n).className;
	...
	setLink(e, t, n) {
		...
		e.split(",").forEach((e) => {
			let i = e;
			/\d/.exec(e[0]) && (i = k + i), i = this.splitClassNameAndType(i).className;
			let a = this.classes.get(i);
			a && (a.link = g.formatUrl(t, r), a.linkTarget = r.securityLevel === "sandbox" ? "_top" : typeof n == "string" ? j(n) : "_blank");
	...
	setClickFunc(e, t, n) {
		...
		let i = this.splitClassNameAndType(r).className;
	...
	createNamespaceNode(e, t, n, r = !1) {
		return {
			...
			domId: k + e + "-" + this.namespaceCounter++,
			parent: n,
			explicit: r
		};
	}
	linkParentChild(e, t) {
		...
		n && r && (n.children.has(t) || n.children.set(t, r), r.parent ?? (r.parent = e));
	}
	addNamespace(e, t) {
...
}, e(w, "ClassDB"), w), N = /* @__PURE__ */ e((e) => `g.classGroup text {
...
`, "getStyles"), P = {
	...
	draw: /* @__PURE__ */ e(async function(e, n, r, i) {
		...
		c.type = i.type, c.layoutAlgorithm = S(s), c.nodeSpacing = o?.nodeSpacing || 50, c.rankSpacing = o?.rankSpacing || 50, c.markers = [
			...
			"dependency",
			"lollipop"
		], c.diagramId = n, await x(c, l), g.insertTitle(l, "classDiagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), b(l, 8, "classDiagram", o?.useMaxWidth ?? !0);
	}, "draw"),
	getDir: /* @__PURE__ */ e((e, t = "TB") => {
		if (!e.doc) return t;
		let n = t;
...
//#endregion
export { N as i, E as n, P as r, M as t };
